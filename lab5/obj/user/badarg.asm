...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 f8 11 80 00 	movl   $0x8011f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 24 13 80 00       	add    $0x801324,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 48 13 80 00 	mov    0x801348(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 3e 13 80 	movl   $0x80133e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 41 13 80 00       	mov    $0x801341,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80106a:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  80106d:	e8 6d f2 ff ff       	call   8002df <fork>
  801072:	89 44 24 18          	mov    %eax,0x18(%esp)
  801076:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80107b:	75 33                	jne    8010b0 <main+0x4c>
        cprintf("fork ok.\n");
  80107d:	c7 04 24 a0 14 80 00 	movl   $0x8014a0,(%esp)
  801084:	e8 96 f0 ff ff       	call   80011f <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  801089:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801090:	00 
  801091:	eb 0a                	jmp    80109d <main+0x39>
            yield();
  801093:	e8 8a f2 ff ff       	call   800322 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  801098:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80109d:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  8010a2:	7e ef                	jle    801093 <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  8010a4:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  8010ab:	e8 10 f2 ff ff       	call   8002c0 <exit>
    }
    assert(pid > 0);
  8010b0:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010b5:	7f 24                	jg     8010db <main+0x77>
  8010b7:	c7 44 24 0c aa 14 80 	movl   $0x8014aa,0xc(%esp)
  8010be:	00 
  8010bf:	c7 44 24 08 b2 14 80 	movl   $0x8014b2,0x8(%esp)
  8010c6:	00 
  8010c7:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  8010ce:	00 
  8010cf:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  8010d6:	e8 55 ef ff ff       	call   800030 <__panic>
    assert(waitpid(-1, NULL) != 0);
  8010db:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010e2:	00 
  8010e3:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8010ea:	e8 19 f2 ff ff       	call   800308 <waitpid>
  8010ef:	85 c0                	test   %eax,%eax
  8010f1:	75 24                	jne    801117 <main+0xb3>
  8010f3:	c7 44 24 0c d5 14 80 	movl   $0x8014d5,0xc(%esp)
  8010fa:	00 
  8010fb:	c7 44 24 08 b2 14 80 	movl   $0x8014b2,0x8(%esp)
  801102:	00 
  801103:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80110a:	00 
  80110b:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  801112:	e8 19 ef ff ff       	call   800030 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801117:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  80111e:	c0 
  80111f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801123:	89 04 24             	mov    %eax,(%esp)
  801126:	e8 dd f1 ff ff       	call   800308 <waitpid>
  80112b:	85 c0                	test   %eax,%eax
  80112d:	75 24                	jne    801153 <main+0xef>
  80112f:	c7 44 24 0c ec 14 80 	movl   $0x8014ec,0xc(%esp)
  801136:	00 
  801137:	c7 44 24 08 b2 14 80 	movl   $0x8014b2,0x8(%esp)
  80113e:	00 
  80113f:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  801146:	00 
  801147:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  80114e:	e8 dd ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  801153:	8d 44 24 14          	lea    0x14(%esp),%eax
  801157:	89 44 24 04          	mov    %eax,0x4(%esp)
  80115b:	8b 44 24 18          	mov    0x18(%esp),%eax
  80115f:	89 04 24             	mov    %eax,(%esp)
  801162:	e8 a1 f1 ff ff       	call   800308 <waitpid>
  801167:	85 c0                	test   %eax,%eax
  801169:	75 0b                	jne    801176 <main+0x112>
  80116b:	8b 44 24 14          	mov    0x14(%esp),%eax
  80116f:	3d af be 00 00       	cmp    $0xbeaf,%eax
  801174:	74 24                	je     80119a <main+0x136>
  801176:	c7 44 24 0c 14 15 80 	movl   $0x801514,0xc(%esp)
  80117d:	00 
  80117e:	c7 44 24 08 b2 14 80 	movl   $0x8014b2,0x8(%esp)
  801185:	00 
  801186:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  80118d:	00 
  80118e:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  801195:	e8 96 ee ff ff       	call   800030 <__panic>
    cprintf("badarg pass.\n");
  80119a:	c7 04 24 49 15 80 00 	movl   $0x801549,(%esp)
  8011a1:	e8 79 ef ff ff       	call   80011f <cprintf>
    return 0;
