...
main(void) {
  ...
  80106d:	66 b8 28 00          	mov    $0x28,%ax
  801071:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  801073:	c7 44 24 08 80 13 80 	movl   $0x801380,0x8(%esp)
  80107a:	00 
  80107b:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801082:	00 
  801083:	c7 04 24 8b 13 80 00 	movl   $0x80138b,(%esp)
  80108a:	e8 a1 ef ff ff       	call   800030 <__panic>
