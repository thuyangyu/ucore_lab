...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 c0 10 80 00 	movl   $0x8010c0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 dc 10 80 00 	movl   $0x8010dc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80106a:	83 ec 20             	sub    $0x20,%esp
    cprintf("value is %d.\n", 1 / zero);
  80106d:	8b 15 08 20 80 00    	mov    0x802008,%edx
  801073:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  801077:	b8 01 00 00 00       	mov    $0x1,%eax
  80107c:	89 c2                	mov    %eax,%edx
  80107e:	c1 fa 1f             	sar    $0x1f,%edx
  801081:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801085:	89 44 24 04          	mov    %eax,0x4(%esp)
  801089:	c7 04 24 a0 13 80 00 	movl   $0x8013a0,(%esp)
  801090:	e8 8a f0 ff ff       	call   80011f <cprintf>
    panic("FAIL: T.T\n");
  801095:	c7 44 24 08 ae 13 80 	movl   $0x8013ae,0x8(%esp)
  80109c:	00 
  80109d:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8010a4:	00 
  8010a5:	c7 04 24 b9 13 80 00 	movl   $0x8013b9,(%esp)
  8010ac:	e8 7f ef ff ff       	call   800030 <__panic>
