...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 e0 11 80 00 	movl   $0x8011e0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 fc 11 80 00 	movl   $0x8011fc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80106d:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  801074:	e8 a6 f0 ff ff       	call   80011f <cprintf>
    if ((pid = fork()) == 0) {
  801079:	e8 61 f2 ff ff       	call   8002df <fork>
  80107e:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801082:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801087:	75 3c                	jne    8010c5 <main+0x61>
        cprintf("I am the child.\n");
  801089:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  801090:	e8 8a f0 ff ff       	call   80011f <cprintf>
        yield();
  801095:	e8 88 f2 ff ff       	call   800322 <yield>
        yield();
  80109a:	e8 83 f2 ff ff       	call   800322 <yield>
        yield();
  80109f:	e8 7e f2 ff ff       	call   800322 <yield>
        yield();
  8010a4:	e8 79 f2 ff ff       	call   800322 <yield>
        yield();
  8010a9:	e8 74 f2 ff ff       	call   800322 <yield>
        yield();
  8010ae:	e8 6f f2 ff ff       	call   800322 <yield>
        yield();
  8010b3:	e8 6a f2 ff ff       	call   800322 <yield>
        exit(magic);
  8010b8:	a1 08 20 80 00       	mov    0x802008,%eax
  8010bd:	89 04 24             	mov    %eax,(%esp)
  8010c0:	e8 fb f1 ff ff       	call   8002c0 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  8010c5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010cd:	c7 04 24 f8 14 80 00 	movl   $0x8014f8,(%esp)
  8010d4:	e8 46 f0 ff ff       	call   80011f <cprintf>
    }
    assert(pid > 0);
  8010d9:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010de:	7f 24                	jg     801104 <main+0xa0>
  8010e0:	c7 44 24 0c 1a 15 80 	movl   $0x80151a,0xc(%esp)
  8010e7:	00 
  8010e8:	c7 44 24 08 22 15 80 	movl   $0x801522,0x8(%esp)
  8010ef:	00 
  8010f0:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  8010f7:	00 
  8010f8:	c7 04 24 37 15 80 00 	movl   $0x801537,(%esp)
  8010ff:	e8 2c ef ff ff       	call   800030 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801104:	c7 04 24 44 15 80 00 	movl   $0x801544,(%esp)
  80110b:	e8 0f f0 ff ff       	call   80011f <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801110:	8d 44 24 18          	lea    0x18(%esp),%eax
  801114:	89 44 24 04          	mov    %eax,0x4(%esp)
  801118:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80111c:	89 04 24             	mov    %eax,(%esp)
  80111f:	e8 e4 f1 ff ff       	call   800308 <waitpid>
  801124:	85 c0                	test   %eax,%eax
  801126:	75 0d                	jne    801135 <main+0xd1>
  801128:	8b 54 24 18          	mov    0x18(%esp),%edx
  80112c:	a1 08 20 80 00       	mov    0x802008,%eax
  801131:	39 c2                	cmp    %eax,%edx
  801133:	74 24                	je     801159 <main+0xf5>
  801135:	c7 44 24 0c 64 15 80 	movl   $0x801564,0xc(%esp)
  80113c:	00 
  80113d:	c7 44 24 08 22 15 80 	movl   $0x801522,0x8(%esp)
  801144:	00 
  801145:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  80114c:	00 
  80114d:	c7 04 24 37 15 80 00 	movl   $0x801537,(%esp)
  801154:	e8 d7 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  801159:	8d 44 24 18          	lea    0x18(%esp),%eax
  80115d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801161:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801165:	89 04 24             	mov    %eax,(%esp)
  801168:	e8 9b f1 ff ff       	call   800308 <waitpid>
  80116d:	85 c0                	test   %eax,%eax
  80116f:	74 09                	je     80117a <main+0x116>
  801171:	e8 76 f1 ff ff       	call   8002ec <wait>
  801176:	85 c0                	test   %eax,%eax
  801178:	75 24                	jne    80119e <main+0x13a>
  80117a:	c7 44 24 0c 90 15 80 	movl   $0x801590,0xc(%esp)
  801181:	00 
  801182:	c7 44 24 08 22 15 80 	movl   $0x801522,0x8(%esp)
  801189:	00 
  80118a:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801191:	00 
  801192:	c7 04 24 37 15 80 00 	movl   $0x801537,(%esp)
  801199:	e8 92 ee ff ff       	call   800030 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  80119e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011a2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011a6:	c7 04 24 b8 15 80 00 	movl   $0x8015b8,(%esp)
  8011ad:	e8 6d ef ff ff       	call   80011f <cprintf>

    cprintf("exit pass.\n");
  8011b2:	c7 04 24 c8 15 80 00 	movl   $0x8015c8,(%esp)
  8011b9:	e8 61 ef ff ff       	call   80011f <cprintf>
    return 0;
