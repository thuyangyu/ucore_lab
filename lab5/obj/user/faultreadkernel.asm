...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 ba 10 80 00 	movl   $0x8010ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 bc 10 80 00 	movl   $0x8010bc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 ba 10 80 00 	movl   $0x8010ba,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 04 12 80 00       	add    $0x801204,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 28 12 80 00 	mov    0x801228(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 1e 12 80 	movl   $0x80121e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 21 12 80 00       	mov    $0x801221,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80106d:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  801072:	8b 00                	mov    (%eax),%eax
  801074:	89 44 24 04          	mov    %eax,0x4(%esp)
  801078:	c7 04 24 80 13 80 00 	movl   $0x801380,(%esp)
  80107f:	e8 9b f0 ff ff       	call   80011f <cprintf>
    panic("FAIL: T.T\n");
  801084:	c7 44 24 08 9e 13 80 	movl   $0x80139e,0x8(%esp)
  80108b:	00 
  80108c:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801093:	00 
  801094:	c7 04 24 a9 13 80 00 	movl   $0x8013a9,(%esp)
  80109b:	e8 90 ef ff ff       	call   800030 <__panic>
