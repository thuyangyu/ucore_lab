...
main(void) {
  ...
  80106d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801074:	00 
  801075:	eb 60                	jmp    8010d7 <main+0x73>
        if ((pid = fork()) == 0) {
  801077:	e8 63 f2 ff ff       	call   8002df <fork>
  80107c:	89 44 24 18          	mov    %eax,0x18(%esp)
  801080:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801085:	75 20                	jne    8010a7 <main+0x43>
            cprintf("I am child %d\n", n);
  801087:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80108b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80108f:	c7 04 24 64 14 80 00 	movl   $0x801464,(%esp)
  801096:	e8 84 f0 ff ff       	call   80011f <cprintf>
            exit(0);
  80109b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010a2:	e8 19 f2 ff ff       	call   8002c0 <exit>
        }
        assert(pid > 0);
  8010a7:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010ac:	7f 24                	jg     8010d2 <main+0x6e>
  8010ae:	c7 44 24 0c 73 14 80 	movl   $0x801473,0xc(%esp)
  8010b5:	00 
  8010b6:	c7 44 24 08 7b 14 80 	movl   $0x80147b,0x8(%esp)
  8010bd:	00 
  8010be:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  8010c5:	00 
  8010c6:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  8010cd:	e8 5e ef ff ff       	call   800030 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  8010d2:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8010d7:	a1 60 14 80 00       	mov    0x801460,%eax
  8010dc:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010e0:	7c 95                	jl     801077 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  8010e2:	a1 60 14 80 00       	mov    0x801460,%eax
  8010e7:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010eb:	7e 4e                	jle    80113b <main+0xd7>
        panic("fork claimed to work %d times!\n", n);
  8010ed:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010f1:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010f5:	c7 44 24 08 a0 14 80 	movl   $0x8014a0,0x8(%esp)
  8010fc:	00 
  8010fd:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801104:	00 
  801105:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  80110c:	e8 1f ef ff ff       	call   800030 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801111:	e8 d6 f1 ff ff       	call   8002ec <wait>
  801116:	85 c0                	test   %eax,%eax
  801118:	74 1c                	je     801136 <main+0xd2>
            panic("wait stopped early\n");
  80111a:	c7 44 24 08 c0 14 80 	movl   $0x8014c0,0x8(%esp)
  801121:	00 
  801122:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801129:	00 
  80112a:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  801131:	e8 fa ee ff ff       	call   800030 <__panic>
    ...
    for (; n > 0; n --) {
  801136:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  80113b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801140:	7f cf                	jg     801111 <main+0xad>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  801142:	e8 a5 f1 ff ff       	call   8002ec <wait>
  801147:	85 c0                	test   %eax,%eax
  801149:	75 1c                	jne    801167 <main+0x103>
        panic("wait got too many\n");
  80114b:	c7 44 24 08 d4 14 80 	movl   $0x8014d4,0x8(%esp)
  801152:	00 
  801153:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80115a:	00 
  80115b:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  801162:	e8 c9 ee ff ff       	call   800030 <__panic>
    }

    cprintf("forktest pass.\n");
  801167:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  80116e:	e8 ac ef ff ff       	call   80011f <cprintf>
    return 0;
