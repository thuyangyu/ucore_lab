...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
umain(void) {
  ...
  80035f:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  800362:	e8 b5 0d 00 00       	call   80111c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  801067:	83 ec 48             	sub    $0x48,%esp
  80106a:	8b 45 0c             	mov    0xc(%ebp),%eax
  80106d:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  801070:	8b 45 08             	mov    0x8(%ebp),%eax
  801073:	89 04 24             	mov    %eax,(%esp)
  801076:	e8 f5 fa ff ff       	call   800b70 <strlen>
  80107b:	83 f8 03             	cmp    $0x3,%eax
  80107e:	77 4f                	ja     8010cf <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801080:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801084:	89 44 24 10          	mov    %eax,0x10(%esp)
  801088:	8b 45 08             	mov    0x8(%ebp),%eax
  80108b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80108f:	c7 44 24 08 20 14 80 	movl   $0x801420,0x8(%esp)
  801096:	00 
  801097:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  80109e:	00 
  80109f:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8010a2:	89 04 24             	mov    %eax,(%esp)
  8010a5:	e8 2a f9 ff ff       	call   8009d4 <snprintf>
    if (fork() == 0) {
  8010aa:	e8 30 f2 ff ff       	call   8002df <fork>
  8010af:	85 c0                	test   %eax,%eax
  8010b1:	75 1d                	jne    8010d0 <forkchild+0x6c>
        forktree(nxt);
  8010b3:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8010b6:	89 04 24             	mov    %eax,(%esp)
  8010b9:	e8 14 00 00 00       	call   8010d2 <forktree>
        yield();
  8010be:	e8 5f f2 ff ff       	call   800322 <yield>
        exit(0);
  8010c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010ca:	e8 f1 f1 ff ff       	call   8002c0 <exit>
void
forkchild(const char *cur, char branch) {
    char nxt[DEPTH + 1];
...
forktree(const char *cur) {
  ...
  8010d5:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  8010d8:	e8 65 f2 ff ff       	call   800342 <getpid>
  8010dd:	8b 55 08             	mov    0x8(%ebp),%edx
  8010e0:	89 54 24 08          	mov    %edx,0x8(%esp)
  8010e4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010e8:	c7 04 24 25 14 80 00 	movl   $0x801425,(%esp)
  8010ef:	e8 2b f0 ff ff       	call   80011f <cprintf>

    forkchild(cur, '0');
  8010f4:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  8010fb:	00 
  8010fc:	8b 45 08             	mov    0x8(%ebp),%eax
  8010ff:	89 04 24             	mov    %eax,(%esp)
  801102:	e8 5d ff ff ff       	call   801064 <forkchild>
    forkchild(cur, '1');
  801107:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  80110e:	00 
  80110f:	8b 45 08             	mov    0x8(%ebp),%eax
  801112:	89 04 24             	mov    %eax,(%esp)
  801115:	e8 4a ff ff ff       	call   801064 <forkchild>
}
  80111a:	c9                   	leave  
  80111b:	c3                   	ret    
...
main(void) {
  ...
  80111f:	83 e4 f0             	and    $0xfffffff0,%esp
  801122:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  801125:	c7 04 24 36 14 80 00 	movl   $0x801436,(%esp)
  80112c:	e8 a1 ff ff ff       	call   8010d2 <forktree>
    return 0;
