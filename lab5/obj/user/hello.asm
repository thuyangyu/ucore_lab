...
main(void) {
  ...
  80106a:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  80106d:	c7 04 24 a0 13 80 00 	movl   $0x8013a0,(%esp)
  801074:	e8 a6 f0 ff ff       	call   80011f <cprintf>
    cprintf("I am process %d.\n", getpid());
  801079:	e8 c4 f2 ff ff       	call   800342 <getpid>
  80107e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801082:	c7 04 24 b0 13 80 00 	movl   $0x8013b0,(%esp)
  801089:	e8 91 f0 ff ff       	call   80011f <cprintf>
    cprintf("hello pass.\n");
  80108e:	c7 04 24 c2 13 80 00 	movl   $0x8013c2,(%esp)
  801095:	e8 85 f0 ff ff       	call   80011f <cprintf>
    return 0;
