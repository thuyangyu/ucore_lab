...
main(void) {
  ...
  801076:	c7 04 24 80 13 80 00 	movl   $0x801380,(%esp)
  80107d:	e8 9d f0 ff ff       	call   80011f <cprintf>
    print_pgdir();
  801082:	e8 c8 f2 ff ff       	call   80034f <print_pgdir>
    cprintf("pgdir pass.\n");
  801087:	c7 04 24 97 13 80 00 	movl   $0x801397,(%esp)
  80108e:	e8 8c f0 ff ff       	call   80011f <cprintf>
    return 0;
