...
main(void) {
  ...
  80106a:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  80106d:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  80106f:	c7 44 24 08 80 13 80 	movl   $0x801380,0x8(%esp)
  801076:	00 
  801077:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  80107e:	00 
  80107f:	c7 04 24 8b 13 80 00 	movl   $0x80138b,(%esp)
  801086:	e8 a5 ef ff ff       	call   800030 <__panic>
