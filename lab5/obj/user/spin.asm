...
main(void) {
  ...
  801087:	75 0e                	jne    801097 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  801089:	c7 04 24 87 14 80 00 	movl   $0x801487,(%esp)
  801090:	e8 8a f0 ff ff       	call   80011f <cprintf>
        while (1);
  801095:	eb fe                	jmp    801095 <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  801097:	c7 04 24 a8 14 80 00 	movl   $0x8014a8,(%esp)
  80109e:	e8 7c f0 ff ff       	call   80011f <cprintf>

    yield();
  8010a3:	e8 7a f2 ff ff       	call   800322 <yield>
    yield();
  8010a8:	e8 75 f2 ff ff       	call   800322 <yield>
    yield();
  8010ad:	e8 70 f2 ff ff       	call   800322 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  8010b2:	c7 04 24 d0 14 80 00 	movl   $0x8014d0,(%esp)
  8010b9:	e8 61 f0 ff ff       	call   80011f <cprintf>

    assert((ret = kill(pid)) == 0);
  8010be:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c2:	89 04 24             	mov    %eax,(%esp)
  8010c5:	e8 65 f2 ff ff       	call   80032f <kill>
  8010ca:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010ce:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010d3:	74 24                	je     8010f9 <main+0x95>
  8010d5:	c7 44 24 0c f8 14 80 	movl   $0x8014f8,0xc(%esp)
  8010dc:	00 
  8010dd:	c7 44 24 08 0f 15 80 	movl   $0x80150f,0x8(%esp)
  8010e4:	00 
  8010e5:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  8010ec:	00 
  8010ed:	c7 04 24 24 15 80 00 	movl   $0x801524,(%esp)
  8010f4:	e8 37 ef ff ff       	call   800030 <__panic>
    cprintf("kill returns %d\n", ret);
  8010f9:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010fd:	89 44 24 04          	mov    %eax,0x4(%esp)
  801101:	c7 04 24 30 15 80 00 	movl   $0x801530,(%esp)
  801108:	e8 12 f0 ff ff       	call   80011f <cprintf>
  ...
  80111c:	e8 e7 f1 ff ff       	call   800308 <waitpid>
  801121:	89 44 24 18          	mov    %eax,0x18(%esp)
  801125:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80112a:	74 24                	je     801150 <main+0xec>
  80112c:	c7 44 24 0c 44 15 80 	movl   $0x801544,0xc(%esp)
  801133:	00 
  801134:	c7 44 24 08 0f 15 80 	movl   $0x80150f,0x8(%esp)
  80113b:	00 
  80113c:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801143:	00 
  801144:	c7 04 24 24 15 80 00 	movl   $0x801524,(%esp)
  80114b:	e8 e0 ee ff ff       	call   800030 <__panic>
    cprintf("wait returns %d\n", ret);
  801150:	8b 44 24 18          	mov    0x18(%esp),%eax
  801154:	89 44 24 04          	mov    %eax,0x4(%esp)
  801158:	c7 04 24 64 15 80 00 	movl   $0x801564,(%esp)
  80115f:	e8 bb ef ff ff       	call   80011f <cprintf>

    cprintf("spin may pass.\n");
  801164:	c7 04 24 75 15 80 00 	movl   $0x801575,(%esp)
  80116b:	e8 af ef ff ff       	call   80011f <cprintf>
    return 0;
