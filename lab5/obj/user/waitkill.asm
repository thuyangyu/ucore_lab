...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 00 12 80 00 	movl   $0x801200,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 1a 12 80 00 	movl   $0x80121a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 1c 12 80 00 	movl   $0x80121c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 1a 12 80 00 	movl   $0x80121a,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
...
umain(void) {
  ...
  80035f:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  800362:	e8 a5 0d 00 00       	call   80110c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 64 13 80 00       	add    $0x801364,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 88 13 80 00 	mov    0x801388(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 81 13 80 00       	mov    $0x801381,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  801067:	83 ec 08             	sub    $0x8,%esp
    yield();
  80106a:	e8 b3 f2 ff ff       	call   800322 <yield>
    yield();
  80106f:	e8 ae f2 ff ff       	call   800322 <yield>
    yield();
  801074:	e8 a9 f2 ff ff       	call   800322 <yield>
    yield();
  801079:	e8 a4 f2 ff ff       	call   800322 <yield>
    yield();
  80107e:	e8 9f f2 ff ff       	call   800322 <yield>
    yield();
  801083:	e8 9a f2 ff ff       	call   800322 <yield>
}
  801088:	c9                   	leave  
  801089:	c3                   	ret    
...
loop(void) {
  ...
  80108d:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801090:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
  801097:	e8 83 f0 ff ff       	call   80011f <cprintf>
    while (1);
  80109c:	eb fe                	jmp    80109c <loop+0x12>
...
work(void) {
  ...
  8010a1:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  8010a4:	c7 04 24 ea 14 80 00 	movl   $0x8014ea,(%esp)
  8010ab:	e8 6f f0 ff ff       	call   80011f <cprintf>
    do_yield();
  8010b0:	e8 af ff ff ff       	call   801064 <do_yield>
    if (kill(parent) == 0) {
  8010b5:	a1 08 20 80 00       	mov    0x802008,%eax
  8010ba:	89 04 24             	mov    %eax,(%esp)
  8010bd:	e8 6d f2 ff ff       	call   80032f <kill>
  8010c2:	85 c0                	test   %eax,%eax
  8010c4:	75 3a                	jne    801100 <work+0x62>
        cprintf("kill parent ok.\n");
  8010c6:	c7 04 24 f4 14 80 00 	movl   $0x8014f4,(%esp)
  8010cd:	e8 4d f0 ff ff       	call   80011f <cprintf>
        do_yield();
  8010d2:	e8 8d ff ff ff       	call   801064 <do_yield>
        if (kill(pid1) == 0) {
  8010d7:	a1 10 20 80 00       	mov    0x802010,%eax
  8010dc:	89 04 24             	mov    %eax,(%esp)
  8010df:	e8 4b f2 ff ff       	call   80032f <kill>
  8010e4:	85 c0                	test   %eax,%eax
  8010e6:	75 18                	jne    801100 <work+0x62>
            cprintf("kill child1 ok.\n");
  8010e8:	c7 04 24 05 15 80 00 	movl   $0x801505,(%esp)
  8010ef:	e8 2b f0 ff ff       	call   80011f <cprintf>
            exit(0);
  8010f4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010fb:	e8 c0 f1 ff ff       	call   8002c0 <exit>
        }
    }
    exit(-1);
  801100:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801107:	e8 b4 f1 ff ff       	call   8002c0 <exit>
...
main(void) {
  ...
  80110f:	83 e4 f0             	and    $0xfffffff0,%esp
  801112:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801115:	e8 28 f2 ff ff       	call   800342 <getpid>
  80111a:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80111f:	e8 bb f1 ff ff       	call   8002df <fork>
  801124:	a3 10 20 80 00       	mov    %eax,0x802010
  801129:	a1 10 20 80 00       	mov    0x802010,%eax
  80112e:	85 c0                	test   %eax,%eax
  801130:	75 05                	jne    801137 <main+0x2b>
        loop();
  801132:	e8 53 ff ff ff       	call   80108a <loop>
    }

    assert(pid1 > 0);
  801137:	a1 10 20 80 00       	mov    0x802010,%eax
  80113c:	85 c0                	test   %eax,%eax
  80113e:	7f 24                	jg     801164 <main+0x58>
  801140:	c7 44 24 0c 16 15 80 	movl   $0x801516,0xc(%esp)
  801147:	00 
  801148:	c7 44 24 08 1f 15 80 	movl   $0x80151f,0x8(%esp)
  80114f:	00 
  801150:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  801157:	00 
  801158:	c7 04 24 34 15 80 00 	movl   $0x801534,(%esp)
  80115f:	e8 cc ee ff ff       	call   800030 <__panic>

    if ((pid2 = fork()) == 0) {
  801164:	e8 76 f1 ff ff       	call   8002df <fork>
  801169:	a3 0c 20 80 00       	mov    %eax,0x80200c
  80116e:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801173:	85 c0                	test   %eax,%eax
  801175:	75 05                	jne    80117c <main+0x70>
        work();
  801177:	e8 22 ff ff ff       	call   80109e <work>
    }
    if (pid2 > 0) {
  80117c:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801181:	85 c0                	test   %eax,%eax
  801183:	7e 46                	jle    8011cb <main+0xbf>
        cprintf("wait child 1.\n");
  801185:	c7 04 24 44 15 80 00 	movl   $0x801544,(%esp)
  80118c:	e8 8e ef ff ff       	call   80011f <cprintf>
        waitpid(pid1, NULL);
  801191:	a1 10 20 80 00       	mov    0x802010,%eax
  801196:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80119d:	00 
  80119e:	89 04 24             	mov    %eax,(%esp)
  8011a1:	e8 62 f1 ff ff       	call   800308 <waitpid>
        panic("waitpid %d returns\n", pid1);
  8011a6:	a1 10 20 80 00       	mov    0x802010,%eax
  8011ab:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011af:	c7 44 24 08 53 15 80 	movl   $0x801553,0x8(%esp)
  8011b6:	00 
  8011b7:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  8011be:	00 
  8011bf:	c7 04 24 34 15 80 00 	movl   $0x801534,(%esp)
  8011c6:	e8 65 ee ff ff       	call   800030 <__panic>
    }
    else {
        kill(pid1);
  8011cb:	a1 10 20 80 00       	mov    0x802010,%eax
  8011d0:	89 04 24             	mov    %eax,(%esp)
  8011d3:	e8 57 f1 ff ff       	call   80032f <kill>
    }
    panic("FAIL: T.T\n");
  8011d8:	c7 44 24 08 67 15 80 	movl   $0x801567,0x8(%esp)
  8011df:	00 
  8011e0:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  8011e7:	00 
  8011e8:	c7 04 24 34 15 80 00 	movl   $0x801534,(%esp)
  8011ef:	e8 3c ee ff ff       	call   800030 <__panic>
