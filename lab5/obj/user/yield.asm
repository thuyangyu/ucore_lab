...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 00 11 80 00 	movl   $0x801100,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 1a 11 80 00 	movl   $0x80111a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 1c 11 80 00 	movl   $0x80111c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 1a 11 80 00 	movl   $0x80111a,(%esp)
...
exit(int error_code) {
  ...
  8002d1:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8004bb:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800621:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800725:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  80072c:	00 
  ...
  800751:	75 05                	jne    800758 <vprintfmt+0x1ae>
                p = "(null)";
  800753:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80106d:	e8 d0 f2 ff ff       	call   800342 <getpid>
  801072:	89 44 24 04          	mov    %eax,0x4(%esp)
  801076:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  80107d:	e8 9d f0 ff ff       	call   80011f <cprintf>
    for (i = 0; i < 5; i ++) {
  801082:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801089:	00 
  80108a:	eb 27                	jmp    8010b3 <main+0x4f>
        yield();
  80108c:	e8 91 f2 ff ff       	call   800322 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801091:	e8 ac f2 ff ff       	call   800342 <getpid>
  801096:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80109a:	89 54 24 08          	mov    %edx,0x8(%esp)
  80109e:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010a2:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  8010a9:	e8 71 f0 ff ff       	call   80011f <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  8010ae:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8010b3:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8010b8:	7e d2                	jle    80108c <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  8010ba:	e8 83 f2 ff ff       	call   800342 <getpid>
  8010bf:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c3:	c7 04 24 1f 14 80 00 	movl   $0x80141f,(%esp)
  8010ca:	e8 50 f0 ff ff       	call   80011f <cprintf>
    cprintf("yield pass.\n");
  8010cf:	c7 04 24 38 14 80 00 	movl   $0x801438,(%esp)
  8010d6:	e8 44 f0 ff ff       	call   80011f <cprintf>
    return 0;
