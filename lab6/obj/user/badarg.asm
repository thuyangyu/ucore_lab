...
exit(int error_code) {
  ...
  800301:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 64 13 80 00       	add    $0x801364,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 88 13 80 00 	mov    0x801388(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 81 13 80 00       	mov    $0x801381,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ba:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8010bd:	e8 4d f2 ff ff       	call   80030f <fork>
  8010c2:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010c6:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010cb:	75 33                	jne    801100 <main+0x4c>
        cprintf("fork ok.\n");
  8010cd:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
  8010d4:	e8 46 f0 ff ff       	call   80011f <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  8010d9:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010e0:	00 
  8010e1:	eb 0a                	jmp    8010ed <main+0x39>
            yield();
  8010e3:	e8 6a f2 ff ff       	call   800352 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  8010e8:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8010ed:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  8010f2:	7e ef                	jle    8010e3 <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  8010f4:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  8010fb:	e8 f0 f1 ff ff       	call   8002f0 <exit>
    }
    assert(pid > 0);
  801100:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801105:	7f 24                	jg     80112b <main+0x77>
  801107:	c7 44 24 0c ea 14 80 	movl   $0x8014ea,0xc(%esp)
  80110e:	00 
  80110f:	c7 44 24 08 f2 14 80 	movl   $0x8014f2,0x8(%esp)
  801116:	00 
  801117:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80111e:	00 
  80111f:	c7 04 24 07 15 80 00 	movl   $0x801507,(%esp)
  801126:	e8 05 ef ff ff       	call   800030 <__panic>
    assert(waitpid(-1, NULL) != 0);
  80112b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801132:	00 
  801133:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80113a:	e8 f9 f1 ff ff       	call   800338 <waitpid>
  80113f:	85 c0                	test   %eax,%eax
  801141:	75 24                	jne    801167 <main+0xb3>
  801143:	c7 44 24 0c 15 15 80 	movl   $0x801515,0xc(%esp)
  80114a:	00 
  80114b:	c7 44 24 08 f2 14 80 	movl   $0x8014f2,0x8(%esp)
  801152:	00 
  801153:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80115a:	00 
  80115b:	c7 04 24 07 15 80 00 	movl   $0x801507,(%esp)
  801162:	e8 c9 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801167:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  80116e:	c0 
  80116f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801173:	89 04 24             	mov    %eax,(%esp)
  801176:	e8 bd f1 ff ff       	call   800338 <waitpid>
  80117b:	85 c0                	test   %eax,%eax
  80117d:	75 24                	jne    8011a3 <main+0xef>
  80117f:	c7 44 24 0c 2c 15 80 	movl   $0x80152c,0xc(%esp)
  801186:	00 
  801187:	c7 44 24 08 f2 14 80 	movl   $0x8014f2,0x8(%esp)
  80118e:	00 
  80118f:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  801196:	00 
  801197:	c7 04 24 07 15 80 00 	movl   $0x801507,(%esp)
  80119e:	e8 8d ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8011a3:	8d 44 24 14          	lea    0x14(%esp),%eax
  8011a7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011ab:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011af:	89 04 24             	mov    %eax,(%esp)
  8011b2:	e8 81 f1 ff ff       	call   800338 <waitpid>
  8011b7:	85 c0                	test   %eax,%eax
  8011b9:	75 0b                	jne    8011c6 <main+0x112>
  8011bb:	8b 44 24 14          	mov    0x14(%esp),%eax
  8011bf:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8011c4:	74 24                	je     8011ea <main+0x136>
  8011c6:	c7 44 24 0c 54 15 80 	movl   $0x801554,0xc(%esp)
  8011cd:	00 
  8011ce:	c7 44 24 08 f2 14 80 	movl   $0x8014f2,0x8(%esp)
  8011d5:	00 
  8011d6:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8011dd:	00 
  8011de:	c7 04 24 07 15 80 00 	movl   $0x801507,(%esp)
  8011e5:	e8 46 ee ff ff       	call   800030 <__panic>
    cprintf("badarg pass.\n");
  8011ea:	c7 04 24 89 15 80 00 	movl   $0x801589,(%esp)
  8011f1:	e8 29 ef ff ff       	call   80011f <cprintf>
    return 0;
