...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 e0 10 80 00 	movl   $0x8010e0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 fa 10 80 00 	movl   $0x8010fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 fc 10 80 00 	movl   $0x8010fc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 fa 10 80 00 	movl   $0x8010fa,(%esp)
...
exit(int error_code) {
  ...
  800301:	c7 04 24 18 11 80 00 	movl   $0x801118,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 44 12 80 00       	add    $0x801244,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 68 12 80 00 	mov    0x801268(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 5e 12 80 	movl   $0x80125e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 61 12 80 00       	mov    $0x801261,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010bd:	66 b8 28 00          	mov    $0x28,%ax
  8010c1:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8010c3:	c7 44 24 08 c0 13 80 	movl   $0x8013c0,0x8(%esp)
  8010ca:	00 
  8010cb:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8010d2:	00 
  8010d3:	c7 04 24 cb 13 80 00 	movl   $0x8013cb,(%esp)
  8010da:	e8 51 ef ff ff       	call   800030 <__panic>
