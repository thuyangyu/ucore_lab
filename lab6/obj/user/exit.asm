...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 20 12 80 00 	movl   $0x801220,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 3a 12 80 00 	movl   $0x80123a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 3c 12 80 00 	movl   $0x80123c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 3a 12 80 00 	movl   $0x80123a,(%esp)
...
exit(int error_code) {
  ...
  800301:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 84 13 80 00       	add    $0x801384,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 a8 13 80 00 	mov    0x8013a8(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 9e 13 80 	movl   $0x80139e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be a1 13 80 00       	mov    $0x8013a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010bd:	c7 04 24 00 15 80 00 	movl   $0x801500,(%esp)
  8010c4:	e8 56 f0 ff ff       	call   80011f <cprintf>
    if ((pid = fork()) == 0) {
  8010c9:	e8 41 f2 ff ff       	call   80030f <fork>
  8010ce:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8010d2:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010d7:	75 3c                	jne    801115 <main+0x61>
        cprintf("I am the child.\n");
  8010d9:	c7 04 24 27 15 80 00 	movl   $0x801527,(%esp)
  8010e0:	e8 3a f0 ff ff       	call   80011f <cprintf>
        yield();
  8010e5:	e8 68 f2 ff ff       	call   800352 <yield>
        yield();
  8010ea:	e8 63 f2 ff ff       	call   800352 <yield>
        yield();
  8010ef:	e8 5e f2 ff ff       	call   800352 <yield>
        yield();
  8010f4:	e8 59 f2 ff ff       	call   800352 <yield>
        yield();
  8010f9:	e8 54 f2 ff ff       	call   800352 <yield>
        yield();
  8010fe:	e8 4f f2 ff ff       	call   800352 <yield>
        yield();
  801103:	e8 4a f2 ff ff       	call   800352 <yield>
        exit(magic);
  801108:	a1 08 20 80 00       	mov    0x802008,%eax
  80110d:	89 04 24             	mov    %eax,(%esp)
  801110:	e8 db f1 ff ff       	call   8002f0 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801115:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801119:	89 44 24 04          	mov    %eax,0x4(%esp)
  80111d:	c7 04 24 38 15 80 00 	movl   $0x801538,(%esp)
  801124:	e8 f6 ef ff ff       	call   80011f <cprintf>
    }
    assert(pid > 0);
  801129:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80112e:	7f 24                	jg     801154 <main+0xa0>
  801130:	c7 44 24 0c 5a 15 80 	movl   $0x80155a,0xc(%esp)
  801137:	00 
  801138:	c7 44 24 08 62 15 80 	movl   $0x801562,0x8(%esp)
  80113f:	00 
  801140:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801147:	00 
  801148:	c7 04 24 77 15 80 00 	movl   $0x801577,(%esp)
  80114f:	e8 dc ee ff ff       	call   800030 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801154:	c7 04 24 84 15 80 00 	movl   $0x801584,(%esp)
  80115b:	e8 bf ef ff ff       	call   80011f <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801160:	8d 44 24 18          	lea    0x18(%esp),%eax
  801164:	89 44 24 04          	mov    %eax,0x4(%esp)
  801168:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80116c:	89 04 24             	mov    %eax,(%esp)
  80116f:	e8 c4 f1 ff ff       	call   800338 <waitpid>
  801174:	85 c0                	test   %eax,%eax
  801176:	75 0d                	jne    801185 <main+0xd1>
  801178:	8b 54 24 18          	mov    0x18(%esp),%edx
  80117c:	a1 08 20 80 00       	mov    0x802008,%eax
  801181:	39 c2                	cmp    %eax,%edx
  801183:	74 24                	je     8011a9 <main+0xf5>
  801185:	c7 44 24 0c a4 15 80 	movl   $0x8015a4,0xc(%esp)
  80118c:	00 
  80118d:	c7 44 24 08 62 15 80 	movl   $0x801562,0x8(%esp)
  801194:	00 
  801195:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  80119c:	00 
  80119d:	c7 04 24 77 15 80 00 	movl   $0x801577,(%esp)
  8011a4:	e8 87 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8011a9:	8d 44 24 18          	lea    0x18(%esp),%eax
  8011ad:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011b1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011b5:	89 04 24             	mov    %eax,(%esp)
  8011b8:	e8 7b f1 ff ff       	call   800338 <waitpid>
  8011bd:	85 c0                	test   %eax,%eax
  8011bf:	74 09                	je     8011ca <main+0x116>
  8011c1:	e8 56 f1 ff ff       	call   80031c <wait>
  8011c6:	85 c0                	test   %eax,%eax
  8011c8:	75 24                	jne    8011ee <main+0x13a>
  8011ca:	c7 44 24 0c d0 15 80 	movl   $0x8015d0,0xc(%esp)
  8011d1:	00 
  8011d2:	c7 44 24 08 62 15 80 	movl   $0x801562,0x8(%esp)
  8011d9:	00 
  8011da:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8011e1:	00 
  8011e2:	c7 04 24 77 15 80 00 	movl   $0x801577,(%esp)
  8011e9:	e8 42 ee ff ff       	call   800030 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8011ee:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011f2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011f6:	c7 04 24 f8 15 80 00 	movl   $0x8015f8,(%esp)
  8011fd:	e8 1d ef ff ff       	call   80011f <cprintf>

    cprintf("exit pass.\n");
  801202:	c7 04 24 08 16 80 00 	movl   $0x801608,(%esp)
  801209:	e8 11 ef ff ff       	call   80011f <cprintf>
    return 0;
