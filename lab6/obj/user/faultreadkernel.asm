...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010bd:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8010c2:	8b 00                	mov    (%eax),%eax
  8010c4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c8:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  8010cf:	e8 4b f0 ff ff       	call   80011f <cprintf>
    panic("FAIL: T.T\n");
  8010d4:	c7 44 24 08 fe 13 80 	movl   $0x8013fe,0x8(%esp)
  8010db:	00 
  8010dc:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8010e3:	00 
  8010e4:	c7 04 24 09 14 80 00 	movl   $0x801409,(%esp)
  8010eb:	e8 40 ef ff ff       	call   800030 <__panic>
