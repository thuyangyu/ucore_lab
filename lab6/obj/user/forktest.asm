...
exit(int error_code) {
  ...
  800301:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010bd:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010c4:	00 
  8010c5:	eb 60                	jmp    801127 <main+0x73>
        if ((pid = fork()) == 0) {
  8010c7:	e8 43 f2 ff ff       	call   80030f <fork>
  8010cc:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010d0:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010d5:	75 20                	jne    8010f7 <main+0x43>
            cprintf("I am child %d\n", n);
  8010d7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010db:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010df:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  8010e6:	e8 34 f0 ff ff       	call   80011f <cprintf>
            exit(0);
  8010eb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010f2:	e8 f9 f1 ff ff       	call   8002f0 <exit>
        }
        assert(pid > 0);
  8010f7:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010fc:	7f 24                	jg     801122 <main+0x6e>
  8010fe:	c7 44 24 0c d3 14 80 	movl   $0x8014d3,0xc(%esp)
  801105:	00 
  801106:	c7 44 24 08 db 14 80 	movl   $0x8014db,0x8(%esp)
  80110d:	00 
  80110e:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801115:	00 
  801116:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  80111d:	e8 0e ef ff ff       	call   800030 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801122:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801127:	a1 c0 14 80 00       	mov    0x8014c0,%eax
  80112c:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801130:	7c 95                	jl     8010c7 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  801132:	a1 c0 14 80 00       	mov    0x8014c0,%eax
  801137:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80113b:	7e 4e                	jle    80118b <main+0xd7>
        panic("fork claimed to work %d times!\n", n);
  80113d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801141:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801145:	c7 44 24 08 00 15 80 	movl   $0x801500,0x8(%esp)
  80114c:	00 
  80114d:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801154:	00 
  801155:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  80115c:	e8 cf ee ff ff       	call   800030 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801161:	e8 b6 f1 ff ff       	call   80031c <wait>
  801166:	85 c0                	test   %eax,%eax
  801168:	74 1c                	je     801186 <main+0xd2>
            panic("wait stopped early\n");
  80116a:	c7 44 24 08 20 15 80 	movl   $0x801520,0x8(%esp)
  801171:	00 
  801172:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801179:	00 
  80117a:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  801181:	e8 aa ee ff ff       	call   800030 <__panic>
    ...
    for (; n > 0; n --) {
  801186:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  80118b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801190:	7f cf                	jg     801161 <main+0xad>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  801192:	e8 85 f1 ff ff       	call   80031c <wait>
  801197:	85 c0                	test   %eax,%eax
  801199:	75 1c                	jne    8011b7 <main+0x103>
        panic("wait got too many\n");
  80119b:	c7 44 24 08 34 15 80 	movl   $0x801534,0x8(%esp)
  8011a2:	00 
  8011a3:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8011aa:	00 
  8011ab:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  8011b2:	e8 79 ee ff ff       	call   800030 <__panic>
    }

    cprintf("forktest pass.\n");
  8011b7:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  8011be:	e8 5c ef ff ff       	call   80011f <cprintf>
    return 0;
