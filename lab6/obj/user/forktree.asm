...
umain(void) {
  ...
  8003af:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003b2:	e8 b5 0d 00 00       	call   80116c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  8010b7:	83 ec 48             	sub    $0x48,%esp
  8010ba:	8b 45 0c             	mov    0xc(%ebp),%eax
  8010bd:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8010c0:	8b 45 08             	mov    0x8(%ebp),%eax
  8010c3:	89 04 24             	mov    %eax,(%esp)
  8010c6:	e8 f5 fa ff ff       	call   800bc0 <strlen>
  8010cb:	83 f8 03             	cmp    $0x3,%eax
  8010ce:	77 4f                	ja     80111f <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8010d0:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8010d4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8010d8:	8b 45 08             	mov    0x8(%ebp),%eax
  8010db:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010df:	c7 44 24 08 80 14 80 	movl   $0x801480,0x8(%esp)
  8010e6:	00 
  8010e7:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  8010ee:	00 
  8010ef:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8010f2:	89 04 24             	mov    %eax,(%esp)
  8010f5:	e8 2a f9 ff ff       	call   800a24 <snprintf>
    if (fork() == 0) {
  8010fa:	e8 10 f2 ff ff       	call   80030f <fork>
  8010ff:	85 c0                	test   %eax,%eax
  801101:	75 1d                	jne    801120 <forkchild+0x6c>
        forktree(nxt);
  801103:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801106:	89 04 24             	mov    %eax,(%esp)
  801109:	e8 14 00 00 00       	call   801122 <forktree>
        yield();
  80110e:	e8 3f f2 ff ff       	call   800352 <yield>
        exit(0);
  801113:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80111a:	e8 d1 f1 ff ff       	call   8002f0 <exit>
void
forkchild(const char *cur, char branch) {
    char nxt[DEPTH + 1];
...
forktree(const char *cur) {
  ...
  801125:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801128:	e8 45 f2 ff ff       	call   800372 <getpid>
  80112d:	8b 55 08             	mov    0x8(%ebp),%edx
  801130:	89 54 24 08          	mov    %edx,0x8(%esp)
  801134:	89 44 24 04          	mov    %eax,0x4(%esp)
  801138:	c7 04 24 85 14 80 00 	movl   $0x801485,(%esp)
  80113f:	e8 db ef ff ff       	call   80011f <cprintf>

    forkchild(cur, '0');
  801144:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  80114b:	00 
  80114c:	8b 45 08             	mov    0x8(%ebp),%eax
  80114f:	89 04 24             	mov    %eax,(%esp)
  801152:	e8 5d ff ff ff       	call   8010b4 <forkchild>
    forkchild(cur, '1');
  801157:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  80115e:	00 
  80115f:	8b 45 08             	mov    0x8(%ebp),%eax
  801162:	89 04 24             	mov    %eax,(%esp)
  801165:	e8 4a ff ff ff       	call   8010b4 <forkchild>
}
  80116a:	c9                   	leave  
  80116b:	c3                   	ret    
...
main(void) {
  ...
  80116f:	83 e4 f0             	and    $0xfffffff0,%esp
  801172:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  801175:	c7 04 24 96 14 80 00 	movl   $0x801496,(%esp)
  80117c:	e8 a1 ff ff ff       	call   801122 <forktree>
    return 0;
