...
main(void) {
  ...
  8010ba:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8010bd:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  8010c4:	e8 56 f0 ff ff       	call   80011f <cprintf>
    cprintf("I am process %d.\n", getpid());
  8010c9:	e8 a4 f2 ff ff       	call   800372 <getpid>
  8010ce:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010d2:	c7 04 24 f0 13 80 00 	movl   $0x8013f0,(%esp)
  8010d9:	e8 41 f0 ff ff       	call   80011f <cprintf>
    cprintf("hello pass.\n");
  8010de:	c7 04 24 02 14 80 00 	movl   $0x801402,(%esp)
  8010e5:	e8 35 f0 ff ff       	call   80011f <cprintf>
    return 0;
