...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 9a 14 80 00 	movl   $0x80149a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 9c 14 80 00 	movl   $0x80149c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 9a 14 80 00 	movl   $0x80149a,(%esp)
...
exit(int error_code) {
  ...
  800301:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
...
umain(void) {
  ...
  8003af:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003b2:	e8 1b 0f 00 00       	call   8012d2 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 e4 15 80 00       	add    $0x8015e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 08 16 80 00 	mov    0x801608(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 fe 15 80 	movl   $0x8015fe,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 01 16 80 00       	mov    $0x801601,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8010bb:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8010c2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010c9:	eb 5f                	jmp    80112a <work+0x76>
        for (j = 0; j < size; j ++) {
  8010cb:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8010d2:	eb 4a                	jmp    80111e <work+0x6a>
            mata[i][j] = matb[i][j] = 1;
  8010d4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8010d7:	89 d0                	mov    %edx,%eax
  8010d9:	c1 e0 02             	shl    $0x2,%eax
  8010dc:	01 d0                	add    %edx,%eax
  8010de:	01 c0                	add    %eax,%eax
  8010e0:	03 45 f0             	add    -0x10(%ebp),%eax
  8010e3:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  8010ea:	01 00 00 00 
  ...
  8010fa:	03 45 f0             	add    -0x10(%ebp),%eax
  8010fd:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  ...
  801110:	03 45 f0             	add    -0x10(%ebp),%eax
  801113:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80111a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80111e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801121:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801124:	7c ae                	jl     8010d4 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801126:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80112a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80112d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801130:	7c 99                	jl     8010cb <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801132:	e8 1b f2 ff ff       	call   800352 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801137:	e8 36 f2 ff ff       	call   800372 <getpid>
  80113c:	8b 55 08             	mov    0x8(%ebp),%edx
  80113f:	89 54 24 08          	mov    %edx,0x8(%esp)
  801143:	89 44 24 04          	mov    %eax,0x4(%esp)
  801147:	c7 04 24 60 17 80 00 	movl   $0x801760,(%esp)
  80114e:	e8 cc ef ff ff       	call   80011f <cprintf>

    while (times -- > 0) {
  801153:	e9 46 01 00 00       	jmp    80129e <work+0x1ea>
        for (i = 0; i < size; i ++) {
  801158:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80115f:	e9 ac 00 00 00       	jmp    801210 <work+0x15c>
            for (j = 0; j < size; j ++) {
  801164:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80116b:	e9 90 00 00 00       	jmp    801200 <work+0x14c>
                matc[i][j] = 0;
  801170:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801173:	89 d0                	mov    %edx,%eax
  801175:	c1 e0 02             	shl    $0x2,%eax
  801178:	01 d0                	add    %edx,%eax
  80117a:	01 c0                	add    %eax,%eax
  80117c:	03 45 f0             	add    -0x10(%ebp),%eax
  80117f:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  801186:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  80118a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801191:	eb 61                	jmp    8011f4 <work+0x140>
  ...
  80119f:	03 45 f0             	add    -0x10(%ebp),%eax
  8011a2:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  8011a9:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011ac:	89 d0                	mov    %edx,%eax
  8011ae:	c1 e0 02             	shl    $0x2,%eax
  8011b1:	01 d0                	add    %edx,%eax
  8011b3:	01 c0                	add    %eax,%eax
  8011b5:	03 45 ec             	add    -0x14(%ebp),%eax
  8011b8:	8b 1c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ebx
  8011bf:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8011c2:	89 d0                	mov    %edx,%eax
  8011c4:	c1 e0 02             	shl    $0x2,%eax
  8011c7:	01 d0                	add    %edx,%eax
  8011c9:	01 c0                	add    %eax,%eax
  8011cb:	03 45 f0             	add    -0x10(%ebp),%eax
  8011ce:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  8011d5:	0f af c3             	imul   %ebx,%eax
  8011d8:	01 c1                	add    %eax,%ecx
  ...
  8011e6:	03 45 f0             	add    -0x10(%ebp),%eax
  8011e9:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  8011f0:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  8011f4:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8011f7:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8011fa:	7c 97                	jl     801193 <work+0xdf>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8011fc:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801200:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801203:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801206:	0f 8c 64 ff ff ff    	jl     801170 <work+0xbc>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  80120c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801210:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801213:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801216:	0f 8c 48 ff ff ff    	jl     801164 <work+0xb0>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801223:	eb 71                	jmp    801296 <work+0x1e2>
            for (j = 0; j < size; j ++) {
  801225:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80122c:	eb 5c                	jmp    80128a <work+0x1d6>
  ...
  80123a:	03 45 f0             	add    -0x10(%ebp),%eax
  80123d:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  801244:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801247:	89 d0                	mov    %edx,%eax
  801249:	c1 e0 02             	shl    $0x2,%eax
  80124c:	01 d0                	add    %edx,%eax
  80124e:	01 c0                	add    %eax,%eax
  801250:	03 45 f0             	add    -0x10(%ebp),%eax
  801253:	89 0c 85 c0 21 80 00 	mov    %ecx,0x8021c0(,%eax,4)
  80125a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80125d:	89 d0                	mov    %edx,%eax
  80125f:	c1 e0 02             	shl    $0x2,%eax
  801262:	01 d0                	add    %edx,%eax
  801264:	01 c0                	add    %eax,%eax
  801266:	03 45 f0             	add    -0x10(%ebp),%eax
  801269:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  801270:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801273:	89 d0                	mov    %edx,%eax
  801275:	c1 e0 02             	shl    $0x2,%eax
  801278:	01 d0                	add    %edx,%eax
  80127a:	01 c0                	add    %eax,%eax
  80127c:	03 45 f0             	add    -0x10(%ebp),%eax
  80127f:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801286:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80128a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80128d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801290:	7c 9c                	jl     80122e <work+0x17a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  801292:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801296:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801299:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80129c:	7c 87                	jl     801225 <work+0x171>
    ...
    while (times -- > 0) {
  80129e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  8012a2:	0f 95 c0             	setne  %al
  8012a5:	83 6d 08 01          	subl   $0x1,0x8(%ebp)
  8012a9:	84 c0                	test   %al,%al
  8012ab:	0f 85 a7 fe ff ff    	jne    801158 <work+0xa4>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8012b1:	e8 bc f0 ff ff       	call   800372 <getpid>
  8012b6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012ba:	c7 04 24 80 17 80 00 	movl   $0x801780,(%esp)
  8012c1:	e8 59 ee ff ff       	call   80011f <cprintf>
    exit(0);
  8012c6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8012cd:	e8 1e f0 ff ff       	call   8002f0 <exit>
...
int
main(void) {
  8012d2:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8012d6:	83 e4 f0             	and    $0xfffffff0,%esp
  8012d9:	ff 71 fc             	pushl  -0x4(%ecx)
  8012dc:	55                   	push   %ebp
  8012dd:	89 e5                	mov    %esp,%ebp
  8012df:	53                   	push   %ebx
  8012e0:	51                   	push   %ecx
  8012e1:	83 ec 30             	sub    $0x30,%esp
  8012e4:	89 e0                	mov    %esp,%eax
  8012e6:	89 c3                	mov    %eax,%ebx
    int pids[total];
  8012e8:	a1 90 17 80 00       	mov    0x801790,%eax
  8012ed:	83 e8 01             	sub    $0x1,%eax
  8012f0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  8012f3:	a1 90 17 80 00       	mov    0x801790,%eax
  8012f8:	c1 e0 02             	shl    $0x2,%eax
  8012fb:	8d 50 0f             	lea    0xf(%eax),%edx
  8012fe:	b8 10 00 00 00       	mov    $0x10,%eax
  801303:	83 e8 01             	sub    $0x1,%eax
  801306:	01 d0                	add    %edx,%eax
  801308:	c7 45 e4 10 00 00 00 	movl   $0x10,-0x1c(%ebp)
  80130f:	ba 00 00 00 00       	mov    $0x0,%edx
  801314:	f7 75 e4             	divl   -0x1c(%ebp)
  801317:	6b c0 10             	imul   $0x10,%eax,%eax
  80131a:	29 c4                	sub    %eax,%esp
  80131c:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801320:	83 c0 0f             	add    $0xf,%eax
  801323:	c1 e8 04             	shr    $0x4,%eax
  801326:	c1 e0 04             	shl    $0x4,%eax
  801329:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  80132c:	a1 90 17 80 00       	mov    0x801790,%eax
  801331:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801338:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80133b:	89 54 24 08          	mov    %edx,0x8(%esp)
  80133f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801346:	00 
  801347:	89 04 24             	mov    %eax,(%esp)
  80134a:	e8 ac fb ff ff       	call   800efb <memset>

    int i;
    for (i = 0; i < total; i ++) {
  80134f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801356:	eb 71                	jmp    8013c9 <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  801358:	e8 b2 ef ff ff       	call   80030f <fork>
  80135d:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801360:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801363:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801366:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801369:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80136c:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80136f:	85 c0                	test   %eax,%eax
  801371:	75 45                	jne    8013b8 <main+0xe6>
            srand(i * i);
  801373:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801376:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  80137a:	89 04 24             	mov    %eax,(%esp)
  80137d:	e8 24 f8 ff ff       	call   800ba6 <srand>
            int times = (((unsigned int)rand()) % total);
  801382:	e8 35 f7 ff ff       	call   800abc <rand>
  801387:	8b 15 90 17 80 00    	mov    0x801790,%edx
  ...
  80139e:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8013a2:	6b c0 64             	imul   $0x64,%eax,%eax
  8013a5:	05 e8 03 00 00       	add    $0x3e8,%eax
  8013aa:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8013ad:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8013b0:	89 04 24             	mov    %eax,(%esp)
  8013b3:	e8 fc fc ff ff       	call   8010b4 <work>
        }
        if (pids[i] < 0) {
  8013b8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013bb:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013be:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013c1:	85 c0                	test   %eax,%eax
  8013c3:	78 65                	js     80142a <main+0x158>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  8013c5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8013c9:	a1 90 17 80 00       	mov    0x801790,%eax
  8013ce:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8013d1:	7c 85                	jl     801358 <main+0x86>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  8013d3:	c7 04 24 94 17 80 00 	movl   $0x801794,(%esp)
  8013da:	e8 40 ed ff ff       	call   80011f <cprintf>

    for (i = 0; i < total; i ++) {
  8013df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8013e6:	eb 1b                	jmp    801403 <main+0x131>
        if (wait() != 0) {
  8013e8:	e8 2f ef ff ff       	call   80031c <wait>
  8013ed:	85 c0                	test   %eax,%eax
  8013ef:	74 0e                	je     8013ff <main+0x12d>
            cprintf("wait failed.\n");
  8013f1:	c7 04 24 9e 17 80 00 	movl   $0x80179e,(%esp)
  8013f8:	e8 22 ed ff ff       	call   80011f <cprintf>
            goto failed;
  8013fd:	eb 2c                	jmp    80142b <main+0x159>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  8013ff:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801403:	a1 90 17 80 00       	mov    0x801790,%eax
  801408:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80140b:	7c db                	jl     8013e8 <main+0x116>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  80140d:	c7 04 24 ac 17 80 00 	movl   $0x8017ac,(%esp)
  801414:	e8 06 ed ff ff       	call   80011f <cprintf>
    return 0;
  801419:	b8 00 00 00 00       	mov    $0x0,%eax
  80141e:	89 dc                	mov    %ebx,%esp
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
  ...
  801424:	5b                   	pop    %ebx
  801425:	5d                   	pop    %ebp
  801426:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801429:	c3                   	ret    
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
...
failed:
    for (i = 0; i < total; i ++) {
  80142b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801432:	eb 22                	jmp    801456 <main+0x184>
        if (pids[i] > 0) {
  801434:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801437:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80143a:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80143d:	85 c0                	test   %eax,%eax
  80143f:	7e 11                	jle    801452 <main+0x180>
            kill(pids[i]);
  801441:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801444:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801447:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80144a:	89 04 24             	mov    %eax,(%esp)
  80144d:	e8 0d ef ff ff       	call   80035f <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801452:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801456:	a1 90 17 80 00       	mov    0x801790,%eax
  80145b:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80145e:	7c d4                	jl     801434 <main+0x162>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801460:	c7 44 24 08 ba 17 80 	movl   $0x8017ba,0x8(%esp)
  801467:	00 
  801468:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  80146f:	00 
  801470:	c7 04 24 c5 17 80 00 	movl   $0x8017c5,(%esp)
  801477:	e8 b4 eb ff ff       	call   800030 <__panic>
