...
main(void) {
  ...
  8010c6:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  8010cd:	e8 4d f0 ff ff       	call   80011f <cprintf>
    print_pgdir();
  8010d2:	e8 a8 f2 ff ff       	call   80037f <print_pgdir>
    cprintf("pgdir pass.\n");
  8010d7:	c7 04 24 f7 13 80 00 	movl   $0x8013f7,(%esp)
  8010de:	e8 3c f0 ff ff       	call   80011f <cprintf>
    return 0;
