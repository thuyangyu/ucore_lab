...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 a0 13 80 00 	movl   $0x8013a0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 ba 13 80 00 	movl   $0x8013ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 bc 13 80 00 	movl   $0x8013bc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 ba 13 80 00 	movl   $0x8013ba,(%esp)
...
exit(int error_code) {
  ...
  800301:	c7 04 24 d8 13 80 00 	movl   $0x8013d8,(%esp)
...
umain(void) {
  ...
  8003af:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003b2:	e8 29 0d 00 00       	call   8010e0 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 04 15 80 00       	add    $0x801504,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 28 15 80 00 	mov    0x801528(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 1e 15 80 	movl   $0x80151e,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be 21 15 80 00       	mov    $0x801521,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8010c1:	eb 12                	jmp    8010d5 <spin_delay+0x21>
     {
          j = !j;
  8010c3:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8010c6:	85 c0                	test   %eax,%eax
  8010c8:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8010d1:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8010d5:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  8010dc:	75 e5                	jne    8010c3 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  8010e3:	53                   	push   %ebx
  8010e4:	83 e4 f0             	and    $0xfffffff0,%esp
  8010e7:	83 ec 30             	sub    $0x30,%esp
     int i,time;
     memset(pids, 0, sizeof(pids));
  8010ea:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  8010f1:	00 
  8010f2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010f9:	00 
  8010fa:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  801101:	e8 f5 fd ff ff       	call   800efb <memset>
     lab6_set_priority(TOTAL + 1);
  801106:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80110d:	e8 87 f2 ff ff       	call   800399 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801112:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801119:	00 
  80111a:	e9 04 01 00 00       	jmp    801223 <main+0x143>
          acc[i]=0;
  80111f:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801123:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  80112a:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80112e:	e8 dc f1 ff ff       	call   80030f <fork>
  801133:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801137:	89 04 95 30 20 80 00 	mov    %eax,0x802030(,%edx,4)
  80113e:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801142:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801149:	85 c0                	test   %eax,%eax
  80114b:	0f 85 ba 00 00 00    	jne    80120b <main+0x12b>
               lab6_set_priority(i + 1);
  801151:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801155:	83 c0 01             	add    $0x1,%eax
  801158:	89 04 24             	mov    %eax,(%esp)
  80115b:	e8 39 f2 ff ff       	call   800399 <lab6_set_priority>
               acc[i] = 0;
  801160:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801164:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  80116b:	00 00 00 00 
  80116f:	eb 01                	jmp    801172 <main+0x92>
  ...
  801171:	90                   	nop
          ...
          if ((pids[i] = fork()) == 0) {
               ...
               while (1) {
                    spin_delay();
  801172:	e8 3d ff ff ff       	call   8010b4 <spin_delay>
                    ++ acc[i];
  801177:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80117b:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801182:	8d 50 01             	lea    0x1(%eax),%edx
  801185:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801189:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  801190:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801194:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  80119b:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8011a0:	89 c8                	mov    %ecx,%eax
  8011a2:	f7 e2                	mul    %edx
  8011a4:	89 d0                	mov    %edx,%eax
  8011a6:	c1 e8 08             	shr    $0x8,%eax
  8011a9:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8011af:	89 ca                	mov    %ecx,%edx
  8011b1:	29 c2                	sub    %eax,%edx
  8011b3:	89 d0                	mov    %edx,%eax
  8011b5:	85 c0                	test   %eax,%eax
  8011b7:	75 b8                	jne    801171 <main+0x91>
                        if((time=gettime_msec())>MAX_TIME) {
  8011b9:	e8 ce f1 ff ff       	call   80038c <gettime_msec>
  8011be:	89 44 24 28          	mov    %eax,0x28(%esp)
  8011c2:	81 7c 24 28 e8 03 00 	cmpl   $0x3e8,0x28(%esp)
  8011c9:	00 
  8011ca:	7e a5                	jle    801171 <main+0x91>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8011cc:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011d0:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  8011d7:	e8 96 f1 ff ff       	call   800372 <getpid>
  8011dc:	8b 54 24 28          	mov    0x28(%esp),%edx
  8011e0:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8011e4:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8011e8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011ec:	c7 04 24 80 16 80 00 	movl   $0x801680,(%esp)
  8011f3:	e8 27 ef ff ff       	call   80011f <cprintf>
                            exit(acc[i]);
  8011f8:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011fc:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801203:	89 04 24             	mov    %eax,(%esp)
  801206:	e8 e5 f0 ff ff       	call   8002f0 <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  80120b:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80120f:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801216:	85 c0                	test   %eax,%eax
  801218:	0f 88 18 01 00 00    	js     801336 <main+0x256>
main(void) {
     int i,time;
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80121e:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801223:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801228:	0f 8e f1 fe ff ff    	jle    80111f <main+0x3f>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80122e:	c7 04 24 a0 16 80 00 	movl   $0x8016a0,(%esp)
  801235:	e8 e5 ee ff ff       	call   80011f <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80123a:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801241:	00 
  801242:	eb 6b                	jmp    8012af <main+0x1cf>
         status[i]=0;
  801244:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801248:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  80124f:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801253:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801257:	c1 e0 02             	shl    $0x2,%eax
  80125a:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  801260:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801264:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80126b:	89 54 24 04          	mov    %edx,0x4(%esp)
  80126f:	89 04 24             	mov    %eax,(%esp)
  801272:	e8 c1 f0 ff ff       	call   800338 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801277:	e8 10 f1 ff ff       	call   80038c <gettime_msec>
  80127c:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801280:	8b 0c 95 1c 20 80 00 	mov    0x80201c(,%edx,4),%ecx
  801287:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  80128b:	8b 14 95 30 20 80 00 	mov    0x802030(,%edx,4),%edx
  801292:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801296:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80129a:	89 54 24 04          	mov    %edx,0x4(%esp)
  80129e:	c7 04 24 c8 16 80 00 	movl   $0x8016c8,(%esp)
  8012a5:	e8 75 ee ff ff       	call   80011f <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8012aa:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  8012af:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  8012b4:	7e 8e                	jle    801244 <main+0x164>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  8012b6:	c7 04 24 e7 16 80 00 	movl   $0x8016e7,(%esp)
  8012bd:	e8 5d ee ff ff       	call   80011f <cprintf>
     cprintf("stride sched correct result:");
  8012c2:	c7 04 24 fd 16 80 00 	movl   $0x8016fd,(%esp)
  8012c9:	e8 51 ee ff ff       	call   80011f <cprintf>
     for (i = 0; i < TOTAL; i ++)
  8012ce:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  8012d5:	00 
  8012d6:	eb 41                	jmp    801319 <main+0x239>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  8012d8:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8012dc:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  8012e3:	01 c0                	add    %eax,%eax
  8012e5:	8b 15 1c 20 80 00    	mov    0x80201c,%edx
  8012eb:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  8012ef:	89 c2                	mov    %eax,%edx
  8012f1:	c1 fa 1f             	sar    $0x1f,%edx
  8012f4:	f7 7c 24 1c          	idivl  0x1c(%esp)
  8012f8:	83 c0 01             	add    $0x1,%eax
  8012fb:	89 c2                	mov    %eax,%edx
  8012fd:	c1 ea 1f             	shr    $0x1f,%edx
  801300:	01 d0                	add    %edx,%eax
  801302:	d1 f8                	sar    %eax
  801304:	89 44 24 04          	mov    %eax,0x4(%esp)
  801308:	c7 04 24 1a 17 80 00 	movl   $0x80171a,(%esp)
  80130f:	e8 0b ee ff ff       	call   80011f <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801314:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801319:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  80131e:	7e b8                	jle    8012d8 <main+0x1f8>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801320:	c7 04 24 1e 17 80 00 	movl   $0x80171e,(%esp)
  801327:	e8 f3 ed ff ff       	call   80011f <cprintf>
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801337:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  80133e:	00 
  80133f:	eb 27                	jmp    801368 <main+0x288>
          if (pids[i] > 0) {
  801341:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801345:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80134c:	85 c0                	test   %eax,%eax
  80134e:	7e 13                	jle    801363 <main+0x283>
               kill(pids[i]);
  801350:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801354:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80135b:	89 04 24             	mov    %eax,(%esp)
  80135e:	e8 fc ef ff ff       	call   80035f <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801363:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801368:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  80136d:	7e d2                	jle    801341 <main+0x261>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  80136f:	c7 44 24 08 20 17 80 	movl   $0x801720,0x8(%esp)
  801376:	00 
  801377:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  80137e:	00 
  80137f:	c7 04 24 2b 17 80 00 	movl   $0x80172b,(%esp)
  801386:	e8 a5 ec ff ff       	call   800030 <__panic>
