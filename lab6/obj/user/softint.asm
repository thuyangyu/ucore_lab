...
main(void) {
  ...
  8010ba:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8010bd:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8010bf:	c7 44 24 08 c0 13 80 	movl   $0x8013c0,0x8(%esp)
  8010c6:	00 
  8010c7:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8010ce:	00 
  8010cf:	c7 04 24 cb 13 80 00 	movl   $0x8013cb,(%esp)
