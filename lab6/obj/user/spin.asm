...
main(void) {
  ...
  8010d7:	75 0e                	jne    8010e7 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  8010d9:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  8010e0:	e8 3a f0 ff ff       	call   80011f <cprintf>
        while (1);
  8010e5:	eb fe                	jmp    8010e5 <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  8010e7:	c7 04 24 08 15 80 00 	movl   $0x801508,(%esp)
  8010ee:	e8 2c f0 ff ff       	call   80011f <cprintf>

    yield();
  8010f3:	e8 5a f2 ff ff       	call   800352 <yield>
    yield();
  8010f8:	e8 55 f2 ff ff       	call   800352 <yield>
    yield();
  8010fd:	e8 50 f2 ff ff       	call   800352 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  801102:	c7 04 24 30 15 80 00 	movl   $0x801530,(%esp)
  801109:	e8 11 f0 ff ff       	call   80011f <cprintf>

    assert((ret = kill(pid)) == 0);
  80110e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801112:	89 04 24             	mov    %eax,(%esp)
  801115:	e8 45 f2 ff ff       	call   80035f <kill>
  80111a:	89 44 24 18          	mov    %eax,0x18(%esp)
  80111e:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801123:	74 24                	je     801149 <main+0x95>
  801125:	c7 44 24 0c 58 15 80 	movl   $0x801558,0xc(%esp)
  80112c:	00 
  80112d:	c7 44 24 08 6f 15 80 	movl   $0x80156f,0x8(%esp)
  801134:	00 
  801135:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  80113c:	00 
  80113d:	c7 04 24 84 15 80 00 	movl   $0x801584,(%esp)
  801144:	e8 e7 ee ff ff       	call   800030 <__panic>
    cprintf("kill returns %d\n", ret);
  801149:	8b 44 24 18          	mov    0x18(%esp),%eax
  80114d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801151:	c7 04 24 90 15 80 00 	movl   $0x801590,(%esp)
  801158:	e8 c2 ef ff ff       	call   80011f <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  80115d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801164:	00 
  801165:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801169:	89 04 24             	mov    %eax,(%esp)
  80116c:	e8 c7 f1 ff ff       	call   800338 <waitpid>
  801171:	89 44 24 18          	mov    %eax,0x18(%esp)
  801175:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80117a:	74 24                	je     8011a0 <main+0xec>
  80117c:	c7 44 24 0c a4 15 80 	movl   $0x8015a4,0xc(%esp)
  801183:	00 
  801184:	c7 44 24 08 6f 15 80 	movl   $0x80156f,0x8(%esp)
  80118b:	00 
  80118c:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801193:	00 
  801194:	c7 04 24 84 15 80 00 	movl   $0x801584,(%esp)
  80119b:	e8 90 ee ff ff       	call   800030 <__panic>
    cprintf("wait returns %d\n", ret);
  8011a0:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011a4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011a8:	c7 04 24 c4 15 80 00 	movl   $0x8015c4,(%esp)
  8011af:	e8 6b ef ff ff       	call   80011f <cprintf>

    cprintf("spin may pass.\n");
  8011b4:	c7 04 24 d5 15 80 00 	movl   $0x8015d5,(%esp)
  8011bb:	e8 5f ef ff ff       	call   80011f <cprintf>
    return 0;
