...
main(void) {
  ...
  8010bd:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  8010c4:	e8 56 f0 ff ff       	call   80011f <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010c9:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010d0:	00 
  8010d1:	eb 38                	jmp    80110b <main+0x57>
        if (bigarray[i] != 0) {
  8010d3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010d7:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  8010de:	85 c0                	test   %eax,%eax
  8010e0:	74 24                	je     801106 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  8010e2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010ea:	c7 44 24 08 e0 14 80 	movl   $0x8014e0,0x8(%esp)
  8010f1:	00 
  8010f2:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  8010f9:	00 
  8010fa:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  801101:	e8 2a ef ff ff       	call   800030 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801106:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80110b:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801112:	00 
  801113:	7e be                	jle    8010d3 <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801115:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80111c:	00 
  80111d:	eb 14                	jmp    801133 <main+0x7f>
        bigarray[i] = i;
  80111f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801123:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801127:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
  ...
  80113a:	00 
  80113b:	7e e2                	jle    80111f <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80113d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801144:	00 
  801145:	eb 3c                	jmp    801183 <main+0xcf>
        if (bigarray[i] != i) {
  801147:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80114b:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  801152:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801156:	39 c2                	cmp    %eax,%edx
  801158:	74 24                	je     80117e <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  80115a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80115e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801162:	c7 44 24 08 0c 15 80 	movl   $0x80150c,0x8(%esp)
  801169:	00 
  80116a:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801171:	00 
  801172:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  801179:	e8 b2 ee ff ff       	call   800030 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80117e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801183:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80118a:	00 
  80118b:	7e ba                	jle    801147 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  80118d:	c7 04 24 34 15 80 00 	movl   $0x801534,(%esp)
  801194:	e8 86 ef ff ff       	call   80011f <cprintf>
    cprintf("testbss may pass.\n");
  801199:	c7 04 24 67 15 80 00 	movl   $0x801567,(%esp)
  8011a0:	e8 7a ef ff ff       	call   80011f <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8011a5:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8011ac:	00 00 00 
    asm volatile ("int $0x14");
  8011af:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8011b1:	c7 44 24 08 7a 15 80 	movl   $0x80157a,0x8(%esp)
  8011b8:	00 
  8011b9:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8011c0:	00 
  8011c1:	c7 04 24 fd 14 80 00 	movl   $0x8014fd,(%esp)
  8011c8:	e8 63 ee ff ff       	call   800030 <__panic>
