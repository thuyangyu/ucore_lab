...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 60 12 80 00 	movl   $0x801260,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 7a 12 80 00 	movl   $0x80127a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 7c 12 80 00 	movl   $0x80127c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 7a 12 80 00 	movl   $0x80127a,(%esp)
...
exit(int error_code) {
  ...
  800301:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
...
umain(void) {
  ...
  8003af:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003b2:	e8 a5 0d 00 00       	call   80115c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 c4 13 80 00       	add    $0x8013c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 e8 13 80 00 	mov    0x8013e8(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 de 13 80 	movl   $0x8013de,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be e1 13 80 00       	mov    $0x8013e1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8010b7:	83 ec 08             	sub    $0x8,%esp
    yield();
  8010ba:	e8 93 f2 ff ff       	call   800352 <yield>
    yield();
  8010bf:	e8 8e f2 ff ff       	call   800352 <yield>
    yield();
  8010c4:	e8 89 f2 ff ff       	call   800352 <yield>
    yield();
  8010c9:	e8 84 f2 ff ff       	call   800352 <yield>
    yield();
  8010ce:	e8 7f f2 ff ff       	call   800352 <yield>
    yield();
  8010d3:	e8 7a f2 ff ff       	call   800352 <yield>
}
  8010d8:	c9                   	leave  
  8010d9:	c3                   	ret    
...
loop(void) {
  ...
  8010dd:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  8010e0:	c7 04 24 40 15 80 00 	movl   $0x801540,(%esp)
  8010e7:	e8 33 f0 ff ff       	call   80011f <cprintf>
    while (1);
  8010ec:	eb fe                	jmp    8010ec <loop+0x12>
...
work(void) {
  ...
  8010f1:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  8010f4:	c7 04 24 4a 15 80 00 	movl   $0x80154a,(%esp)
  8010fb:	e8 1f f0 ff ff       	call   80011f <cprintf>
    do_yield();
  801100:	e8 af ff ff ff       	call   8010b4 <do_yield>
    if (kill(parent) == 0) {
  801105:	a1 08 20 80 00       	mov    0x802008,%eax
  80110a:	89 04 24             	mov    %eax,(%esp)
  80110d:	e8 4d f2 ff ff       	call   80035f <kill>
  801112:	85 c0                	test   %eax,%eax
  801114:	75 3a                	jne    801150 <work+0x62>
        cprintf("kill parent ok.\n");
  801116:	c7 04 24 54 15 80 00 	movl   $0x801554,(%esp)
  80111d:	e8 fd ef ff ff       	call   80011f <cprintf>
        do_yield();
  801122:	e8 8d ff ff ff       	call   8010b4 <do_yield>
        if (kill(pid1) == 0) {
  801127:	a1 10 20 80 00       	mov    0x802010,%eax
  80112c:	89 04 24             	mov    %eax,(%esp)
  80112f:	e8 2b f2 ff ff       	call   80035f <kill>
  801134:	85 c0                	test   %eax,%eax
  801136:	75 18                	jne    801150 <work+0x62>
            cprintf("kill child1 ok.\n");
  801138:	c7 04 24 65 15 80 00 	movl   $0x801565,(%esp)
  80113f:	e8 db ef ff ff       	call   80011f <cprintf>
            exit(0);
  801144:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80114b:	e8 a0 f1 ff ff       	call   8002f0 <exit>
        }
    }
    exit(-1);
  801150:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801157:	e8 94 f1 ff ff       	call   8002f0 <exit>
...
main(void) {
  ...
  80115f:	83 e4 f0             	and    $0xfffffff0,%esp
  801162:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801165:	e8 08 f2 ff ff       	call   800372 <getpid>
  80116a:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80116f:	e8 9b f1 ff ff       	call   80030f <fork>
  801174:	a3 10 20 80 00       	mov    %eax,0x802010
  801179:	a1 10 20 80 00       	mov    0x802010,%eax
  80117e:	85 c0                	test   %eax,%eax
  801180:	75 05                	jne    801187 <main+0x2b>
        loop();
  801182:	e8 53 ff ff ff       	call   8010da <loop>
    }

    assert(pid1 > 0);
  801187:	a1 10 20 80 00       	mov    0x802010,%eax
  80118c:	85 c0                	test   %eax,%eax
  80118e:	7f 24                	jg     8011b4 <main+0x58>
  801190:	c7 44 24 0c 76 15 80 	movl   $0x801576,0xc(%esp)
  801197:	00 
  801198:	c7 44 24 08 7f 15 80 	movl   $0x80157f,0x8(%esp)
  80119f:	00 
  8011a0:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8011a7:	00 
  8011a8:	c7 04 24 94 15 80 00 	movl   $0x801594,(%esp)
  8011af:	e8 7c ee ff ff       	call   800030 <__panic>

    if ((pid2 = fork()) == 0) {
  8011b4:	e8 56 f1 ff ff       	call   80030f <fork>
  8011b9:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8011be:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011c3:	85 c0                	test   %eax,%eax
  8011c5:	75 05                	jne    8011cc <main+0x70>
        work();
  8011c7:	e8 22 ff ff ff       	call   8010ee <work>
    }
    if (pid2 > 0) {
  8011cc:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011d1:	85 c0                	test   %eax,%eax
  8011d3:	7e 46                	jle    80121b <main+0xbf>
        cprintf("wait child 1.\n");
  8011d5:	c7 04 24 a4 15 80 00 	movl   $0x8015a4,(%esp)
  8011dc:	e8 3e ef ff ff       	call   80011f <cprintf>
        waitpid(pid1, NULL);
  8011e1:	a1 10 20 80 00       	mov    0x802010,%eax
  8011e6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8011ed:	00 
  8011ee:	89 04 24             	mov    %eax,(%esp)
  8011f1:	e8 42 f1 ff ff       	call   800338 <waitpid>
        panic("waitpid %d returns\n", pid1);
  8011f6:	a1 10 20 80 00       	mov    0x802010,%eax
  8011fb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011ff:	c7 44 24 08 b3 15 80 	movl   $0x8015b3,0x8(%esp)
  801206:	00 
  801207:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80120e:	00 
  80120f:	c7 04 24 94 15 80 00 	movl   $0x801594,(%esp)
  801216:	e8 15 ee ff ff       	call   800030 <__panic>
    }
    else {
        kill(pid1);
  80121b:	a1 10 20 80 00       	mov    0x802010,%eax
  801220:	89 04 24             	mov    %eax,(%esp)
  801223:	e8 37 f1 ff ff       	call   80035f <kill>
    }
    panic("FAIL: T.T\n");
  801228:	c7 44 24 08 c7 15 80 	movl   $0x8015c7,0x8(%esp)
  80122f:	00 
  801230:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801237:	00 
  801238:	c7 04 24 94 15 80 00 	movl   $0x801594,(%esp)
  80123f:	e8 ec ed ff ff       	call   800030 <__panic>
