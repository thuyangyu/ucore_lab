...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80050b:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800671:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800775:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  80077c:	00 
  ...
  8007a1:	75 05                	jne    8007a8 <vprintfmt+0x1ae>
                p = "(null)";
  8007a3:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010bd:	e8 b0 f2 ff ff       	call   800372 <getpid>
  8010c2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010c6:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  8010cd:	e8 4d f0 ff ff       	call   80011f <cprintf>
    for (i = 0; i < 5; i ++) {
  8010d2:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010d9:	00 
  8010da:	eb 27                	jmp    801103 <main+0x4f>
        yield();
  8010dc:	e8 71 f2 ff ff       	call   800352 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8010e1:	e8 8c f2 ff ff       	call   800372 <getpid>
  8010e6:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8010ea:	89 54 24 08          	mov    %edx,0x8(%esp)
  8010ee:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f2:	c7 04 24 3c 14 80 00 	movl   $0x80143c,(%esp)
  8010f9:	e8 21 f0 ff ff       	call   80011f <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  8010fe:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801103:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801108:	7e d2                	jle    8010dc <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  80110a:	e8 63 f2 ff ff       	call   800372 <getpid>
  80110f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801113:	c7 04 24 5f 14 80 00 	movl   $0x80145f,(%esp)
  80111a:	e8 00 f0 ff ff       	call   80011f <cprintf>
    cprintf("yield pass.\n");
  80111f:	c7 04 24 78 14 80 00 	movl   $0x801478,(%esp)
  801126:	e8 f4 ef ff ff       	call   80011f <cprintf>
    return 0;
