...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 40 12 80 00 	movl   $0x801240,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 5a 12 80 00 	movl   $0x80125a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 5c 12 80 00 	movl   $0x80125c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 5a 12 80 00 	movl   $0x80125a,(%esp)
...
exit(int error_code) {
  ...
  80031d:	c7 04 24 78 12 80 00 	movl   $0x801278,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 a4 13 80 00       	add    $0x8013a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 c8 13 80 00 	mov    0x8013c8(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 be 13 80 	movl   $0x8013be,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be c1 13 80 00       	mov    $0x8013c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ea:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8010ed:	e8 39 f2 ff ff       	call   80032b <fork>
  8010f2:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010f6:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010fb:	75 33                	jne    801130 <main+0x4c>
        cprintf("fork ok.\n");
  8010fd:	c7 04 24 20 15 80 00 	movl   $0x801520,(%esp)
  801104:	e8 16 f0 ff ff       	call   80011f <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  801109:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801110:	00 
  801111:	eb 0a                	jmp    80111d <main+0x39>
            yield();
  801113:	e8 56 f2 ff ff       	call   80036e <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  801118:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80111d:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  801122:	7e ef                	jle    801113 <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  801124:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  80112b:	e8 dc f1 ff ff       	call   80030c <exit>
    }
    assert(pid > 0);
  801130:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801135:	7f 24                	jg     80115b <main+0x77>
  801137:	c7 44 24 0c 2a 15 80 	movl   $0x80152a,0xc(%esp)
  80113e:	00 
  80113f:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  801146:	00 
  801147:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  80114e:	00 
  80114f:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  801156:	e8 d5 ee ff ff       	call   800030 <__panic>
    assert(waitpid(-1, NULL) != 0);
  80115b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801162:	00 
  801163:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80116a:	e8 e5 f1 ff ff       	call   800354 <waitpid>
  80116f:	85 c0                	test   %eax,%eax
  801171:	75 24                	jne    801197 <main+0xb3>
  801173:	c7 44 24 0c 55 15 80 	movl   $0x801555,0xc(%esp)
  80117a:	00 
  80117b:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  801182:	00 
  801183:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  80118a:	00 
  80118b:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  801192:	e8 99 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801197:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  80119e:	c0 
  80119f:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011a3:	89 04 24             	mov    %eax,(%esp)
  8011a6:	e8 a9 f1 ff ff       	call   800354 <waitpid>
  8011ab:	85 c0                	test   %eax,%eax
  8011ad:	75 24                	jne    8011d3 <main+0xef>
  8011af:	c7 44 24 0c 6c 15 80 	movl   $0x80156c,0xc(%esp)
  8011b6:	00 
  8011b7:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  8011be:	00 
  8011bf:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8011c6:	00 
  8011c7:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  8011ce:	e8 5d ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8011d3:	8d 44 24 14          	lea    0x14(%esp),%eax
  8011d7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011db:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011df:	89 04 24             	mov    %eax,(%esp)
  8011e2:	e8 6d f1 ff ff       	call   800354 <waitpid>
  8011e7:	85 c0                	test   %eax,%eax
  8011e9:	75 0b                	jne    8011f6 <main+0x112>
  8011eb:	8b 44 24 14          	mov    0x14(%esp),%eax
  8011ef:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8011f4:	74 24                	je     80121a <main+0x136>
  8011f6:	c7 44 24 0c 94 15 80 	movl   $0x801594,0xc(%esp)
  8011fd:	00 
  8011fe:	c7 44 24 08 32 15 80 	movl   $0x801532,0x8(%esp)
  801205:	00 
  801206:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  80120d:	00 
  80120e:	c7 04 24 47 15 80 00 	movl   $0x801547,(%esp)
  801215:	e8 16 ee ff ff       	call   800030 <__panic>
    cprintf("badarg pass.\n");
  80121a:	c7 04 24 c9 15 80 00 	movl   $0x8015c9,(%esp)
  801221:	e8 f9 ee ff ff       	call   80011f <cprintf>
    return 0;
