...
exit(int error_code) {
  ...
  80031d:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ea:	83 ec 20             	sub    $0x20,%esp
    cprintf("value is %d.\n", 1 / zero);
  8010ed:	8b 15 08 20 80 00    	mov    0x802008,%edx
  8010f3:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  8010f7:	b8 01 00 00 00       	mov    $0x1,%eax
  8010fc:	89 c2                	mov    %eax,%edx
  8010fe:	c1 fa 1f             	sar    $0x1f,%edx
  801101:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801105:	89 44 24 04          	mov    %eax,0x4(%esp)
  801109:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  801110:	e8 0a f0 ff ff       	call   80011f <cprintf>
    panic("FAIL: T.T\n");
  801115:	c7 44 24 08 2e 14 80 	movl   $0x80142e,0x8(%esp)
  80111c:	00 
  80111d:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801124:	00 
  801125:	c7 04 24 39 14 80 00 	movl   $0x801439,(%esp)
  80112c:	e8 ff ee ff ff       	call   800030 <__panic>
