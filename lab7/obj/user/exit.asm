...
exit(int error_code) {
  ...
  80031d:	c7 04 24 98 12 80 00 	movl   $0x801298,(%esp)
...
umain(void) {
  ...
  8003df:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003e2:	e8 fd 0c 00 00       	call   8010e4 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 c4 13 80 00       	add    $0x8013c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 e8 13 80 00 	mov    0x8013e8(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 de 13 80 	movl   $0x8013de,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be e1 13 80 00       	mov    $0x8013e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010e7:	83 e4 f0             	and    $0xfffffff0,%esp
  8010ea:	83 ec 20             	sub    $0x20,%esp
    int pid, code;
    cprintf("I am the parent. Forking the child...\n");
  8010ed:	c7 04 24 40 15 80 00 	movl   $0x801540,(%esp)
  8010f4:	e8 26 f0 ff ff       	call   80011f <cprintf>
    if ((pid = fork()) == 0) {
  8010f9:	e8 2d f2 ff ff       	call   80032b <fork>
  8010fe:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801102:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801107:	75 3c                	jne    801145 <main+0x61>
        cprintf("I am the child.\n");
  801109:	c7 04 24 67 15 80 00 	movl   $0x801567,(%esp)
  801110:	e8 0a f0 ff ff       	call   80011f <cprintf>
        yield();
  801115:	e8 54 f2 ff ff       	call   80036e <yield>
        yield();
  80111a:	e8 4f f2 ff ff       	call   80036e <yield>
        yield();
  80111f:	e8 4a f2 ff ff       	call   80036e <yield>
        yield();
  801124:	e8 45 f2 ff ff       	call   80036e <yield>
        yield();
  801129:	e8 40 f2 ff ff       	call   80036e <yield>
        yield();
  80112e:	e8 3b f2 ff ff       	call   80036e <yield>
        yield();
  801133:	e8 36 f2 ff ff       	call   80036e <yield>
        exit(magic);
  801138:	a1 08 20 80 00       	mov    0x802008,%eax
  80113d:	89 04 24             	mov    %eax,(%esp)
  801140:	e8 c7 f1 ff ff       	call   80030c <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801145:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801149:	89 44 24 04          	mov    %eax,0x4(%esp)
  80114d:	c7 04 24 78 15 80 00 	movl   $0x801578,(%esp)
  801154:	e8 c6 ef ff ff       	call   80011f <cprintf>
    }
    assert(pid > 0);
  801159:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80115e:	7f 24                	jg     801184 <main+0xa0>
  801160:	c7 44 24 0c 9a 15 80 	movl   $0x80159a,0xc(%esp)
  801167:	00 
  801168:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  80116f:	00 
  801170:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801177:	00 
  801178:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  80117f:	e8 ac ee ff ff       	call   800030 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801184:	c7 04 24 c4 15 80 00 	movl   $0x8015c4,(%esp)
  80118b:	e8 8f ef ff ff       	call   80011f <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801190:	8d 44 24 18          	lea    0x18(%esp),%eax
  801194:	89 44 24 04          	mov    %eax,0x4(%esp)
  801198:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80119c:	89 04 24             	mov    %eax,(%esp)
  80119f:	e8 b0 f1 ff ff       	call   800354 <waitpid>
  8011a4:	85 c0                	test   %eax,%eax
  8011a6:	75 0d                	jne    8011b5 <main+0xd1>
  8011a8:	8b 54 24 18          	mov    0x18(%esp),%edx
  8011ac:	a1 08 20 80 00       	mov    0x802008,%eax
  8011b1:	39 c2                	cmp    %eax,%edx
  8011b3:	74 24                	je     8011d9 <main+0xf5>
  8011b5:	c7 44 24 0c e4 15 80 	movl   $0x8015e4,0xc(%esp)
  8011bc:	00 
  8011bd:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  8011c4:	00 
  8011c5:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8011cc:	00 
  8011cd:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  8011d4:	e8 57 ee ff ff       	call   800030 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8011d9:	8d 44 24 18          	lea    0x18(%esp),%eax
  8011dd:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011e1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011e5:	89 04 24             	mov    %eax,(%esp)
  8011e8:	e8 67 f1 ff ff       	call   800354 <waitpid>
  8011ed:	85 c0                	test   %eax,%eax
  8011ef:	74 09                	je     8011fa <main+0x116>
  8011f1:	e8 42 f1 ff ff       	call   800338 <wait>
  8011f6:	85 c0                	test   %eax,%eax
  8011f8:	75 24                	jne    80121e <main+0x13a>
  8011fa:	c7 44 24 0c 10 16 80 	movl   $0x801610,0xc(%esp)
  801201:	00 
  801202:	c7 44 24 08 a2 15 80 	movl   $0x8015a2,0x8(%esp)
  801209:	00 
  80120a:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801211:	00 
  801212:	c7 04 24 b7 15 80 00 	movl   $0x8015b7,(%esp)
  801219:	e8 12 ee ff ff       	call   800030 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  80121e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801222:	89 44 24 04          	mov    %eax,0x4(%esp)
  801226:	c7 04 24 38 16 80 00 	movl   $0x801638,(%esp)
  80122d:	e8 ed ee ff ff       	call   80011f <cprintf>

    cprintf("exit pass.\n");
  801232:	c7 04 24 48 16 80 00 	movl   $0x801648,(%esp)
  801239:	e8 e1 ee ff ff       	call   80011f <cprintf>
    return 0;
