...
exit(int error_code) {
  ...
  80031d:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ed:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8010f2:	8b 00                	mov    (%eax),%eax
  8010f4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f8:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  8010ff:	e8 1b f0 ff ff       	call   80011f <cprintf>
    panic("FAIL: T.T\n");
  801104:	c7 44 24 08 1e 14 80 	movl   $0x80141e,0x8(%esp)
  80110b:	00 
  80110c:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801113:	00 
  801114:	c7 04 24 29 14 80 00 	movl   $0x801429,(%esp)
  80111b:	e8 10 ef ff ff       	call   800030 <__panic>
