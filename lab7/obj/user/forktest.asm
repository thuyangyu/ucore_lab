...
exit(int error_code) {
  ...
  80031d:	c7 04 24 38 12 80 00 	movl   $0x801238,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 64 13 80 00       	add    $0x801364,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 88 13 80 00 	mov    0x801388(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 81 13 80 00       	mov    $0x801381,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010f4:	00 
  8010f5:	eb 60                	jmp    801157 <main+0x73>
        if ((pid = fork()) == 0) {
  8010f7:	e8 2f f2 ff ff       	call   80032b <fork>
  8010fc:	89 44 24 18          	mov    %eax,0x18(%esp)
  801100:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801105:	75 20                	jne    801127 <main+0x43>
            cprintf("I am child %d\n", n);
  801107:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80110b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80110f:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  801116:	e8 04 f0 ff ff       	call   80011f <cprintf>
            exit(0);
  80111b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801122:	e8 e5 f1 ff ff       	call   80030c <exit>
        }
        assert(pid > 0);
  801127:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80112c:	7f 24                	jg     801152 <main+0x6e>
  80112e:	c7 44 24 0c f3 14 80 	movl   $0x8014f3,0xc(%esp)
  801135:	00 
  801136:	c7 44 24 08 fb 14 80 	movl   $0x8014fb,0x8(%esp)
  80113d:	00 
  80113e:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801145:	00 
  801146:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  80114d:	e8 de ee ff ff       	call   800030 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801152:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801157:	a1 e0 14 80 00       	mov    0x8014e0,%eax
  80115c:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801160:	7c 95                	jl     8010f7 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  801162:	a1 e0 14 80 00       	mov    0x8014e0,%eax
  801167:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80116b:	7e 4e                	jle    8011bb <main+0xd7>
        panic("fork claimed to work %d times!\n", n);
  80116d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801171:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801175:	c7 44 24 08 20 15 80 	movl   $0x801520,0x8(%esp)
  80117c:	00 
  80117d:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801184:	00 
  801185:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  80118c:	e8 9f ee ff ff       	call   800030 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801191:	e8 a2 f1 ff ff       	call   800338 <wait>
  801196:	85 c0                	test   %eax,%eax
  801198:	74 1c                	je     8011b6 <main+0xd2>
            panic("wait stopped early\n");
  80119a:	c7 44 24 08 40 15 80 	movl   $0x801540,0x8(%esp)
  8011a1:	00 
  8011a2:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8011a9:	00 
  8011aa:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  8011b1:	e8 7a ee ff ff       	call   800030 <__panic>
    ...
    for (; n > 0; n --) {
  8011b6:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  8011bb:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8011c0:	7f cf                	jg     801191 <main+0xad>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8011c2:	e8 71 f1 ff ff       	call   800338 <wait>
  8011c7:	85 c0                	test   %eax,%eax
  8011c9:	75 1c                	jne    8011e7 <main+0x103>
        panic("wait got too many\n");
  8011cb:	c7 44 24 08 54 15 80 	movl   $0x801554,0x8(%esp)
  8011d2:	00 
  8011d3:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8011da:	00 
  8011db:	c7 04 24 10 15 80 00 	movl   $0x801510,(%esp)
  8011e2:	e8 49 ee ff ff       	call   800030 <__panic>
    }

    cprintf("forktest pass.\n");
  8011e7:	c7 04 24 67 15 80 00 	movl   $0x801567,(%esp)
  8011ee:	e8 2c ef ff ff       	call   80011f <cprintf>
    return 0;
