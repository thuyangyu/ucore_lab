...
main(void) {
  ...
  8010ea:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8010ed:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  8010f4:	e8 26 f0 ff ff       	call   80011f <cprintf>
    cprintf("I am process %d.\n", getpid());
  8010f9:	e8 90 f2 ff ff       	call   80038e <getpid>
  8010fe:	89 44 24 04          	mov    %eax,0x4(%esp)
  801102:	c7 04 24 30 14 80 00 	movl   $0x801430,(%esp)
  801109:	e8 11 f0 ff ff       	call   80011f <cprintf>
    cprintf("hello pass.\n");
  80110e:	c7 04 24 42 14 80 00 	movl   $0x801442,(%esp)
  801115:	e8 05 f0 ff ff       	call   80011f <cprintf>
    return 0;
