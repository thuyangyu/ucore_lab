...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 da 14 80 00 	movl   $0x8014da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 dc 14 80 00 	movl   $0x8014dc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 da 14 80 00 	movl   $0x8014da,(%esp)
...
exit(int error_code) {
  ...
  80031d:	c7 04 24 f8 14 80 00 	movl   $0x8014f8,(%esp)
...
umain(void) {
  ...
  8003df:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003e2:	e8 1b 0f 00 00       	call   801302 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 24 16 80 00       	add    $0x801624,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 48 16 80 00 	mov    0x801648(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 3e 16 80 	movl   $0x80163e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 41 16 80 00       	mov    $0x801641,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8010eb:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8010f2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010f9:	eb 5f                	jmp    80115a <work+0x76>
        for (j = 0; j < size; j ++) {
  8010fb:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801102:	eb 4a                	jmp    80114e <work+0x6a>
            mata[i][j] = matb[i][j] = 1;
  ...
  801113:	c7 04 85 c0 21 80 00 	movl   $0x1,0x8021c0(,%eax,4)
  80111a:	01 00 00 00 
  ...
  80112a:	03 45 f0             	add    -0x10(%ebp),%eax
  ...
  801140:	03 45 f0             	add    -0x10(%ebp),%eax
  801143:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80114a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80114e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801151:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801154:	7c ae                	jl     801104 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801156:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80115a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80115d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801160:	7c 99                	jl     8010fb <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801162:	e8 07 f2 ff ff       	call   80036e <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801167:	e8 22 f2 ff ff       	call   80038e <getpid>
  80116c:	8b 55 08             	mov    0x8(%ebp),%edx
  80116f:	89 54 24 08          	mov    %edx,0x8(%esp)
  801173:	89 44 24 04          	mov    %eax,0x4(%esp)
  801177:	c7 04 24 a0 17 80 00 	movl   $0x8017a0,(%esp)
  80117e:	e8 9c ef ff ff       	call   80011f <cprintf>

    while (times -- > 0) {
  801183:	e9 46 01 00 00       	jmp    8012ce <work+0x1ea>
        for (i = 0; i < size; i ++) {
  801188:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80118f:	e9 ac 00 00 00       	jmp    801240 <work+0x15c>
            for (j = 0; j < size; j ++) {
  801194:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80119b:	e9 90 00 00 00       	jmp    801230 <work+0x14c>
                matc[i][j] = 0;
  ...
  8011ac:	03 45 f0             	add    -0x10(%ebp),%eax
  8011af:	c7 04 85 60 23 80 00 	movl   $0x0,0x802360(,%eax,4)
  8011b6:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8011ba:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8011c1:	eb 61                	jmp    801224 <work+0x140>
  ...
  8011cf:	03 45 f0             	add    -0x10(%ebp),%eax
  8011d2:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  8011d9:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011dc:	89 d0                	mov    %edx,%eax
  8011de:	c1 e0 02             	shl    $0x2,%eax
  8011e1:	01 d0                	add    %edx,%eax
  8011e3:	01 c0                	add    %eax,%eax
  8011e5:	03 45 ec             	add    -0x14(%ebp),%eax
  8011e8:	8b 1c 85 20 20 80 00 	mov    0x802020(,%eax,4),%ebx
  8011ef:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8011f2:	89 d0                	mov    %edx,%eax
  8011f4:	c1 e0 02             	shl    $0x2,%eax
  8011f7:	01 d0                	add    %edx,%eax
  8011f9:	01 c0                	add    %eax,%eax
  8011fb:	03 45 f0             	add    -0x10(%ebp),%eax
  8011fe:	8b 04 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%eax
  801205:	0f af c3             	imul   %ebx,%eax
  801208:	01 c1                	add    %eax,%ecx
  ...
  801216:	03 45 f0             	add    -0x10(%ebp),%eax
  801219:	89 0c 85 60 23 80 00 	mov    %ecx,0x802360(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  801220:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  801224:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801227:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80122a:	7c 97                	jl     8011c3 <work+0xdf>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  80122c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801230:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801233:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801236:	0f 8c 64 ff ff ff    	jl     8011a0 <work+0xbc>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  80123c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801240:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801243:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801246:	0f 8c 48 ff ff ff    	jl     801194 <work+0xb0>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801253:	eb 71                	jmp    8012c6 <work+0x1e2>
            for (j = 0; j < size; j ++) {
  801255:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80125c:	eb 5c                	jmp    8012ba <work+0x1d6>
                mata[i][j] = matb[i][j] = matc[i][j];
  80125e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801261:	89 d0                	mov    %edx,%eax
  801263:	c1 e0 02             	shl    $0x2,%eax
  801266:	01 d0                	add    %edx,%eax
  801268:	01 c0                	add    %eax,%eax
  80126a:	03 45 f0             	add    -0x10(%ebp),%eax
  80126d:	8b 0c 85 60 23 80 00 	mov    0x802360(,%eax,4),%ecx
  ...
  801280:	03 45 f0             	add    -0x10(%ebp),%eax
  801283:	89 0c 85 c0 21 80 00 	mov    %ecx,0x8021c0(,%eax,4)
  80128a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80128d:	89 d0                	mov    %edx,%eax
  80128f:	c1 e0 02             	shl    $0x2,%eax
  801292:	01 d0                	add    %edx,%eax
  801294:	01 c0                	add    %eax,%eax
  801296:	03 45 f0             	add    -0x10(%ebp),%eax
  801299:	8b 0c 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%ecx
  ...
  8012ac:	03 45 f0             	add    -0x10(%ebp),%eax
  8012af:	89 0c 85 20 20 80 00 	mov    %ecx,0x802020(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8012b6:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8012ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8012bd:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8012c0:	7c 9c                	jl     80125e <work+0x17a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8012c2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8012c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8012c9:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8012cc:	7c 87                	jl     801255 <work+0x171>
  ...
  8012d2:	0f 95 c0             	setne  %al
  8012d5:	83 6d 08 01          	subl   $0x1,0x8(%ebp)
  8012d9:	84 c0                	test   %al,%al
  8012db:	0f 85 a7 fe ff ff    	jne    801188 <work+0xa4>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8012e1:	e8 a8 f0 ff ff       	call   80038e <getpid>
  8012e6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012ea:	c7 04 24 c0 17 80 00 	movl   $0x8017c0,(%esp)
  8012f1:	e8 29 ee ff ff       	call   80011f <cprintf>
    exit(0);
  8012f6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8012fd:	e8 0a f0 ff ff       	call   80030c <exit>
...
int
main(void) {
  801302:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801306:	83 e4 f0             	and    $0xfffffff0,%esp
  801309:	ff 71 fc             	pushl  -0x4(%ecx)
  80130c:	55                   	push   %ebp
  80130d:	89 e5                	mov    %esp,%ebp
  80130f:	53                   	push   %ebx
  801310:	51                   	push   %ecx
  801311:	83 ec 30             	sub    $0x30,%esp
  801314:	89 e0                	mov    %esp,%eax
  801316:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801318:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  80131d:	83 e8 01             	sub    $0x1,%eax
  801320:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801323:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  801328:	c1 e0 02             	shl    $0x2,%eax
  80132b:	8d 50 0f             	lea    0xf(%eax),%edx
  80132e:	b8 10 00 00 00       	mov    $0x10,%eax
  801333:	83 e8 01             	sub    $0x1,%eax
  801336:	01 d0                	add    %edx,%eax
  801338:	c7 45 e4 10 00 00 00 	movl   $0x10,-0x1c(%ebp)
  80133f:	ba 00 00 00 00       	mov    $0x0,%edx
  801344:	f7 75 e4             	divl   -0x1c(%ebp)
  801347:	6b c0 10             	imul   $0x10,%eax,%eax
  80134a:	29 c4                	sub    %eax,%esp
  80134c:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801350:	83 c0 0f             	add    $0xf,%eax
  801353:	c1 e8 04             	shr    $0x4,%eax
  801356:	c1 e0 04             	shl    $0x4,%eax
  801359:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  80135c:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  801361:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801368:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80136b:	89 54 24 08          	mov    %edx,0x8(%esp)
  80136f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801376:	00 
  801377:	89 04 24             	mov    %eax,(%esp)
  80137a:	e8 ac fb ff ff       	call   800f2b <memset>

    int i;
    for (i = 0; i < total; i ++) {
  80137f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801386:	eb 71                	jmp    8013f9 <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  801388:	e8 9e ef ff ff       	call   80032b <fork>
  80138d:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801390:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801393:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801396:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801399:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80139c:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80139f:	85 c0                	test   %eax,%eax
  8013a1:	75 45                	jne    8013e8 <main+0xe6>
            srand(i * i);
  8013a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8013a6:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  8013aa:	89 04 24             	mov    %eax,(%esp)
  8013ad:	e8 24 f8 ff ff       	call   800bd6 <srand>
            int times = (((unsigned int)rand()) % total);
  8013b2:	e8 35 f7 ff ff       	call   800aec <rand>
  8013b7:	8b 15 d0 17 80 00    	mov    0x8017d0,%edx
  ...
  8013ce:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8013d2:	6b c0 64             	imul   $0x64,%eax,%eax
  8013d5:	05 e8 03 00 00       	add    $0x3e8,%eax
  8013da:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8013dd:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8013e0:	89 04 24             	mov    %eax,(%esp)
  8013e3:	e8 fc fc ff ff       	call   8010e4 <work>
        }
        if (pids[i] < 0) {
  8013e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8013eb:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8013ee:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8013f1:	85 c0                	test   %eax,%eax
  8013f3:	78 65                	js     80145a <main+0x158>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  8013f5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8013f9:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  8013fe:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801401:	7c 85                	jl     801388 <main+0x86>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801403:	c7 04 24 d4 17 80 00 	movl   $0x8017d4,(%esp)
  80140a:	e8 10 ed ff ff       	call   80011f <cprintf>

    for (i = 0; i < total; i ++) {
  80140f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801416:	eb 1b                	jmp    801433 <main+0x131>
        if (wait() != 0) {
  801418:	e8 1b ef ff ff       	call   800338 <wait>
  80141d:	85 c0                	test   %eax,%eax
  80141f:	74 0e                	je     80142f <main+0x12d>
            cprintf("wait failed.\n");
  801421:	c7 04 24 de 17 80 00 	movl   $0x8017de,(%esp)
  801428:	e8 f2 ec ff ff       	call   80011f <cprintf>
            goto failed;
  80142d:	eb 2c                	jmp    80145b <main+0x159>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  80142f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801433:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  801438:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80143b:	7c db                	jl     801418 <main+0x116>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  80143d:	c7 04 24 ec 17 80 00 	movl   $0x8017ec,(%esp)
  801444:	e8 d6 ec ff ff       	call   80011f <cprintf>
    return 0;
  801449:	b8 00 00 00 00       	mov    $0x0,%eax
  80144e:	89 dc                	mov    %ebx,%esp
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
  ...
  801454:	5b                   	pop    %ebx
  801455:	5d                   	pop    %ebp
  801456:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801459:	c3                   	ret    
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
...
failed:
  ...
  801462:	eb 22                	jmp    801486 <main+0x184>
        if (pids[i] > 0) {
  801464:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801467:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80146a:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80146d:	85 c0                	test   %eax,%eax
  80146f:	7e 11                	jle    801482 <main+0x180>
            kill(pids[i]);
  801471:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801474:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801477:	8b 04 90             	mov    (%eax,%edx,4),%eax
  80147a:	89 04 24             	mov    %eax,(%esp)
  80147d:	e8 f9 ee ff ff       	call   80037b <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801482:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801486:	a1 d0 17 80 00       	mov    0x8017d0,%eax
  80148b:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80148e:	7c d4                	jl     801464 <main+0x162>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801490:	c7 44 24 08 fa 17 80 	movl   $0x8017fa,0x8(%esp)
  801497:	00 
  801498:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  80149f:	00 
  8014a0:	c7 04 24 05 18 80 00 	movl   $0x801805,(%esp)
  8014a7:	e8 84 eb ff ff       	call   800030 <__panic>
