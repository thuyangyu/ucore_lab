...
main(void) {
  ...
  8010f6:	c7 04 24 00 14 80 00 	movl   $0x801400,(%esp)
  8010fd:	e8 1d f0 ff ff       	call   80011f <cprintf>
    print_pgdir();
  801102:	e8 94 f2 ff ff       	call   80039b <print_pgdir>
    cprintf("pgdir pass.\n");
  801107:	c7 04 24 17 14 80 00 	movl   $0x801417,(%esp)
  80110e:	e8 0c f0 ff ff       	call   80011f <cprintf>
    return 0;
