...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
exit(int error_code) {
  ...
  80031d:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
...
umain(void) {
  ...
  8003df:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003e2:	e8 29 0d 00 00       	call   801110 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 44 15 80 00       	add    $0x801544,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 68 15 80 00 	mov    0x801568(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 5e 15 80 	movl   $0x80155e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 61 15 80 00       	mov    $0x801561,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8010f1:	eb 12                	jmp    801105 <spin_delay+0x21>
     {
          j = !j;
  8010f3:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8010f6:	85 c0                	test   %eax,%eax
  8010f8:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  801101:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  801105:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  80110c:	75 e5                	jne    8010f3 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  801113:	53                   	push   %ebx
  801114:	83 e4 f0             	and    $0xfffffff0,%esp
  801117:	83 ec 30             	sub    $0x30,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  80111a:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801121:	00 
  801122:	c7 04 24 c0 16 80 00 	movl   $0x8016c0,(%esp)
  801129:	e8 f1 ef ff ff       	call   80011f <cprintf>
     sleep(SLEEP_TIME);
  80112e:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801135:	e8 8e f2 ff ff       	call   8003c8 <sleep>
     memset(pids, 0, sizeof(pids));
  80113a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801141:	00 
  801142:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801149:	00 
  80114a:	c7 04 24 30 20 80 00 	movl   $0x802030,(%esp)
  801151:	e8 d5 fd ff ff       	call   800f2b <memset>
     lab6_set_priority(TOTAL + 1);
  801156:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80115d:	e8 53 f2 ff ff       	call   8003b5 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801162:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801169:	00 
  80116a:	e9 04 01 00 00       	jmp    801273 <main+0x163>
          acc[i]=0;
  80116f:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801173:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  80117a:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80117e:	e8 a8 f1 ff ff       	call   80032b <fork>
  801183:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801187:	89 04 95 30 20 80 00 	mov    %eax,0x802030(,%edx,4)
  80118e:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801192:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801199:	85 c0                	test   %eax,%eax
  80119b:	0f 85 ba 00 00 00    	jne    80125b <main+0x14b>
               lab6_set_priority(i + 1);
  8011a1:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011a5:	83 c0 01             	add    $0x1,%eax
  8011a8:	89 04 24             	mov    %eax,(%esp)
  8011ab:	e8 05 f2 ff ff       	call   8003b5 <lab6_set_priority>
               acc[i] = 0;
  8011b0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011b4:	c7 04 85 08 20 80 00 	movl   $0x0,0x802008(,%eax,4)
  8011bb:	00 00 00 00 
  8011bf:	eb 01                	jmp    8011c2 <main+0xb2>
  ...
  8011c1:	90                   	nop
          ...
          if ((pids[i] = fork()) == 0) {
               ...
               while (1) {
                    spin_delay();
  8011c2:	e8 1d ff ff ff       	call   8010e4 <spin_delay>
                    ++ acc[i];
  8011c7:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011cb:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  8011d2:	8d 50 01             	lea    0x1(%eax),%edx
  8011d5:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011d9:	89 14 85 08 20 80 00 	mov    %edx,0x802008(,%eax,4)
                    if(acc[i]%4000==0) {
  8011e0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8011e4:	8b 0c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ecx
  8011eb:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8011f0:	89 c8                	mov    %ecx,%eax
  8011f2:	f7 e2                	mul    %edx
  8011f4:	89 d0                	mov    %edx,%eax
  8011f6:	c1 e8 08             	shr    $0x8,%eax
  8011f9:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8011ff:	89 ca                	mov    %ecx,%edx
  801201:	29 c2                	sub    %eax,%edx
  801203:	89 d0                	mov    %edx,%eax
  801205:	85 c0                	test   %eax,%eax
  801207:	75 b8                	jne    8011c1 <main+0xb1>
                        if((time=gettime_msec())>MAX_TIME+SLEEP_TIME) {
  801209:	e8 9a f1 ff ff       	call   8003a8 <gettime_msec>
  80120e:	89 44 24 28          	mov    %eax,0x28(%esp)
  801212:	81 7c 24 28 78 05 00 	cmpl   $0x578,0x28(%esp)
  801219:	00 
  80121a:	7e a5                	jle    8011c1 <main+0xb1>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  80121c:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801220:	8b 1c 85 08 20 80 00 	mov    0x802008(,%eax,4),%ebx
  801227:	e8 62 f1 ff ff       	call   80038e <getpid>
  80122c:	8b 54 24 28          	mov    0x28(%esp),%edx
  801230:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801234:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801238:	89 44 24 04          	mov    %eax,0x4(%esp)
  80123c:	c7 04 24 e8 16 80 00 	movl   $0x8016e8,(%esp)
  801243:	e8 d7 ee ff ff       	call   80011f <cprintf>
                            exit(acc[i]);
  801248:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80124c:	8b 04 85 08 20 80 00 	mov    0x802008(,%eax,4),%eax
  801253:	89 04 24             	mov    %eax,(%esp)
  801256:	e8 b1 f0 ff ff       	call   80030c <exit>
                        }
                    }
               }
          ...
          if (pids[i] < 0) {
  80125b:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80125f:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  801266:	85 c0                	test   %eax,%eax
  801268:	0f 88 18 01 00 00    	js     801386 <main+0x276>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80126e:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801273:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801278:	0f 8e f1 fe ff ff    	jle    80116f <main+0x5f>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80127e:	c7 04 24 08 17 80 00 	movl   $0x801708,(%esp)
  801285:	e8 95 ee ff ff       	call   80011f <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80128a:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801291:	00 
  801292:	eb 6b                	jmp    8012ff <main+0x1ef>
         status[i]=0;
  801294:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801298:	c7 04 85 1c 20 80 00 	movl   $0x0,0x80201c(,%eax,4)
  80129f:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8012a3:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8012a7:	c1 e0 02             	shl    $0x2,%eax
  8012aa:	8d 90 1c 20 80 00    	lea    0x80201c(%eax),%edx
  8012b0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8012b4:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8012bb:	89 54 24 04          	mov    %edx,0x4(%esp)
  8012bf:	89 04 24             	mov    %eax,(%esp)
  8012c2:	e8 8d f0 ff ff       	call   800354 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8012c7:	e8 dc f0 ff ff       	call   8003a8 <gettime_msec>
  8012cc:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  8012d0:	8b 0c 95 1c 20 80 00 	mov    0x80201c(,%edx,4),%ecx
  8012d7:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  8012db:	8b 14 95 30 20 80 00 	mov    0x802030(,%edx,4),%edx
  8012e2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8012e6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8012ea:	89 54 24 04          	mov    %edx,0x4(%esp)
  8012ee:	c7 04 24 30 17 80 00 	movl   $0x801730,(%esp)
  8012f5:	e8 25 ee ff ff       	call   80011f <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8012fa:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  8012ff:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801304:	7e 8e                	jle    801294 <main+0x184>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801306:	c7 04 24 4f 17 80 00 	movl   $0x80174f,(%esp)
  80130d:	e8 0d ee ff ff       	call   80011f <cprintf>
     cprintf("stride sched correct result:");
  801312:	c7 04 24 65 17 80 00 	movl   $0x801765,(%esp)
  801319:	e8 01 ee ff ff       	call   80011f <cprintf>
     for (i = 0; i < TOTAL; i ++)
  80131e:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801325:	00 
  801326:	eb 41                	jmp    801369 <main+0x259>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801328:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80132c:	8b 04 85 1c 20 80 00 	mov    0x80201c(,%eax,4),%eax
  801333:	01 c0                	add    %eax,%eax
  801335:	8b 15 1c 20 80 00    	mov    0x80201c,%edx
  80133b:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  80133f:	89 c2                	mov    %eax,%edx
  801341:	c1 fa 1f             	sar    $0x1f,%edx
  801344:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801348:	83 c0 01             	add    $0x1,%eax
  80134b:	89 c2                	mov    %eax,%edx
  80134d:	c1 ea 1f             	shr    $0x1f,%edx
  801350:	01 d0                	add    %edx,%eax
  801352:	d1 f8                	sar    %eax
  801354:	89 44 24 04          	mov    %eax,0x4(%esp)
  801358:	c7 04 24 82 17 80 00 	movl   $0x801782,(%esp)
  80135f:	e8 bb ed ff ff       	call   80011f <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801364:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801369:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  80136e:	7e b8                	jle    801328 <main+0x218>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801370:	c7 04 24 86 17 80 00 	movl   $0x801786,(%esp)
  801377:	e8 a3 ed ff ff       	call   80011f <cprintf>
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801387:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  80138e:	00 
  80138f:	eb 27                	jmp    8013b8 <main+0x2a8>
          if (pids[i] > 0) {
  801391:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801395:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  80139c:	85 c0                	test   %eax,%eax
  80139e:	7e 13                	jle    8013b3 <main+0x2a3>
               kill(pids[i]);
  8013a0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8013a4:	8b 04 85 30 20 80 00 	mov    0x802030(,%eax,4),%eax
  8013ab:	89 04 24             	mov    %eax,(%esp)
  8013ae:	e8 c8 ef ff ff       	call   80037b <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  8013b3:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  8013b8:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  8013bd:	7e d2                	jle    801391 <main+0x281>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  8013bf:	c7 44 24 08 88 17 80 	movl   $0x801788,0x8(%esp)
  8013c6:	00 
  8013c7:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  8013ce:	00 
  8013cf:	c7 04 24 93 17 80 00 	movl   $0x801793,(%esp)
  8013d6:	e8 55 ec ff ff       	call   800030 <__panic>
