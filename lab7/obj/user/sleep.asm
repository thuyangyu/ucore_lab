...
exit(int error_code) {
  ...
  80031d:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
umain(void) {
  ...
  8003df:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003e2:	e8 51 0d 00 00       	call   801138 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8010e7:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8010ea:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8010f1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8010f8:	eb 2c                	jmp    801126 <sleepy+0x42>
        sleep(time);
  8010fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8010fd:	89 04 24             	mov    %eax,(%esp)
  801100:	e8 c3 f2 ff ff       	call   8003c8 <sleep>
  ...
  801112:	89 54 24 04          	mov    %edx,0x4(%esp)
  801116:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  801122:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801126:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  80112a:	7e ce                	jle    8010fa <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  80112c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801133:	e8 d4 f1 ff ff       	call   80030c <exit>
...
main(void) {
  ...
  80113b:	83 e4 f0             	and    $0xfffffff0,%esp
  80113e:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801141:	e8 62 f2 ff ff       	call   8003a8 <gettime_msec>
  801146:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80114a:	e8 dc f1 ff ff       	call   80032b <fork>
  80114f:	89 44 24 18          	mov    %eax,0x18(%esp)
  801153:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801158:	75 0c                	jne    801166 <main+0x2e>
        sleepy(pid1);
  80115a:	8b 44 24 18          	mov    0x18(%esp),%eax
  80115e:	89 04 24             	mov    %eax,(%esp)
  801161:	e8 7e ff ff ff       	call   8010e4 <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  801166:	8d 44 24 14          	lea    0x14(%esp),%eax
  80116a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80116e:	8b 44 24 18          	mov    0x18(%esp),%eax
  801172:	89 04 24             	mov    %eax,(%esp)
  801175:	e8 da f1 ff ff       	call   800354 <waitpid>
  80117a:	85 c0                	test   %eax,%eax
  80117c:	75 08                	jne    801186 <main+0x4e>
  80117e:	8b 44 24 14          	mov    0x14(%esp),%eax
  801182:	85 c0                	test   %eax,%eax
  801184:	74 24                	je     8011aa <main+0x72>
  801186:	c7 44 24 0c d8 14 80 	movl   $0x8014d8,0xc(%esp)
  80118d:	00 
  80118e:	c7 44 24 08 09 15 80 	movl   $0x801509,0x8(%esp)
  801195:	00 
  801196:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80119d:	00 
  80119e:	c7 04 24 1e 15 80 00 	movl   $0x80151e,(%esp)
  8011a5:	e8 86 ee ff ff       	call   800030 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  8011aa:	e8 f9 f1 ff ff       	call   8003a8 <gettime_msec>
  8011af:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  8011b3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011b7:	c7 04 24 2b 15 80 00 	movl   $0x80152b,(%esp)
  8011be:	e8 5c ef ff ff       	call   80011f <cprintf>
    cprintf("sleep pass.\n");
  8011c3:	c7 04 24 3c 15 80 00 	movl   $0x80153c,(%esp)
  8011ca:	e8 50 ef ff ff       	call   80011f <cprintf>
    return 0;
