...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
exit(int error_code) {
  ...
  80031d:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010f2:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8010f6:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010fb:	75 18                	jne    801115 <main+0x31>
        sleep(~0);
  8010fd:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801104:	e8 bf f2 ff ff       	call   8003c8 <sleep>
        exit(0xdead);
  801109:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  801110:	e8 f7 f1 ff ff       	call   80030c <exit>
    }
    assert(pid > 0);
  801115:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80111a:	7f 24                	jg     801140 <main+0x5c>
  80111c:	c7 44 24 0c 80 14 80 	movl   $0x801480,0xc(%esp)
  801123:	00 
  801124:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  80112b:	00 
  80112c:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  801133:	00 
  801134:	c7 04 24 9d 14 80 00 	movl   $0x80149d,(%esp)
  80113b:	e8 f0 ee ff ff       	call   800030 <__panic>

    sleep(100);
  801140:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801147:	e8 7c f2 ff ff       	call   8003c8 <sleep>
    assert(kill(pid) == 0);
  80114c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801150:	89 04 24             	mov    %eax,(%esp)
  801153:	e8 23 f2 ff ff       	call   80037b <kill>
  801158:	85 c0                	test   %eax,%eax
  80115a:	74 24                	je     801180 <main+0x9c>
  80115c:	c7 44 24 0c ae 14 80 	movl   $0x8014ae,0xc(%esp)
  801163:	00 
  801164:	c7 44 24 08 88 14 80 	movl   $0x801488,0x8(%esp)
  80116b:	00 
  80116c:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801173:	00 
  801174:	c7 04 24 9d 14 80 00 	movl   $0x80149d,(%esp)
  80117b:	e8 b0 ee ff ff       	call   800030 <__panic>
    cprintf("sleepkill pass.\n");
  801180:	c7 04 24 bd 14 80 00 	movl   $0x8014bd,(%esp)
  801187:	e8 93 ef ff ff       	call   80011f <cprintf>
    return 0;
