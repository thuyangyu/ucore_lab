...
exit(int error_code) {
  ...
  80031d:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 84 13 80 00       	add    $0x801384,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 a8 13 80 00 	mov    0x8013a8(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 9e 13 80 	movl   $0x80139e,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be a1 13 80 00       	mov    $0x8013a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ed:	c7 04 24 00 15 80 00 	movl   $0x801500,(%esp)
  ...
  801107:	75 0e                	jne    801117 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  801109:	c7 04 24 27 15 80 00 	movl   $0x801527,(%esp)
  801110:	e8 0a f0 ff ff       	call   80011f <cprintf>
        while (1);
  801115:	eb fe                	jmp    801115 <main+0x31>
    }else if (pid<0) {
  801117:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80111c:	79 1c                	jns    80113a <main+0x56>
        panic("fork child error\n");
  80111e:	c7 44 24 08 45 15 80 	movl   $0x801545,0x8(%esp)
  801125:	00 
  801126:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  80112d:	00 
  80112e:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  801135:	e8 f6 ee ff ff       	call   800030 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  80113a:	c7 04 24 64 15 80 00 	movl   $0x801564,(%esp)
  801141:	e8 d9 ef ff ff       	call   80011f <cprintf>

    yield();
  801146:	e8 23 f2 ff ff       	call   80036e <yield>
    yield();
  80114b:	e8 1e f2 ff ff       	call   80036e <yield>
    yield();
  801150:	e8 19 f2 ff ff       	call   80036e <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  801155:	c7 04 24 8c 15 80 00 	movl   $0x80158c,(%esp)
  80115c:	e8 be ef ff ff       	call   80011f <cprintf>

    assert((ret = kill(pid)) == 0);
  801161:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801165:	89 04 24             	mov    %eax,(%esp)
  801168:	e8 0e f2 ff ff       	call   80037b <kill>
  80116d:	89 44 24 18          	mov    %eax,0x18(%esp)
  801171:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801176:	74 24                	je     80119c <main+0xb8>
  801178:	c7 44 24 0c b4 15 80 	movl   $0x8015b4,0xc(%esp)
  80117f:	00 
  801180:	c7 44 24 08 cb 15 80 	movl   $0x8015cb,0x8(%esp)
  801187:	00 
  801188:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80118f:	00 
  801190:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  801197:	e8 94 ee ff ff       	call   800030 <__panic>
    cprintf("kill returns %d\n", ret);
  80119c:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011a0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011a4:	c7 04 24 e0 15 80 00 	movl   $0x8015e0,(%esp)
  8011ab:	e8 6f ef ff ff       	call   80011f <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  8011b0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8011b7:	00 
  8011b8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8011bc:	89 04 24             	mov    %eax,(%esp)
  8011bf:	e8 90 f1 ff ff       	call   800354 <waitpid>
  8011c4:	89 44 24 18          	mov    %eax,0x18(%esp)
  8011c8:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8011cd:	74 24                	je     8011f3 <main+0x10f>
  8011cf:	c7 44 24 0c f4 15 80 	movl   $0x8015f4,0xc(%esp)
  8011d6:	00 
  8011d7:	c7 44 24 08 cb 15 80 	movl   $0x8015cb,0x8(%esp)
  8011de:	00 
  8011df:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8011e6:	00 
  8011e7:	c7 04 24 57 15 80 00 	movl   $0x801557,(%esp)
  8011ee:	e8 3d ee ff ff       	call   800030 <__panic>
    cprintf("wait returns %d\n", ret);
  8011f3:	8b 44 24 18          	mov    0x18(%esp),%eax
  8011f7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011fb:	c7 04 24 14 16 80 00 	movl   $0x801614,(%esp)
  801202:	e8 18 ef ff ff       	call   80011f <cprintf>

    cprintf("spin may pass.\n");
  801207:	c7 04 24 25 16 80 00 	movl   $0x801625,(%esp)
  80120e:	e8 0c ef ff ff       	call   80011f <cprintf>
    return 0;
