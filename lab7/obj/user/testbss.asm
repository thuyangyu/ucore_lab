...
main(void) {
  ...
  8010ed:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
  8010f4:	e8 26 f0 ff ff       	call   80011f <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010f9:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801100:	00 
  801101:	eb 38                	jmp    80113b <main+0x57>
        if (bigarray[i] != 0) {
  801103:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801107:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  80110e:	85 c0                	test   %eax,%eax
  801110:	74 24                	je     801136 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  801112:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801116:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80111a:	c7 44 24 08 00 15 80 	movl   $0x801500,0x8(%esp)
  801121:	00 
  801122:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801129:	00 
  80112a:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801136:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80113b:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801142:	00 
  801143:	7e be                	jle    801103 <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801145:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80114c:	00 
  80114d:	eb 14                	jmp    801163 <main+0x7f>
        bigarray[i] = i;
  80114f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801153:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801157:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80115e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801163:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80116a:	00 
  80116b:	7e e2                	jle    80114f <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80116d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801174:	00 
  801175:	eb 3c                	jmp    8011b3 <main+0xcf>
        if (bigarray[i] != i) {
  801177:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80117b:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  801182:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801186:	39 c2                	cmp    %eax,%edx
  801188:	74 24                	je     8011ae <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  80118a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80118e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801192:	c7 44 24 08 2c 15 80 	movl   $0x80152c,0x8(%esp)
  801199:	00 
  80119a:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8011a1:	00 
  8011a2:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  8011a9:	e8 82 ee ff ff       	call   800030 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  8011ae:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8011b3:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8011ba:	00 
  8011bb:	7e ba                	jle    801177 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8011bd:	c7 04 24 54 15 80 00 	movl   $0x801554,(%esp)
  8011c4:	e8 56 ef ff ff       	call   80011f <cprintf>
    cprintf("testbss may pass.\n");
  8011c9:	c7 04 24 87 15 80 00 	movl   $0x801587,(%esp)
  8011d0:	e8 4a ef ff ff       	call   80011f <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8011d5:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  8011dc:	00 00 00 
    asm volatile ("int $0x14");
  8011df:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8011e1:	c7 44 24 08 9a 15 80 	movl   $0x80159a,0x8(%esp)
  8011e8:	00 
  8011e9:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8011f0:	00 
  8011f1:	c7 04 24 1d 15 80 00 	movl   $0x80151d,(%esp)
  8011f8:	e8 33 ee ff ff       	call   800030 <__panic>
