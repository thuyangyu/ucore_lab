...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	c7 04 24 80 12 80 00 	movl   $0x801280,(%esp)
  ...
  800065:	e8 82 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  80006a:	c7 04 24 9a 12 80 00 	movl   $0x80129a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80009e:	c7 04 24 9c 12 80 00 	movl   $0x80129c,(%esp)
  ...
  8000b7:	e8 30 00 00 00       	call   8000ec <vcprintf>
    cprintf("\n");
  8000bc:	c7 04 24 9a 12 80 00 	movl   $0x80129a,(%esp)
...
exit(int error_code) {
  ...
  80031d:	c7 04 24 b8 12 80 00 	movl   $0x8012b8,(%esp)
...
umain(void) {
  ...
  8003df:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003e2:	e8 a5 0d 00 00       	call   80118c <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 e4 13 80 00       	add    $0x8013e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 08 14 80 00 	mov    0x801408(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 fe 13 80 	movl   $0x8013fe,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 01 14 80 00       	mov    $0x801401,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8010e7:	83 ec 08             	sub    $0x8,%esp
    yield();
  8010ea:	e8 7f f2 ff ff       	call   80036e <yield>
    yield();
  8010ef:	e8 7a f2 ff ff       	call   80036e <yield>
    yield();
  8010f4:	e8 75 f2 ff ff       	call   80036e <yield>
    yield();
  8010f9:	e8 70 f2 ff ff       	call   80036e <yield>
    yield();
  8010fe:	e8 6b f2 ff ff       	call   80036e <yield>
    yield();
  801103:	e8 66 f2 ff ff       	call   80036e <yield>
}
  801108:	c9                   	leave  
  801109:	c3                   	ret    
...
loop(void) {
  ...
  80110d:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801110:	c7 04 24 60 15 80 00 	movl   $0x801560,(%esp)
  801117:	e8 03 f0 ff ff       	call   80011f <cprintf>
    while (1);
  80111c:	eb fe                	jmp    80111c <loop+0x12>
...
work(void) {
  ...
  801121:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801124:	c7 04 24 6a 15 80 00 	movl   $0x80156a,(%esp)
  80112b:	e8 ef ef ff ff       	call   80011f <cprintf>
    do_yield();
  801130:	e8 af ff ff ff       	call   8010e4 <do_yield>
    if (kill(parent) == 0) {
  801135:	a1 08 20 80 00       	mov    0x802008,%eax
  80113a:	89 04 24             	mov    %eax,(%esp)
  80113d:	e8 39 f2 ff ff       	call   80037b <kill>
  801142:	85 c0                	test   %eax,%eax
  801144:	75 3a                	jne    801180 <work+0x62>
        cprintf("kill parent ok.\n");
  801146:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  80114d:	e8 cd ef ff ff       	call   80011f <cprintf>
        do_yield();
  801152:	e8 8d ff ff ff       	call   8010e4 <do_yield>
        if (kill(pid1) == 0) {
  801157:	a1 10 20 80 00       	mov    0x802010,%eax
  80115c:	89 04 24             	mov    %eax,(%esp)
  80115f:	e8 17 f2 ff ff       	call   80037b <kill>
  801164:	85 c0                	test   %eax,%eax
  801166:	75 18                	jne    801180 <work+0x62>
            cprintf("kill child1 ok.\n");
  801168:	c7 04 24 85 15 80 00 	movl   $0x801585,(%esp)
  80116f:	e8 ab ef ff ff       	call   80011f <cprintf>
            exit(0);
  801174:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80117b:	e8 8c f1 ff ff       	call   80030c <exit>
        }
    }
    exit(-1);
  801180:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801187:	e8 80 f1 ff ff       	call   80030c <exit>
...
main(void) {
  ...
  80118f:	83 e4 f0             	and    $0xfffffff0,%esp
  801192:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801195:	e8 f4 f1 ff ff       	call   80038e <getpid>
  80119a:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80119f:	e8 87 f1 ff ff       	call   80032b <fork>
  8011a4:	a3 10 20 80 00       	mov    %eax,0x802010
  8011a9:	a1 10 20 80 00       	mov    0x802010,%eax
  8011ae:	85 c0                	test   %eax,%eax
  8011b0:	75 05                	jne    8011b7 <main+0x2b>
        loop();
  8011b2:	e8 53 ff ff ff       	call   80110a <loop>
    }

    assert(pid1 > 0);
  8011b7:	a1 10 20 80 00       	mov    0x802010,%eax
  8011bc:	85 c0                	test   %eax,%eax
  8011be:	7f 24                	jg     8011e4 <main+0x58>
  8011c0:	c7 44 24 0c 96 15 80 	movl   $0x801596,0xc(%esp)
  8011c7:	00 
  8011c8:	c7 44 24 08 9f 15 80 	movl   $0x80159f,0x8(%esp)
  8011cf:	00 
  8011d0:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8011d7:	00 
  8011d8:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  8011df:	e8 4c ee ff ff       	call   800030 <__panic>

    if ((pid2 = fork()) == 0) {
  8011e4:	e8 42 f1 ff ff       	call   80032b <fork>
  8011e9:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8011ee:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011f3:	85 c0                	test   %eax,%eax
  8011f5:	75 05                	jne    8011fc <main+0x70>
        work();
  8011f7:	e8 22 ff ff ff       	call   80111e <work>
    }
    if (pid2 > 0) {
  8011fc:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801201:	85 c0                	test   %eax,%eax
  801203:	7e 46                	jle    80124b <main+0xbf>
        cprintf("wait child 1.\n");
  801205:	c7 04 24 c4 15 80 00 	movl   $0x8015c4,(%esp)
  80120c:	e8 0e ef ff ff       	call   80011f <cprintf>
        waitpid(pid1, NULL);
  801211:	a1 10 20 80 00       	mov    0x802010,%eax
  801216:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80121d:	00 
  80121e:	89 04 24             	mov    %eax,(%esp)
  801221:	e8 2e f1 ff ff       	call   800354 <waitpid>
        panic("waitpid %d returns\n", pid1);
  801226:	a1 10 20 80 00       	mov    0x802010,%eax
  80122b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80122f:	c7 44 24 08 d3 15 80 	movl   $0x8015d3,0x8(%esp)
  801236:	00 
  801237:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80123e:	00 
  80123f:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  801246:	e8 e5 ed ff ff       	call   800030 <__panic>
    }
    else {
        kill(pid1);
  80124b:	a1 10 20 80 00       	mov    0x802010,%eax
  801250:	89 04 24             	mov    %eax,(%esp)
  801253:	e8 23 f1 ff ff       	call   80037b <kill>
    }
    panic("FAIL: T.T\n");
  801258:	c7 44 24 08 e7 15 80 	movl   $0x8015e7,0x8(%esp)
  80125f:	00 
  801260:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801267:	00 
  801268:	c7 04 24 b4 15 80 00 	movl   $0x8015b4,(%esp)
  80126f:	e8 bc ed ff ff       	call   800030 <__panic>
