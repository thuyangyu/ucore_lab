...
exit(int error_code) {
  ...
  80031d:	c7 04 24 b8 11 80 00 	movl   $0x8011b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80053b:	05 e4 12 80 00       	add    $0x8012e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8006a1:	8b 04 85 08 13 80 00 	mov    0x801308(,%eax,4),%eax
  ...
  8007a5:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  8007ac:	00 
  ...
  8007d1:	75 05                	jne    8007d8 <vprintfmt+0x1ae>
                p = "(null)";
  8007d3:	be 01 13 80 00       	mov    $0x801301,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8010ed:	e8 9c f2 ff ff       	call   80038e <getpid>
  8010f2:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010f6:	c7 04 24 60 14 80 00 	movl   $0x801460,(%esp)
  8010fd:	e8 1d f0 ff ff       	call   80011f <cprintf>
    for (i = 0; i < 5; i ++) {
  801102:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801109:	00 
  80110a:	eb 27                	jmp    801133 <main+0x4f>
        yield();
  80110c:	e8 5d f2 ff ff       	call   80036e <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801111:	e8 78 f2 ff ff       	call   80038e <getpid>
  801116:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80111a:	89 54 24 08          	mov    %edx,0x8(%esp)
  80111e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801122:	c7 04 24 7c 14 80 00 	movl   $0x80147c,(%esp)
...
main(void) {
  ...
  801133:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801138:	7e d2                	jle    80110c <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  80113a:	e8 4f f2 ff ff       	call   80038e <getpid>
  80113f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801143:	c7 04 24 9f 14 80 00 	movl   $0x80149f,(%esp)
  80114a:	e8 d0 ef ff ff       	call   80011f <cprintf>
    cprintf("yield pass.\n");
  80114f:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
  801156:	e8 c4 ef ff ff       	call   80011f <cprintf>
    return 0;
