...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 00 1a 80 00 	movl   $0x801a00,(%esp)
  ...
  800284:	c7 04 24 0b 1a 80 00 	movl   $0x801a0b,(%esp)
  ...
  80029a:	c7 04 24 1d 1a 80 00 	movl   $0x801a1d,(%esp)
  ...
  8002b0:	c7 04 24 30 1a 80 00 	movl   $0x801a30,(%esp)
  ...
  8002c6:	c7 04 24 43 1a 80 00 	movl   $0x801a43,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 56 1a 80 00 	movl   $0x801a56,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 70 1a 80 00 	movl   $0x801a70,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 72 1a 80 00 	movl   $0x801a72,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 70 1a 80 00 	movl   $0x801a70,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 8e 1a 80 00 	movl   $0x801a8e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 a1 1a 80 	movl   $0x801aa1,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 a8 1a 80 	movl   $0x801aa8,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 d4 1a 80 	movl   $0x801ad4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 dc 1a 80 	movl   $0x801adc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 c2 1a 80 00 	movl   $0x801ac2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 04 1d 80 00       	add    $0x801d04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 28 1d 80 00 	mov    0x801d28(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 1e 1d 80 	movl   $0x801d1e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 21 1d 80 00       	mov    $0x801d21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b2:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8018b5:	e8 50 f0 ff ff       	call   80090a <fork>
  8018ba:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018be:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018c3:	75 33                	jne    8018f8 <main+0x4c>
        cprintf("fork ok.\n");
  8018c5:	c7 04 24 80 1e 80 00 	movl   $0x801e80,(%esp)
  8018cc:	e8 13 eb ff ff       	call   8003e4 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  8018d1:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8018d8:	00 
  8018d9:	eb 0a                	jmp    8018e5 <main+0x39>
            yield();
  8018db:	e8 6d f0 ff ff       	call   80094d <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  8018e0:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8018e5:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  8018ea:	7e ef                	jle    8018db <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  8018ec:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  8018f3:	e8 f3 ef ff ff       	call   8008eb <exit>
    }
    assert(pid > 0);
  8018f8:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018fd:	7f 24                	jg     801923 <main+0x77>
  8018ff:	c7 44 24 0c 8a 1e 80 	movl   $0x801e8a,0xc(%esp)
  801906:	00 
  801907:	c7 44 24 08 92 1e 80 	movl   $0x801e92,0x8(%esp)
  80190e:	00 
  80190f:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801916:	00 
  801917:	c7 04 24 a7 1e 80 00 	movl   $0x801ea7,(%esp)
  80191e:	e8 c9 e9 ff ff       	call   8002ec <__panic>
    assert(waitpid(-1, NULL) != 0);
  801923:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80192a:	00 
  80192b:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801932:	e8 fc ef ff ff       	call   800933 <waitpid>
  801937:	85 c0                	test   %eax,%eax
  801939:	75 24                	jne    80195f <main+0xb3>
  80193b:	c7 44 24 0c b5 1e 80 	movl   $0x801eb5,0xc(%esp)
  801942:	00 
  801943:	c7 44 24 08 92 1e 80 	movl   $0x801e92,0x8(%esp)
  80194a:	00 
  80194b:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801952:	00 
  801953:	c7 04 24 a7 1e 80 00 	movl   $0x801ea7,(%esp)
  80195a:	e8 8d e9 ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80195f:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801966:	c0 
  801967:	8b 44 24 18          	mov    0x18(%esp),%eax
  80196b:	89 04 24             	mov    %eax,(%esp)
  80196e:	e8 c0 ef ff ff       	call   800933 <waitpid>
  801973:	85 c0                	test   %eax,%eax
  801975:	75 24                	jne    80199b <main+0xef>
  801977:	c7 44 24 0c cc 1e 80 	movl   $0x801ecc,0xc(%esp)
  80197e:	00 
  80197f:	c7 44 24 08 92 1e 80 	movl   $0x801e92,0x8(%esp)
  801986:	00 
  801987:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  80198e:	00 
  80198f:	c7 04 24 a7 1e 80 00 	movl   $0x801ea7,(%esp)
  801996:	e8 51 e9 ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  80199b:	8d 44 24 14          	lea    0x14(%esp),%eax
  80199f:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019a3:	8b 44 24 18          	mov    0x18(%esp),%eax
  8019a7:	89 04 24             	mov    %eax,(%esp)
  8019aa:	e8 84 ef ff ff       	call   800933 <waitpid>
  8019af:	85 c0                	test   %eax,%eax
  8019b1:	75 0b                	jne    8019be <main+0x112>
  8019b3:	8b 44 24 14          	mov    0x14(%esp),%eax
  8019b7:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8019bc:	74 24                	je     8019e2 <main+0x136>
  8019be:	c7 44 24 0c f4 1e 80 	movl   $0x801ef4,0xc(%esp)
  8019c5:	00 
  8019c6:	c7 44 24 08 92 1e 80 	movl   $0x801e92,0x8(%esp)
  8019cd:	00 
  8019ce:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8019d5:	00 
  8019d6:	c7 04 24 a7 1e 80 00 	movl   $0x801ea7,(%esp)
  8019dd:	e8 0a e9 ff ff       	call   8002ec <__panic>
    cprintf("badarg pass.\n");
  8019e2:	c7 04 24 29 1f 80 00 	movl   $0x801f29,(%esp)
  8019e9:	e8 f6 e9 ff ff       	call   8003e4 <cprintf>
    return 0;
