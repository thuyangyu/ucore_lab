...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 36 19 80 00 	movl   $0x801936,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 52 19 80 00 	movl   $0x801952,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 81 19 80 	movl   $0x801981,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 88 19 80 	movl   $0x801988,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 b4 19 80 	movl   $0x8019b4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 bc 19 80 	movl   $0x8019bc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 a2 19 80 00 	movl   $0x8019a2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 e4 1b 80 00       	add    $0x801be4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 08 1c 80 00 	mov    0x801c08(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c fe 1b 80 	movl   $0x801bfe,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 01 1c 80 00       	mov    $0x801c01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b5:	66 b8 28 00          	mov    $0x28,%ax
  8018b9:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8018bb:	c7 44 24 08 60 1d 80 	movl   $0x801d60,0x8(%esp)
  8018c2:	00 
  8018c3:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8018ca:	00 
  8018cb:	c7 04 24 6b 1d 80 00 	movl   $0x801d6b,(%esp)
  8018d2:	e8 15 ea ff ff       	call   8002ec <__panic>
