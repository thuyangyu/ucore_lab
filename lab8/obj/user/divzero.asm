...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 56 19 80 00 	movl   $0x801956,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 70 19 80 00 	movl   $0x801970,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 72 19 80 00 	movl   $0x801972,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 70 19 80 00 	movl   $0x801970,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 8e 19 80 00 	movl   $0x80198e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 a1 19 80 	movl   $0x8019a1,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 a8 19 80 	movl   $0x8019a8,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 d4 19 80 	movl   $0x8019d4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 dc 19 80 	movl   $0x8019dc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b2:	83 ec 20             	sub    $0x20,%esp
    cprintf("value is %d.\n", 1 / zero);
  8018b5:	8b 15 48 21 80 00    	mov    0x802148,%edx
  8018bb:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  8018bf:	b8 01 00 00 00       	mov    $0x1,%eax
  8018c4:	89 c2                	mov    %eax,%edx
  8018c6:	c1 fa 1f             	sar    $0x1f,%edx
  8018c9:	f7 7c 24 1c          	idivl  0x1c(%esp)
  8018cd:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018d1:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8018d8:	e8 07 eb ff ff       	call   8003e4 <cprintf>
    panic("FAIL: T.T\n");
  8018dd:	c7 44 24 08 8e 1d 80 	movl   $0x801d8e,0x8(%esp)
  8018e4:	00 
  8018e5:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8018ec:	00 
  8018ed:	c7 04 24 99 1d 80 00 	movl   $0x801d99,(%esp)
  8018f4:	e8 f3 e9 ff ff       	call   8002ec <__panic>
