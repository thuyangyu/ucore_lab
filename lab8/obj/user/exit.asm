...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 20 1a 80 00 	movl   $0x801a20,(%esp)
  ...
  800284:	c7 04 24 2b 1a 80 00 	movl   $0x801a2b,(%esp)
  ...
  80029a:	c7 04 24 3d 1a 80 00 	movl   $0x801a3d,(%esp)
  ...
  8002b0:	c7 04 24 50 1a 80 00 	movl   $0x801a50,(%esp)
  ...
  8002c6:	c7 04 24 63 1a 80 00 	movl   $0x801a63,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 76 1a 80 00 	movl   $0x801a76,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 90 1a 80 00 	movl   $0x801a90,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 92 1a 80 00 	movl   $0x801a92,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 90 1a 80 00 	movl   $0x801a90,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 ae 1a 80 00 	movl   $0x801aae,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 c1 1a 80 	movl   $0x801ac1,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 c8 1a 80 	movl   $0x801ac8,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 e2 1a 80 00 	movl   $0x801ae2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 f4 1a 80 	movl   $0x801af4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 fc 1a 80 	movl   $0x801afc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 e2 1a 80 00 	movl   $0x801ae2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 24 1d 80 00       	add    $0x801d24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 48 1d 80 00 	mov    0x801d48(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 3e 1d 80 	movl   $0x801d3e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 41 1d 80 00       	mov    $0x801d41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b5:	c7 04 24 a0 1e 80 00 	movl   $0x801ea0,(%esp)
  8018bc:	e8 23 eb ff ff       	call   8003e4 <cprintf>
    if ((pid = fork()) == 0) {
  8018c1:	e8 44 f0 ff ff       	call   80090a <fork>
  8018c6:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8018ca:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8018cf:	75 3c                	jne    80190d <main+0x61>
        cprintf("I am the child.\n");
  8018d1:	c7 04 24 c7 1e 80 00 	movl   $0x801ec7,(%esp)
  8018d8:	e8 07 eb ff ff       	call   8003e4 <cprintf>
        yield();
  8018dd:	e8 6b f0 ff ff       	call   80094d <yield>
        yield();
  8018e2:	e8 66 f0 ff ff       	call   80094d <yield>
        yield();
  8018e7:	e8 61 f0 ff ff       	call   80094d <yield>
        yield();
  8018ec:	e8 5c f0 ff ff       	call   80094d <yield>
        yield();
  8018f1:	e8 57 f0 ff ff       	call   80094d <yield>
        yield();
  8018f6:	e8 52 f0 ff ff       	call   80094d <yield>
        yield();
  8018fb:	e8 4d f0 ff ff       	call   80094d <yield>
        exit(magic);
  801900:	a1 10 20 80 00       	mov    0x802010,%eax
  801905:	89 04 24             	mov    %eax,(%esp)
  801908:	e8 de ef ff ff       	call   8008eb <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80190d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801911:	89 44 24 04          	mov    %eax,0x4(%esp)
  801915:	c7 04 24 d8 1e 80 00 	movl   $0x801ed8,(%esp)
  80191c:	e8 c3 ea ff ff       	call   8003e4 <cprintf>
    }
    assert(pid > 0);
  801921:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801926:	7f 24                	jg     80194c <main+0xa0>
  801928:	c7 44 24 0c fa 1e 80 	movl   $0x801efa,0xc(%esp)
  80192f:	00 
  801930:	c7 44 24 08 02 1f 80 	movl   $0x801f02,0x8(%esp)
  801937:	00 
  801938:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  80193f:	00 
  801940:	c7 04 24 17 1f 80 00 	movl   $0x801f17,(%esp)
  801947:	e8 a0 e9 ff ff       	call   8002ec <__panic>
    cprintf("I am the parent, waiting now..\n");
  80194c:	c7 04 24 24 1f 80 00 	movl   $0x801f24,(%esp)
  801953:	e8 8c ea ff ff       	call   8003e4 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801958:	8d 44 24 18          	lea    0x18(%esp),%eax
  80195c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801960:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801964:	89 04 24             	mov    %eax,(%esp)
  801967:	e8 c7 ef ff ff       	call   800933 <waitpid>
  80196c:	85 c0                	test   %eax,%eax
  80196e:	75 0d                	jne    80197d <main+0xd1>
  801970:	8b 54 24 18          	mov    0x18(%esp),%edx
  801974:	a1 10 20 80 00       	mov    0x802010,%eax
  801979:	39 c2                	cmp    %eax,%edx
  80197b:	74 24                	je     8019a1 <main+0xf5>
  80197d:	c7 44 24 0c 44 1f 80 	movl   $0x801f44,0xc(%esp)
  801984:	00 
  801985:	c7 44 24 08 02 1f 80 	movl   $0x801f02,0x8(%esp)
  80198c:	00 
  80198d:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801994:	00 
  801995:	c7 04 24 17 1f 80 00 	movl   $0x801f17,(%esp)
  80199c:	e8 4b e9 ff ff       	call   8002ec <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8019a1:	8d 44 24 18          	lea    0x18(%esp),%eax
  8019a5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019a9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019ad:	89 04 24             	mov    %eax,(%esp)
  8019b0:	e8 7e ef ff ff       	call   800933 <waitpid>
  8019b5:	85 c0                	test   %eax,%eax
  8019b7:	74 09                	je     8019c2 <main+0x116>
  8019b9:	e8 59 ef ff ff       	call   800917 <wait>
  8019be:	85 c0                	test   %eax,%eax
  8019c0:	75 24                	jne    8019e6 <main+0x13a>
  8019c2:	c7 44 24 0c 70 1f 80 	movl   $0x801f70,0xc(%esp)
  8019c9:	00 
  8019ca:	c7 44 24 08 02 1f 80 	movl   $0x801f02,0x8(%esp)
  8019d1:	00 
  8019d2:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8019d9:	00 
  8019da:	c7 04 24 17 1f 80 00 	movl   $0x801f17,(%esp)
  8019e1:	e8 06 e9 ff ff       	call   8002ec <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8019e6:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019ea:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019ee:	c7 04 24 98 1f 80 00 	movl   $0x801f98,(%esp)
  8019f5:	e8 ea e9 ff ff       	call   8003e4 <cprintf>

    cprintf("exit pass.\n");
  8019fa:	c7 04 24 a8 1f 80 00 	movl   $0x801fa8,(%esp)
  801a01:	e8 de e9 ff ff       	call   8003e4 <cprintf>
    return 0;
