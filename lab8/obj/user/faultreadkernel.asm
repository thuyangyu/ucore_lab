...
main(void) {
  ...
  8018b5:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8018ba:	8b 00                	mov    (%eax),%eax
  8018bc:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018c0:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8018c7:	e8 18 eb ff ff       	call   8003e4 <cprintf>
    panic("FAIL: T.T\n");
  8018cc:	c7 44 24 08 9e 1d 80 	movl   $0x801d9e,0x8(%esp)
  8018d3:	00 
  8018d4:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8018db:	00 
  8018dc:	c7 04 24 a9 1d 80 00 	movl   $0x801da9,(%esp)
  8018e3:	e8 04 ea ff ff       	call   8002ec <__panic>
