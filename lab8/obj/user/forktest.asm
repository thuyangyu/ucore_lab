...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 e0 19 80 00 	movl   $0x8019e0,(%esp)
  ...
  800284:	c7 04 24 eb 19 80 00 	movl   $0x8019eb,(%esp)
  ...
  80029a:	c7 04 24 fd 19 80 00 	movl   $0x8019fd,(%esp)
  ...
  8002b0:	c7 04 24 10 1a 80 00 	movl   $0x801a10,(%esp)
  ...
  8002c6:	c7 04 24 23 1a 80 00 	movl   $0x801a23,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 36 1a 80 00 	movl   $0x801a36,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 50 1a 80 00 	movl   $0x801a50,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 52 1a 80 00 	movl   $0x801a52,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 50 1a 80 00 	movl   $0x801a50,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 6e 1a 80 00 	movl   $0x801a6e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 81 1a 80 	movl   $0x801a81,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 88 1a 80 	movl   $0x801a88,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 a2 1a 80 00 	movl   $0x801aa2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 b4 1a 80 	movl   $0x801ab4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 bc 1a 80 	movl   $0x801abc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 a2 1a 80 00 	movl   $0x801aa2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 e4 1c 80 00       	add    $0x801ce4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 08 1d 80 00 	mov    0x801d08(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c fe 1c 80 	movl   $0x801cfe,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 01 1d 80 00       	mov    $0x801d01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b5:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8018bc:	00 
  8018bd:	eb 60                	jmp    80191f <main+0x73>
        if ((pid = fork()) == 0) {
  8018bf:	e8 46 f0 ff ff       	call   80090a <fork>
  8018c4:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018c8:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018cd:	75 20                	jne    8018ef <main+0x43>
            cprintf("I am child %d\n", n);
  8018cf:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018d3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018d7:	c7 04 24 64 1e 80 00 	movl   $0x801e64,(%esp)
  8018de:	e8 01 eb ff ff       	call   8003e4 <cprintf>
            exit(0);
  8018e3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8018ea:	e8 fc ef ff ff       	call   8008eb <exit>
        }
        assert(pid > 0);
  8018ef:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018f4:	7f 24                	jg     80191a <main+0x6e>
  8018f6:	c7 44 24 0c 73 1e 80 	movl   $0x801e73,0xc(%esp)
  8018fd:	00 
  8018fe:	c7 44 24 08 7b 1e 80 	movl   $0x801e7b,0x8(%esp)
  801905:	00 
  801906:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80190d:	00 
  80190e:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
  801915:	e8 d2 e9 ff ff       	call   8002ec <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  80191a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80191f:	a1 60 1e 80 00       	mov    0x801e60,%eax
  801924:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801928:	7c 95                	jl     8018bf <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  80192a:	a1 60 1e 80 00       	mov    0x801e60,%eax
  80192f:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801933:	7e 4e                	jle    801983 <main+0xd7>
        panic("fork claimed to work %d times!\n", n);
  801935:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801939:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80193d:	c7 44 24 08 a0 1e 80 	movl   $0x801ea0,0x8(%esp)
  801944:	00 
  801945:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  80194c:	00 
  80194d:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
  801954:	e8 93 e9 ff ff       	call   8002ec <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  801959:	e8 b9 ef ff ff       	call   800917 <wait>
  80195e:	85 c0                	test   %eax,%eax
  801960:	74 1c                	je     80197e <main+0xd2>
            panic("wait stopped early\n");
  801962:	c7 44 24 08 c0 1e 80 	movl   $0x801ec0,0x8(%esp)
  801969:	00 
  80196a:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801971:	00 
  801972:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
  801979:	e8 6e e9 ff ff       	call   8002ec <__panic>
    ...
    for (; n > 0; n --) {
  80197e:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  801983:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801988:	7f cf                	jg     801959 <main+0xad>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  80198a:	e8 88 ef ff ff       	call   800917 <wait>
  80198f:	85 c0                	test   %eax,%eax
  801991:	75 1c                	jne    8019af <main+0x103>
        panic("wait got too many\n");
  801993:	c7 44 24 08 d4 1e 80 	movl   $0x801ed4,0x8(%esp)
  80199a:	00 
  80199b:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8019a2:	00 
  8019a3:	c7 04 24 90 1e 80 00 	movl   $0x801e90,(%esp)
  8019aa:	e8 3d e9 ff ff       	call   8002ec <__panic>
    }

    cprintf("forktest pass.\n");
  8019af:	c7 04 24 e7 1e 80 00 	movl   $0x801ee7,(%esp)
  8019b6:	e8 29 ea ff ff       	call   8003e4 <cprintf>
    return 0;
