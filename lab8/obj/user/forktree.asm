...
umain(int argc, char *argv[]) {
  ...
  800af9:	e8 66 0e 00 00       	call   801964 <main>
...
forkchild(const char *cur, char branch) {
  ...
  8018af:	83 ec 48             	sub    $0x48,%esp
  8018b2:	8b 45 0c             	mov    0xc(%ebp),%eax
  8018b5:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8018b8:	8b 45 08             	mov    0x8(%ebp),%eax
  8018bb:	89 04 24             	mov    %eax,(%esp)
  8018be:	e8 d1 fa ff ff       	call   801394 <strlen>
  8018c3:	83 f8 03             	cmp    $0x3,%eax
  8018c6:	77 4f                	ja     801917 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8018c8:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8018cc:	89 44 24 10          	mov    %eax,0x10(%esp)
  8018d0:	8b 45 08             	mov    0x8(%ebp),%eax
  8018d3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8018d7:	c7 44 24 08 20 1e 80 	movl   $0x801e20,0x8(%esp)
  8018de:	00 
  8018df:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  8018e6:	00 
  8018e7:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8018ea:	89 04 24             	mov    %eax,(%esp)
  8018ed:	e8 fc f8 ff ff       	call   8011ee <snprintf>
    if (fork() == 0) {
  8018f2:	e8 13 f0 ff ff       	call   80090a <fork>
  8018f7:	85 c0                	test   %eax,%eax
  8018f9:	75 1d                	jne    801918 <forkchild+0x6c>
        forktree(nxt);
  8018fb:	8d 45 f3             	lea    -0xd(%ebp),%eax
  8018fe:	89 04 24             	mov    %eax,(%esp)
  801901:	e8 14 00 00 00       	call   80191a <forktree>
        yield();
  801906:	e8 42 f0 ff ff       	call   80094d <yield>
        exit(0);
  80190b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801912:	e8 d4 ef ff ff       	call   8008eb <exit>
void
forkchild(const char *cur, char branch) {
    char nxt[DEPTH + 1];
...
forktree(const char *cur) {
  ...
  80191d:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801920:	e8 48 f0 ff ff       	call   80096d <getpid>
  801925:	8b 55 08             	mov    0x8(%ebp),%edx
  801928:	89 54 24 08          	mov    %edx,0x8(%esp)
  80192c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801930:	c7 04 24 25 1e 80 00 	movl   $0x801e25,(%esp)
  801937:	e8 a8 ea ff ff       	call   8003e4 <cprintf>

    forkchild(cur, '0');
  80193c:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801943:	00 
  801944:	8b 45 08             	mov    0x8(%ebp),%eax
  801947:	89 04 24             	mov    %eax,(%esp)
  80194a:	e8 5d ff ff ff       	call   8018ac <forkchild>
    forkchild(cur, '1');
  80194f:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801956:	00 
  801957:	8b 45 08             	mov    0x8(%ebp),%eax
  80195a:	89 04 24             	mov    %eax,(%esp)
  80195d:	e8 4a ff ff ff       	call   8018ac <forkchild>
}
  801962:	c9                   	leave  
  801963:	c3                   	ret    
...
main(void) {
  ...
  801967:	83 e4 f0             	and    $0xfffffff0,%esp
  80196a:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  80196d:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801974:	00 
  801975:	c7 04 24 38 1e 80 00 	movl   $0x801e38,(%esp)
  80197c:	e8 63 ea ff ff       	call   8003e4 <cprintf>
    sleep(SLEEP_TIME);
  801981:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801988:	e8 0d f0 ff ff       	call   80099a <sleep>
    forktree("");
  80198d:	c7 04 24 5e 1e 80 00 	movl   $0x801e5e,(%esp)
  801994:	e8 81 ff ff ff       	call   80191a <forktree>
    return 0;
