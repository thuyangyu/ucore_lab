...
main(void) {
  ...
  8018b2:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8018b5:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8018bc:	e8 23 eb ff ff       	call   8003e4 <cprintf>
    cprintf("I am process %d.\n", getpid());
  8018c1:	e8 a7 f0 ff ff       	call   80096d <getpid>
  8018c6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018ca:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
  8018d1:	e8 0e eb ff ff       	call   8003e4 <cprintf>
    cprintf("hello pass.\n");
  8018d6:	c7 04 24 a2 1d 80 00 	movl   $0x801da2,(%esp)
  8018dd:	e8 02 eb ff ff       	call   8003e4 <cprintf>
    return 0;
