...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 60 1c 80 00 	movl   $0x801c60,(%esp)
  ...
  800284:	c7 04 24 6b 1c 80 00 	movl   $0x801c6b,(%esp)
  ...
  80029a:	c7 04 24 7d 1c 80 00 	movl   $0x801c7d,(%esp)
  ...
  8002b0:	c7 04 24 90 1c 80 00 	movl   $0x801c90,(%esp)
  ...
  8002c6:	c7 04 24 a3 1c 80 00 	movl   $0x801ca3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 b6 1c 80 00 	movl   $0x801cb6,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 d0 1c 80 00 	movl   $0x801cd0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 d2 1c 80 00 	movl   $0x801cd2,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 d0 1c 80 00 	movl   $0x801cd0,(%esp)
...
lock_fork(void) {
  ...
  8008c6:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008c9:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
unlock_fork(void) {
  ...
  8008da:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008dd:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 ee 1c 80 00 	movl   $0x801cee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 01 1d 80 	movl   $0x801d01,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 08 1d 80 	movl   $0x801d08,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 22 1d 80 00 	movl   $0x801d22,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 34 1d 80 	movl   $0x801d34,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 3c 1d 80 	movl   $0x801d3c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 22 1d 80 00 	movl   $0x801d22,(%esp)
  ...
  800af9:	e8 f2 10 00 00       	call   801bf0 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 64 1f 80 00       	add    $0x801f64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 88 1f 80 00 	mov    0x801f88(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 7e 1f 80 	movl   $0x801f7e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 81 1f 80 00       	mov    $0x801f81,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8018af:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8018b2:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8018b6:	8b 45 08             	mov    0x8(%ebp),%eax
  8018b9:	25 00 70 00 00       	and    $0x7000,%eax
  8018be:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8018c3:	75 04                	jne    8018c9 <getmode+0x1d>
  8018c5:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8018c9:	8b 45 08             	mov    0x8(%ebp),%eax
  8018cc:	25 00 70 00 00       	and    $0x7000,%eax
  8018d1:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8018d6:	75 04                	jne    8018dc <getmode+0x30>
  8018d8:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  8018dc:	8b 45 08             	mov    0x8(%ebp),%eax
  8018df:	25 00 70 00 00       	and    $0x7000,%eax
  8018e4:	3d 00 30 00 00       	cmp    $0x3000,%eax
  8018e9:	75 04                	jne    8018ef <getmode+0x43>
  8018eb:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  8018ef:	8b 45 08             	mov    0x8(%ebp),%eax
  8018f2:	25 00 70 00 00       	and    $0x7000,%eax
  8018f7:	3d 00 40 00 00       	cmp    $0x4000,%eax
  8018fc:	75 04                	jne    801902 <getmode+0x56>
  8018fe:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801902:	8b 45 08             	mov    0x8(%ebp),%eax
  801905:	25 00 70 00 00       	and    $0x7000,%eax
  80190a:	3d 00 50 00 00       	cmp    $0x5000,%eax
  80190f:	75 04                	jne    801915 <getmode+0x69>
  801911:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  801915:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  801919:	c9                   	leave  
  80191a:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  801921:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801928:	00 
  801929:	8b 45 08             	mov    0x8(%ebp),%eax
  80192c:	89 04 24             	mov    %eax,(%esp)
  80192f:	e8 c4 e7 ff ff       	call   8000f8 <open>
  801934:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801937:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80193b:	79 05                	jns    801942 <getstat+0x27>
        return fd;
  80193d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801940:	eb 23                	jmp    801965 <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  801975:	e8 32 ff ff ff       	call   8018ac <getmode>
  80197a:	0f be c0             	movsbl %al,%eax
  80197d:	89 44 24 08          	mov    %eax,0x8(%esp)
  801981:	c7 44 24 04 e0 20 80 	movl   $0x8020e0,0x4(%esp)
  801988:	00 
  801989:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801990:	e8 39 eb ff ff       	call   8004ce <fprintf>
    printf(" %3d(h)", stat->st_nlinks);
  801995:	8b 45 08             	mov    0x8(%ebp),%eax
  801998:	8b 40 04             	mov    0x4(%eax),%eax
  80199b:	89 44 24 08          	mov    %eax,0x8(%esp)
  80199f:	c7 44 24 04 e8 20 80 	movl   $0x8020e8,0x4(%esp)
  8019a6:	00 
  8019a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019ae:	e8 1b eb ff ff       	call   8004ce <fprintf>
    printf(" %8d(b)", stat->st_blocks);
  8019b3:	8b 45 08             	mov    0x8(%ebp),%eax
  8019b6:	8b 40 08             	mov    0x8(%eax),%eax
  8019b9:	89 44 24 08          	mov    %eax,0x8(%esp)
  8019bd:	c7 44 24 04 f0 20 80 	movl   $0x8020f0,0x4(%esp)
  8019c4:	00 
  8019c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019cc:	e8 fd ea ff ff       	call   8004ce <fprintf>
    printf(" %8d(s)", stat->st_size);
  8019d1:	8b 45 08             	mov    0x8(%ebp),%eax
  8019d4:	8b 40 0c             	mov    0xc(%eax),%eax
  8019d7:	89 44 24 08          	mov    %eax,0x8(%esp)
  8019db:	c7 44 24 04 f8 20 80 	movl   $0x8020f8,0x4(%esp)
  8019e2:	00 
  8019e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019ea:	e8 df ea ff ff       	call   8004ce <fprintf>
    printf("   %s\n", filename);
  8019ef:	8b 45 0c             	mov    0xc(%ebp),%eax
  8019f2:	89 44 24 08          	mov    %eax,0x8(%esp)
  8019f6:	c7 44 24 04 00 21 80 	movl   $0x802100,0x4(%esp)
  8019fd:	00 
  8019fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a05:	e8 c4 ea ff ff       	call   8004ce <fprintf>
}
  801a0a:	c9                   	leave  
  801a0b:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  801a0f:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801a12:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801a15:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801a18:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  801a1f:	e8 fc e5 ff ff       	call   800020 <opendir>
  801a24:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801a27:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801a2b:	75 3a                	jne    801a67 <lsdir+0x5b>
        return -1;
  801a2d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801a32:	eb 7c                	jmp    801ab0 <lsdir+0xa4>
    }
  ...
  801a44:	e8 d2 fe ff ff       	call   80191b <getstat>
  801a49:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801a4c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801a50:	75 4f                	jne    801aa1 <lsdir+0x95>
            goto failed;
        }
        lsstat(stat, direntp->name);
  801a52:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801a55:	83 c0 04             	add    $0x4,%eax
  801a58:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a5f:	89 04 24             	mov    %eax,(%esp)
  801a62:	e8 00 ff ff ff       	call   801967 <lsstat>
  ...
  801a6d:	e8 26 e6 ff ff       	call   800098 <readdir>
  801a72:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801a75:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801a79:	75 b9                	jne    801a34 <lsdir+0x28>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
    ...
    printf("lsdir: step 4\n");
  801a7b:	c7 44 24 04 09 21 80 	movl   $0x802109,0x4(%esp)
  801a82:	00 
  801a83:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a8a:	e8 3f ea ff ff       	call   8004ce <fprintf>
    closedir(dirp);
  801a8f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a92:	89 04 24             	mov    %eax,(%esp)
  801a95:	e8 2e e6 ff ff       	call   8000c8 <closedir>
    return 0;
  801a9a:	b8 00 00 00 00       	mov    $0x0,%eax
  801a9f:	eb 0f                	jmp    801ab0 <lsdir+0xa4>
        return -1;
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
...
failed:
  ...
  801aa8:	e8 1b e6 ff ff       	call   8000c8 <closedir>
    return ret;
...
ls(const char *path) {
  ...
  801ab5:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801ab8:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  801acb:	e8 4b fe ff ff       	call   80191b <getstat>
  801ad0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801ad3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801ad7:	74 08                	je     801ae1 <ls+0x2f>
        return ret;
  801ad9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801adc:	e9 0d 01 00 00       	jmp    801bee <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  801ae9:	e8 be fd ff ff       	call   8018ac <getmode>
  801aee:	0f be c0             	movsbl %al,%eax
  801af1:	83 f8 63             	cmp    $0x63,%eax
  801af4:	74 38                	je     801b2e <ls+0x7c>
  801af6:	83 f8 63             	cmp    $0x63,%eax
  801af9:	7f 0c                	jg     801b07 <ls+0x55>
  801afb:	83 f8 30             	cmp    $0x30,%eax
  801afe:	74 13                	je     801b13 <ls+0x61>
  801b00:	83 f8 62             	cmp    $0x62,%eax
  801b03:	74 32                	je     801b37 <ls+0x85>
  801b05:	eb 39                	jmp    801b40 <ls+0x8e>
  801b07:	83 f8 64             	cmp    $0x64,%eax
  801b0a:	74 10                	je     801b1c <ls+0x6a>
  801b0c:	83 f8 6c             	cmp    $0x6c,%eax
  801b0f:	74 14                	je     801b25 <ls+0x73>
  801b11:	eb 2d                	jmp    801b40 <ls+0x8e>
    case '0': type = 0; break;
  801b13:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801b1a:	eb 2c                	jmp    801b48 <ls+0x96>
    case 'd': type = 1; break;
  801b1c:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801b23:	eb 23                	jmp    801b48 <ls+0x96>
    case 'l': type = 2; break;
  801b25:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801b2c:	eb 1a                	jmp    801b48 <ls+0x96>
    case 'c': type = 3; break;
  801b2e:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801b35:	eb 11                	jmp    801b48 <ls+0x96>
    case 'b': type = 4; break;
  801b37:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801b3e:	eb 08                	jmp    801b48 <ls+0x96>
    default:  type = 5; break;
  801b40:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801b47:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801b48:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b4b:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801b52:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b56:	c7 44 24 04 18 21 80 	movl   $0x802118,0x4(%esp)
  801b5d:	00 
  801b5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b65:	e8 64 e9 ff ff       	call   8004ce <fprintf>
    printf(" %d(hlinks)", stat->st_nlinks);
  801b6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b6d:	8b 40 04             	mov    0x4(%eax),%eax
  801b70:	89 44 24 08          	mov    %eax,0x8(%esp)
  801b74:	c7 44 24 04 21 21 80 	movl   $0x802121,0x4(%esp)
  801b7b:	00 
  801b7c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b83:	e8 46 e9 ff ff       	call   8004ce <fprintf>
  ...
  801b92:	c7 44 24 04 2d 21 80 	movl   $0x80212d,0x4(%esp)
  801b99:	00 
  801b9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ba1:	e8 28 e9 ff ff       	call   8004ce <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  801ba6:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ba9:	8b 40 0c             	mov    0xc(%eax),%eax
  801bac:	8b 55 08             	mov    0x8(%ebp),%edx
  801baf:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801bb3:	89 44 24 08          	mov    %eax,0x8(%esp)
  801bb7:	c7 44 24 04 39 21 80 	movl   $0x802139,0x4(%esp)
  801bbe:	00 
  801bbf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801bc6:	e8 03 e9 ff ff       	call   8004ce <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801bcb:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801bce:	8b 00                	mov    (%eax),%eax
  801bd0:	25 00 70 00 00       	and    $0x7000,%eax
  801bd5:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801bda:	75 0d                	jne    801be9 <ls+0x137>
        return lsdir(path);
  801bdc:	8b 45 08             	mov    0x8(%ebp),%eax
  801bdf:	89 04 24             	mov    %eax,(%esp)
  801be2:	e8 25 fe ff ff       	call   801a0c <lsdir>
  801be7:	eb 05                	jmp    801bee <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801bf3:	83 e4 f0             	and    $0xfffffff0,%esp
  801bf6:	83 ec 20             	sub    $0x20,%esp
    if (argc == 1) {
  801bf9:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801bfd:	75 0e                	jne    801c0d <main+0x1d>
        return ls(".");
  801bff:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  801c06:	e8 a7 fe ff ff       	call   801ab2 <ls>
  801c0b:	eb 42                	jmp    801c4f <main+0x5f>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801c0d:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801c14:	00 
  801c15:	eb 2a                	jmp    801c41 <main+0x51>
            if ((ret = ls(argv[i])) != 0) {
  801c17:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801c1b:	c1 e0 02             	shl    $0x2,%eax
  801c1e:	03 45 0c             	add    0xc(%ebp),%eax
  801c21:	8b 00                	mov    (%eax),%eax
  801c23:	89 04 24             	mov    %eax,(%esp)
  801c26:	e8 87 fe ff ff       	call   801ab2 <ls>
  801c2b:	89 44 24 18          	mov    %eax,0x18(%esp)
  801c2f:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801c34:	74 06                	je     801c3c <main+0x4c>
                return ret;
  801c36:	8b 44 24 18          	mov    0x18(%esp),%eax
  801c3a:	eb 13                	jmp    801c4f <main+0x5f>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801c3c:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801c41:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801c45:	3b 45 08             	cmp    0x8(%ebp),%eax
  801c48:	7c cd                	jl     801c17 <main+0x27>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
