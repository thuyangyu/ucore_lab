...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 80 1c 80 00 	movl   $0x801c80,(%esp)
  ...
  800284:	c7 04 24 8b 1c 80 00 	movl   $0x801c8b,(%esp)
  ...
  80029a:	c7 04 24 9d 1c 80 00 	movl   $0x801c9d,(%esp)
  ...
  8002b0:	c7 04 24 b0 1c 80 00 	movl   $0x801cb0,(%esp)
  ...
  8002c6:	c7 04 24 c3 1c 80 00 	movl   $0x801cc3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 d6 1c 80 00 	movl   $0x801cd6,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 f0 1c 80 00 	movl   $0x801cf0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 f2 1c 80 00 	movl   $0x801cf2,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 f0 1c 80 00 	movl   $0x801cf0,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 0e 1d 80 00 	movl   $0x801d0e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 21 1d 80 	movl   $0x801d21,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 28 1d 80 	movl   $0x801d28,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 42 1d 80 00 	movl   $0x801d42,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 54 1d 80 	movl   $0x801d54,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 5c 1d 80 	movl   $0x801d5c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 42 1d 80 00 	movl   $0x801d42,(%esp)
  ...
  800af9:	e8 cc 0f 00 00       	call   801aca <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 84 1f 80 00       	add    $0x801f84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 a8 1f 80 00 	mov    0x801fa8(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 9e 1f 80 	movl   $0x801f9e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be a1 1f 80 00       	mov    $0x801fa1,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8018b3:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8018ba:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8018c1:	eb 5f                	jmp    801922 <work+0x76>
        for (j = 0; j < size; j ++) {
  8018c3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8018ca:	eb 4a                	jmp    801916 <work+0x6a>
            mata[i][j] = matb[i][j] = 1;
  ...
  8018d8:	03 45 f0             	add    -0x10(%ebp),%eax
  8018db:	c7 04 85 e0 31 80 00 	movl   $0x1,0x8031e0(,%eax,4)
  8018e2:	01 00 00 00 
  ...
  8018f2:	03 45 f0             	add    -0x10(%ebp),%eax
  8018f5:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  801908:	03 45 f0             	add    -0x10(%ebp),%eax
  80190b:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  801912:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801916:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801919:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80191c:	7c ae                	jl     8018cc <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  80191e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801922:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801925:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801928:	7c 99                	jl     8018c3 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  80192a:	e8 1e f0 ff ff       	call   80094d <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  80192f:	e8 39 f0 ff ff       	call   80096d <getpid>
  801934:	8b 55 08             	mov    0x8(%ebp),%edx
  801937:	89 54 24 08          	mov    %edx,0x8(%esp)
  80193b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80193f:	c7 04 24 00 21 80 00 	movl   $0x802100,(%esp)
  801946:	e8 99 ea ff ff       	call   8003e4 <cprintf>

    while (times -- > 0) {
  80194b:	e9 46 01 00 00       	jmp    801a96 <work+0x1ea>
        for (i = 0; i < size; i ++) {
  801950:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801957:	e9 ac 00 00 00       	jmp    801a08 <work+0x15c>
            for (j = 0; j < size; j ++) {
  80195c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801963:	e9 90 00 00 00       	jmp    8019f8 <work+0x14c>
                matc[i][j] = 0;
  ...
  801974:	03 45 f0             	add    -0x10(%ebp),%eax
  801977:	c7 04 85 80 33 80 00 	movl   $0x0,0x803380(,%eax,4)
  80197e:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  801982:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801989:	eb 61                	jmp    8019ec <work+0x140>
  ...
  801997:	03 45 f0             	add    -0x10(%ebp),%eax
  80199a:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  8019ad:	03 45 ec             	add    -0x14(%ebp),%eax
  8019b0:	8b 1c 85 40 30 80 00 	mov    0x803040(,%eax,4),%ebx
  8019b7:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8019ba:	89 d0                	mov    %edx,%eax
  8019bc:	c1 e0 02             	shl    $0x2,%eax
  8019bf:	01 d0                	add    %edx,%eax
  8019c1:	01 c0                	add    %eax,%eax
  8019c3:	03 45 f0             	add    -0x10(%ebp),%eax
  8019c6:	8b 04 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%eax
  8019cd:	0f af c3             	imul   %ebx,%eax
  8019d0:	01 c1                	add    %eax,%ecx
  ...
  8019de:	03 45 f0             	add    -0x10(%ebp),%eax
  8019e1:	89 0c 85 80 33 80 00 	mov    %ecx,0x803380(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  8019e8:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  8019ec:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019ef:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019f2:	7c 97                	jl     80198b <work+0xdf>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8019f4:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8019f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019fb:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019fe:	0f 8c 64 ff ff ff    	jl     801968 <work+0xbc>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801a04:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801a08:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a0b:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801a0e:	0f 8c 48 ff ff ff    	jl     80195c <work+0xb0>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801a1b:	eb 71                	jmp    801a8e <work+0x1e2>
            for (j = 0; j < size; j ++) {
  801a1d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801a24:	eb 5c                	jmp    801a82 <work+0x1d6>
  ...
  801a32:	03 45 f0             	add    -0x10(%ebp),%eax
  801a35:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  801a48:	03 45 f0             	add    -0x10(%ebp),%eax
  801a4b:	89 0c 85 e0 31 80 00 	mov    %ecx,0x8031e0(,%eax,4)
  ...
  801a5e:	03 45 f0             	add    -0x10(%ebp),%eax
  801a61:	8b 0c 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%ecx
  ...
  801a74:	03 45 f0             	add    -0x10(%ebp),%eax
  801a77:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801a7e:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801a82:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a85:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801a88:	7c 9c                	jl     801a26 <work+0x17a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  801a8a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801a8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a91:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801a94:	7c 87                	jl     801a1d <work+0x171>
    ...
    while (times -- > 0) {
  801a96:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  801a9a:	0f 95 c0             	setne  %al
  801a9d:	83 6d 08 01          	subl   $0x1,0x8(%ebp)
  801aa1:	84 c0                	test   %al,%al
  801aa3:	0f 85 a7 fe ff ff    	jne    801950 <work+0xa4>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  801aa9:	e8 bf ee ff ff       	call   80096d <getpid>
  801aae:	89 44 24 04          	mov    %eax,0x4(%esp)
  801ab2:	c7 04 24 20 21 80 00 	movl   $0x802120,(%esp)
  801ab9:	e8 26 e9 ff ff       	call   8003e4 <cprintf>
    exit(0);
  801abe:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801ac5:	e8 21 ee ff ff       	call   8008eb <exit>
...
int
main(void) {
  801aca:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801ace:	83 e4 f0             	and    $0xfffffff0,%esp
  801ad1:	ff 71 fc             	pushl  -0x4(%ecx)
  801ad4:	55                   	push   %ebp
  801ad5:	89 e5                	mov    %esp,%ebp
  801ad7:	53                   	push   %ebx
  801ad8:	51                   	push   %ecx
  801ad9:	83 ec 30             	sub    $0x30,%esp
  801adc:	89 e0                	mov    %esp,%eax
  801ade:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801ae0:	a1 30 21 80 00       	mov    0x802130,%eax
  801ae5:	83 e8 01             	sub    $0x1,%eax
  801ae8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801aeb:	a1 30 21 80 00       	mov    0x802130,%eax
  801af0:	c1 e0 02             	shl    $0x2,%eax
  801af3:	8d 50 0f             	lea    0xf(%eax),%edx
  801af6:	b8 10 00 00 00       	mov    $0x10,%eax
  801afb:	83 e8 01             	sub    $0x1,%eax
  801afe:	01 d0                	add    %edx,%eax
  801b00:	c7 45 e4 10 00 00 00 	movl   $0x10,-0x1c(%ebp)
  801b07:	ba 00 00 00 00       	mov    $0x0,%edx
  801b0c:	f7 75 e4             	divl   -0x1c(%ebp)
  801b0f:	6b c0 10             	imul   $0x10,%eax,%eax
  801b12:	29 c4                	sub    %eax,%esp
  801b14:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801b18:	83 c0 0f             	add    $0xf,%eax
  801b1b:	c1 e8 04             	shr    $0x4,%eax
  801b1e:	c1 e0 04             	shl    $0x4,%eax
  801b21:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  801b24:	a1 30 21 80 00       	mov    0x802130,%eax
  801b29:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801b30:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b33:	89 54 24 08          	mov    %edx,0x8(%esp)
  801b37:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801b3e:	00 
  801b3f:	89 04 24             	mov    %eax,(%esp)
  801b42:	e8 ad fb ff ff       	call   8016f4 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801b47:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801b4e:	eb 71                	jmp    801bc1 <main+0xf7>
        if ((pids[i] = fork()) == 0) {
  801b50:	e8 b5 ed ff ff       	call   80090a <fork>
  801b55:	8b 55 ec             	mov    -0x14(%ebp),%edx
  801b58:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801b5b:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801b5e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b61:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801b64:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b67:	85 c0                	test   %eax,%eax
  801b69:	75 45                	jne    801bb0 <main+0xe6>
            srand(i * i);
  801b6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b6e:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  801b72:	89 04 24             	mov    %eax,(%esp)
  801b75:	e8 00 f8 ff ff       	call   80137a <srand>
            int times = (((unsigned int)rand()) % total);
  801b7a:	e8 11 f7 ff ff       	call   801290 <rand>
  801b7f:	8b 15 30 21 80 00    	mov    0x802130,%edx
  ...
  801b93:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801b96:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  801b9a:	6b c0 64             	imul   $0x64,%eax,%eax
  801b9d:	05 e8 03 00 00       	add    $0x3e8,%eax
  801ba2:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  801ba5:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801ba8:	89 04 24             	mov    %eax,(%esp)
  801bab:	e8 fc fc ff ff       	call   8018ac <work>
        }
        if (pids[i] < 0) {
  801bb0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801bb3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801bb6:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801bb9:	85 c0                	test   %eax,%eax
  801bbb:	78 65                	js     801c22 <main+0x158>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801bbd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801bc1:	a1 30 21 80 00       	mov    0x802130,%eax
  801bc6:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801bc9:	7c 85                	jl     801b50 <main+0x86>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801bcb:	c7 04 24 34 21 80 00 	movl   $0x802134,(%esp)
  801bd2:	e8 0d e8 ff ff       	call   8003e4 <cprintf>

    for (i = 0; i < total; i ++) {
  801bd7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801bde:	eb 1b                	jmp    801bfb <main+0x131>
        if (wait() != 0) {
  801be0:	e8 32 ed ff ff       	call   800917 <wait>
  801be5:	85 c0                	test   %eax,%eax
  801be7:	74 0e                	je     801bf7 <main+0x12d>
            cprintf("wait failed.\n");
  801be9:	c7 04 24 3e 21 80 00 	movl   $0x80213e,(%esp)
  801bf0:	e8 ef e7 ff ff       	call   8003e4 <cprintf>
            goto failed;
  801bf5:	eb 2c                	jmp    801c23 <main+0x159>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801bf7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801bfb:	a1 30 21 80 00       	mov    0x802130,%eax
  801c00:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801c03:	7c db                	jl     801be0 <main+0x116>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801c05:	c7 04 24 4c 21 80 00 	movl   $0x80214c,(%esp)
  801c0c:	e8 d3 e7 ff ff       	call   8003e4 <cprintf>
    return 0;
  801c11:	b8 00 00 00 00       	mov    $0x0,%eax
  801c16:	89 dc                	mov    %ebx,%esp
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
  ...
  801c1c:	5b                   	pop    %ebx
  801c1d:	5d                   	pop    %ebp
  801c1e:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801c21:	c3                   	ret    
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
...
failed:
    for (i = 0; i < total; i ++) {
  801c4a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801c4e:	a1 30 21 80 00       	mov    0x802130,%eax
  801c53:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801c56:	7c d4                	jl     801c2c <main+0x162>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801c58:	c7 44 24 08 5a 21 80 	movl   $0x80215a,0x8(%esp)
  801c5f:	00 
  801c60:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801c67:	00 
  801c68:	c7 04 24 65 21 80 00 	movl   $0x802165,(%esp)
  801c6f:	e8 78 e6 ff ff       	call   8002ec <__panic>
