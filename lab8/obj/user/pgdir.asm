...
main(void) {
  ...
  8018be:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  8018c5:	e8 1a eb ff ff       	call   8003e4 <cprintf>
    print_pgdir();
  8018ca:	e8 ab f0 ff ff       	call   80097a <print_pgdir>
    cprintf("pgdir pass.\n");
  8018cf:	c7 04 24 97 1d 80 00 	movl   $0x801d97,(%esp)
  8018d6:	e8 09 eb ff ff       	call   8003e4 <cprintf>
    return 0;
