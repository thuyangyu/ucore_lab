...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 16 1c 80 00 	movl   $0x801c16,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 32 1c 80 00 	movl   $0x801c32,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 4e 1c 80 00 	movl   $0x801c4e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 61 1c 80 	movl   $0x801c61,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 68 1c 80 	movl   $0x801c68,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 82 1c 80 00 	movl   $0x801c82,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 94 1c 80 	movl   $0x801c94,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 9c 1c 80 	movl   $0x801c9c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 82 1c 80 00 	movl   $0x801c82,(%esp)
  ...
  800af9:	e8 da 0d 00 00       	call   8018d8 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 c4 1e 80 00       	add    $0x801ec4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 e8 1e 80 00 	mov    0x801ee8(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c de 1e 80 	movl   $0x801ede,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be e1 1e 80 00       	mov    $0x801ee1,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8018b9:	eb 12                	jmp    8018cd <spin_delay+0x21>
     {
          j = !j;
  8018bb:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8018be:	85 c0                	test   %eax,%eax
  8018c0:	0f 94 c0             	sete   %al
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8018c9:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8018cd:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  8018d4:	75 e5                	jne    8018bb <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  8018db:	53                   	push   %ebx
  8018dc:	83 e4 f0             	and    $0xfffffff0,%esp
  8018df:	83 ec 30             	sub    $0x30,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  8018e2:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  8018e9:	00 
  8018ea:	c7 04 24 40 20 80 00 	movl   $0x802040,(%esp)
  8018f1:	e8 ee ea ff ff       	call   8003e4 <cprintf>
     sleep(SLEEP_TIME);
  8018f6:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8018fd:	e8 98 f0 ff ff       	call   80099a <sleep>
     memset(pids, 0, sizeof(pids));
  801902:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801909:	00 
  80190a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801911:	00 
  801912:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  801919:	e8 d6 fd ff ff       	call   8016f4 <memset>
     lab6_set_priority(TOTAL + 1);
  80191e:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801925:	e8 5d f0 ff ff       	call   800987 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  80192a:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801931:	00 
  801932:	e9 04 01 00 00       	jmp    801a3b <main+0x163>
          acc[i]=0;
  801937:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80193b:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801942:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801946:	e8 bf ef ff ff       	call   80090a <fork>
  80194b:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  80194f:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  801956:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80195a:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801961:	85 c0                	test   %eax,%eax
  801963:	0f 85 ba 00 00 00    	jne    801a23 <main+0x14b>
               lab6_set_priority(i + 1);
  801969:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80196d:	83 c0 01             	add    $0x1,%eax
  801970:	89 04 24             	mov    %eax,(%esp)
  801973:	e8 0f f0 ff ff       	call   800987 <lab6_set_priority>
               acc[i] = 0;
  801978:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  80197c:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801983:	00 00 00 00 
  801987:	eb 01                	jmp    80198a <main+0xb2>
  ...
  801989:	90                   	nop
          ...
          if ((pids[i] = fork()) == 0) {
               ...
               while (1) {
                    spin_delay();
  80198a:	e8 1d ff ff ff       	call   8018ac <spin_delay>
                    ++ acc[i];
  80198f:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801993:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  80199a:	8d 50 01             	lea    0x1(%eax),%edx
  80199d:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8019a1:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  8019a8:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8019ac:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  8019b3:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8019b8:	89 c8                	mov    %ecx,%eax
  8019ba:	f7 e2                	mul    %edx
  8019bc:	89 d0                	mov    %edx,%eax
  8019be:	c1 e8 08             	shr    $0x8,%eax
  8019c1:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8019c7:	89 ca                	mov    %ecx,%edx
  8019c9:	29 c2                	sub    %eax,%edx
  8019cb:	89 d0                	mov    %edx,%eax
  8019cd:	85 c0                	test   %eax,%eax
  8019cf:	75 b8                	jne    801989 <main+0xb1>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  8019d1:	e8 d7 ef ff ff       	call   8009ad <gettime_msec>
  8019d6:	89 44 24 28          	mov    %eax,0x28(%esp)
  8019da:	81 7c 24 28 78 05 00 	cmpl   $0x578,0x28(%esp)
  8019e1:	00 
  8019e2:	7e a5                	jle    801989 <main+0xb1>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  8019e4:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  8019e8:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  8019ef:	e8 79 ef ff ff       	call   80096d <getpid>
  8019f4:	8b 54 24 28          	mov    0x28(%esp),%edx
  8019f8:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8019fc:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801a00:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a04:	c7 04 24 68 20 80 00 	movl   $0x802068,(%esp)
  801a0b:	e8 d4 e9 ff ff       	call   8003e4 <cprintf>
                            exit(acc[i]);
  801a10:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801a14:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801a1b:	89 04 24             	mov    %eax,(%esp)
  801a1e:	e8 c8 ee ff ff       	call   8008eb <exit>
                        }
                    }
               }
  ...
  801a27:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a2e:	85 c0                	test   %eax,%eax
  801a30:	0f 88 18 01 00 00    	js     801b4e <main+0x276>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  801a36:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801a3b:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801a40:	0f 8e f1 fe ff ff    	jle    801937 <main+0x5f>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  801a46:	c7 04 24 88 20 80 00 	movl   $0x802088,(%esp)
  801a4d:	e8 92 e9 ff ff       	call   8003e4 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  801a52:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801a59:	00 
  801a5a:	eb 6b                	jmp    801ac7 <main+0x1ef>
         status[i]=0;
  801a5c:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801a60:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  801a67:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  801a6b:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801a6f:	c1 e0 02             	shl    $0x2,%eax
  801a72:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  801a78:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801a7c:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a83:	89 54 24 04          	mov    %edx,0x4(%esp)
  801a87:	89 04 24             	mov    %eax,(%esp)
  801a8a:	e8 a4 ee ff ff       	call   800933 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  801a8f:	e8 19 ef ff ff       	call   8009ad <gettime_msec>
  801a94:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801a98:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  801a9f:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801aa3:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  801aaa:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801aae:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801ab2:	89 54 24 04          	mov    %edx,0x4(%esp)
  801ab6:	c7 04 24 b0 20 80 00 	movl   $0x8020b0,(%esp)
  801abd:	e8 22 e9 ff ff       	call   8003e4 <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  801ac2:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801ac7:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801acc:	7e 8e                	jle    801a5c <main+0x184>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801ace:	c7 04 24 cf 20 80 00 	movl   $0x8020cf,(%esp)
  801ad5:	e8 0a e9 ff ff       	call   8003e4 <cprintf>
     cprintf("stride sched correct result:");
  801ada:	c7 04 24 e5 20 80 00 	movl   $0x8020e5,(%esp)
  801ae1:	e8 fe e8 ff ff       	call   8003e4 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801ae6:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801aed:	00 
  801aee:	eb 41                	jmp    801b31 <main+0x259>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801af0:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801af4:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801afb:	01 c0                	add    %eax,%eax
  801afd:	8b 15 5c 31 80 00    	mov    0x80315c,%edx
  801b03:	89 54 24 1c          	mov    %edx,0x1c(%esp)
  801b07:	89 c2                	mov    %eax,%edx
  801b09:	c1 fa 1f             	sar    $0x1f,%edx
  801b0c:	f7 7c 24 1c          	idivl  0x1c(%esp)
  801b10:	83 c0 01             	add    $0x1,%eax
  801b13:	89 c2                	mov    %eax,%edx
  801b15:	c1 ea 1f             	shr    $0x1f,%edx
  801b18:	01 d0                	add    %edx,%eax
  801b1a:	d1 f8                	sar    %eax
  801b1c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b20:	c7 04 24 02 21 80 00 	movl   $0x802102,(%esp)
  801b27:	e8 b8 e8 ff ff       	call   8003e4 <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801b2c:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801b31:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801b36:	7e b8                	jle    801af0 <main+0x218>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801b38:	c7 04 24 06 21 80 00 	movl   $0x802106,(%esp)
  801b3f:	e8 a0 e8 ff ff       	call   8003e4 <cprintf>
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801b4f:	c7 44 24 2c 00 00 00 	movl   $0x0,0x2c(%esp)
  801b56:	00 
  801b57:	eb 27                	jmp    801b80 <main+0x2a8>
          if (pids[i] > 0) {
  801b59:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801b5d:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801b64:	85 c0                	test   %eax,%eax
  801b66:	7e 13                	jle    801b7b <main+0x2a3>
               kill(pids[i]);
  801b68:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801b6c:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801b73:	89 04 24             	mov    %eax,(%esp)
  801b76:	e8 df ed ff ff       	call   80095a <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801b7b:	83 44 24 2c 01       	addl   $0x1,0x2c(%esp)
  801b80:	83 7c 24 2c 04       	cmpl   $0x4,0x2c(%esp)
  801b85:	7e d2                	jle    801b59 <main+0x281>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801b87:	c7 44 24 08 08 21 80 	movl   $0x802108,0x8(%esp)
  801b8e:	00 
  801b8f:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801b96:	00 
  801b97:	c7 04 24 13 21 80 00 	movl   $0x802113,(%esp)
  801b9e:	e8 49 e7 ff ff       	call   8002ec <__panic>
