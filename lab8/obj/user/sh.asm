...
opendir(const char *path) {
  ...
  80004e:	a1 00 30 80 00       	mov    0x803000,%eax
  ...
  800079:	a1 00 30 80 00       	mov    0x803000,%eax
  80007e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return dirp;
  800085:	a1 00 30 80 00       	mov    0x803000,%eax
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 e0 20 80 00 	movl   $0x8020e0,(%esp)
  ...
  800284:	c7 04 24 eb 20 80 00 	movl   $0x8020eb,(%esp)
  ...
  80029a:	c7 04 24 fd 20 80 00 	movl   $0x8020fd,(%esp)
  ...
  8002b0:	c7 04 24 10 21 80 00 	movl   $0x802110,(%esp)
  ...
  8002c6:	c7 04 24 23 21 80 00 	movl   $0x802123,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 36 21 80 00 	movl   $0x802136,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 50 21 80 00 	movl   $0x802150,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 52 21 80 00 	movl   $0x802152,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 50 21 80 00 	movl   $0x802150,(%esp)
...
lock_fork(void) {
  ...
  8008c6:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008c9:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
unlock_fork(void) {
  ...
  8008da:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008dd:	c7 04 24 20 30 80 00 	movl   $0x803020,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 6e 21 80 00 	movl   $0x80216e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 81 21 80 	movl   $0x802181,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 88 21 80 	movl   $0x802188,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 a2 21 80 00 	movl   $0x8021a2,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 b4 21 80 	movl   $0x8021b4,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 bc 21 80 	movl   $0x8021bc,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 a2 21 80 00 	movl   $0x8021a2,(%esp)
  ...
  800af9:	e8 57 14 00 00       	call   801f55 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 e4 23 80 00       	add    $0x8023e4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 08 24 80 00 	mov    0x802408(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c fe 23 80 	movl   $0x8023fe,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 01 24 80 00       	mov    $0x802401,%esi
            }
            if (width > 0 && padc != '-') {
...
rand(void) {
  ...
  801299:	a1 08 30 80 00       	mov    0x803008,%eax
  80129e:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
  ...
  8012c9:	89 1d 08 30 80 00    	mov    %ebx,0x803008
  8012cf:	89 35 0c 30 80 00    	mov    %esi,0x80300c
    unsigned long long result = (next >> 12);
  8012d5:	a1 08 30 80 00       	mov    0x803008,%eax
  8012da:	8b 15 0c 30 80 00    	mov    0x80300c,%edx
...
srand(unsigned int seed) {
  ...
  801385:	a3 08 30 80 00       	mov    %eax,0x803008
  80138a:	89 15 0c 30 80 00    	mov    %edx,0x80300c
}
  801390:	5d                   	pop    %ebp
  801391:	c3                   	ret    
	...
...
gettoken(char **p1, char **p2) {
  ...
  8018ba:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8018be:	75 16                	jne    8018d6 <gettoken+0x2a>
        return 0;
  8018c0:	b8 00 00 00 00       	mov    $0x0,%eax
  8018c5:	e9 f5 00 00 00       	jmp    8019bf <gettoken+0x113>
    }
    while (strchr(WHITESPACE, *s) != NULL) {
        *s ++ = '\0';
  8018ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018cd:	c6 00 00             	movb   $0x0,(%eax)
  8018d0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8018d4:	eb 01                	jmp    8018d7 <gettoken+0x2b>
gettoken(char **p1, char **p2) {
    char *s;
    if ((s = *p1) == NULL) {
        return 0;
  ...
  8018e4:	c7 04 24 60 25 80 00 	movl   $0x802560,(%esp)
  8018eb:	e8 49 fc ff ff       	call   801539 <strchr>
  8018f0:	85 c0                	test   %eax,%eax
  8018f2:	75 d6                	jne    8018ca <gettoken+0x1e>
        *s ++ = '\0';
    }
    if (*s == '\0') {
  ...
  8018fc:	75 0a                	jne    801908 <gettoken+0x5c>
        return 0;
  8018fe:	b8 00 00 00 00       	mov    $0x0,%eax
  801903:	e9 b7 00 00 00       	jmp    8019bf <gettoken+0x113>
    }

    *p2 = s;
  801908:	8b 45 0c             	mov    0xc(%ebp),%eax
  80190b:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80190e:	89 10                	mov    %edx,(%eax)
    int token = 'w';
  801910:	c7 45 f0 77 00 00 00 	movl   $0x77,-0x10(%ebp)
    if (strchr(SYMBOLS, *s) != NULL) {
  801917:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80191a:	0f b6 00             	movzbl (%eax),%eax
  80191d:	0f be c0             	movsbl %al,%eax
  801920:	89 44 24 04          	mov    %eax,0x4(%esp)
  801924:	c7 04 24 65 25 80 00 	movl   $0x802565,(%esp)
  80192b:	e8 09 fc ff ff       	call   801539 <strchr>
  801930:	85 c0                	test   %eax,%eax
  801932:	74 18                	je     80194c <gettoken+0xa0>
        token = *s, *s ++ = '\0';
  ...
  801946:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80194a:	eb 57                	jmp    8019a3 <gettoken+0xf7>
    }
    else {
        bool flag = 0;
  80194c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
        while (*s != '\0' && (flag || strchr(WHITESPACE SYMBOLS, *s) == NULL)) {
  801953:	eb 21                	jmp    801976 <gettoken+0xca>
            if (*s == '"') {
  801955:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801958:	0f b6 00             	movzbl (%eax),%eax
  80195b:	3c 22                	cmp    $0x22,%al
  80195d:	75 13                	jne    801972 <gettoken+0xc6>
                *s = ' ', flag = !flag;
  80195f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801962:	c6 00 20             	movb   $0x20,(%eax)
  801965:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801969:	0f 94 c0             	sete   %al
  80196c:	0f b6 c0             	movzbl %al,%eax
  80196f:	89 45 ec             	mov    %eax,-0x14(%ebp)
            }
            s ++;
  801972:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    if (strchr(SYMBOLS, *s) != NULL) {
        token = *s, *s ++ = '\0';
    }
    else {
  ...
  801979:	0f b6 00             	movzbl (%eax),%eax
  80197c:	84 c0                	test   %al,%al
  80197e:	74 23                	je     8019a3 <gettoken+0xf7>
  801980:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801984:	75 cf                	jne    801955 <gettoken+0xa9>
  801986:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801989:	0f b6 00             	movzbl (%eax),%eax
  80198c:	0f be c0             	movsbl %al,%eax
  80198f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801993:	c7 04 24 6b 25 80 00 	movl   $0x80256b,(%esp)
  80199a:	e8 9a fb ff ff       	call   801539 <strchr>
  80199f:	85 c0                	test   %eax,%eax
  8019a1:	74 b2                	je     801955 <gettoken+0xa9>
                *s = ' ', flag = !flag;
            }
            s ++;
        }
  ...
  8019a6:	0f b6 00             	movzbl (%eax),%eax
  8019a9:	84 c0                	test   %al,%al
  8019ab:	74 05                	je     8019b2 <gettoken+0x106>
  8019ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019b0:	eb 05                	jmp    8019b7 <gettoken+0x10b>
  8019b2:	b8 00 00 00 00       	mov    $0x0,%eax
  8019b7:	8b 55 08             	mov    0x8(%ebp),%edx
  8019ba:	89 02                	mov    %eax,(%edx)
    return token;
...
readline(const char *prompt) {
  ...
  8019c4:	83 ec 28             	sub    $0x28,%esp
    static char buffer[BUFSIZE];
    if (prompt != NULL) {
  8019c7:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  8019cb:	74 1b                	je     8019e8 <readline+0x27>
        printf("%s", prompt);
  8019cd:	8b 45 08             	mov    0x8(%ebp),%eax
  8019d0:	89 44 24 08          	mov    %eax,0x8(%esp)
  8019d4:	c7 44 24 04 75 25 80 	movl   $0x802575,0x4(%esp)
  8019db:	00 
  8019dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019e3:	e8 e6 ea ff ff       	call   8004ce <fprintf>
    }
    int ret, i = 0;
  8019e8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8019ef:	eb 01                	jmp    8019f2 <readline+0x31>
        else if (c == '\n' || c == '\r') {
            putc(c);
            buffer[i] = '\0';
            break;
  ...
  8019f2:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  8019f9:	00 
  8019fa:	8d 45 ef             	lea    -0x11(%ebp),%eax
  8019fd:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a01:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a08:	e8 18 e7 ff ff       	call   800125 <read>
  801a0d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801a10:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801a14:	79 0a                	jns    801a20 <readline+0x5f>
            return NULL;
  801a16:	b8 00 00 00 00       	mov    $0x0,%eax
  801a1b:	e9 fa 00 00 00       	jmp    801b1a <readline+0x159>
        }
        else if (ret == 0) {
  801a20:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801a24:	75 20                	jne    801a46 <readline+0x85>
            if (i > 0) {
  801a26:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801a2a:	7e 10                	jle    801a3c <readline+0x7b>
                buffer[i] = '\0';
  801a2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a2f:	05 40 40 80 00       	add    $0x804040,%eax
  801a34:	c6 00 00             	movb   $0x0,(%eax)
                break;
  801a37:	e9 d9 00 00 00       	jmp    801b15 <readline+0x154>
            }
            return NULL;
  801a3c:	b8 00 00 00 00       	mov    $0x0,%eax
  801a41:	e9 d4 00 00 00       	jmp    801b1a <readline+0x159>
        }

        if (c == 3) {
  801a46:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801a4a:	3c 03                	cmp    $0x3,%al
  801a4c:	75 0a                	jne    801a58 <readline+0x97>
            return NULL;
  801a4e:	b8 00 00 00 00       	mov    $0x0,%eax
  801a53:	e9 c2 00 00 00       	jmp    801b1a <readline+0x159>
        }
        else if (c >= ' ' && i < BUFSIZE - 1) {
  801a58:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801a5c:	3c 1f                	cmp    $0x1f,%al
  801a5e:	7e 3d                	jle    801a9d <readline+0xdc>
  801a60:	81 7d f4 fe 0f 00 00 	cmpl   $0xffe,-0xc(%ebp)
  801a67:	7f 34                	jg     801a9d <readline+0xdc>
            putc(c);
  801a69:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801a6d:	0f be c0             	movsbl %al,%eax
  801a70:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a74:	c7 44 24 04 78 25 80 	movl   $0x802578,0x4(%esp)
  801a7b:	00 
  801a7c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a83:	e8 46 ea ff ff       	call   8004ce <fprintf>
            buffer[i ++] = c;
  801a88:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801a8c:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801a8f:	81 c2 40 40 80 00    	add    $0x804040,%edx
  801a95:	88 02                	mov    %al,(%edx)
  801a97:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801a9b:	eb 73                	jmp    801b10 <readline+0x14f>
        }
        else if (c == '\b' && i > 0) {
  801a9d:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801aa1:	3c 08                	cmp    $0x8,%al
  801aa3:	75 2b                	jne    801ad0 <readline+0x10f>
  801aa5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801aa9:	7e 25                	jle    801ad0 <readline+0x10f>
            putc(c);
  801aab:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801aaf:	0f be c0             	movsbl %al,%eax
  801ab2:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ab6:	c7 44 24 04 78 25 80 	movl   $0x802578,0x4(%esp)
  801abd:	00 
  801abe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ac5:	e8 04 ea ff ff       	call   8004ce <fprintf>
            i --;
  801aca:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
  801ace:	eb 40                	jmp    801b10 <readline+0x14f>
        }
        else if (c == '\n' || c == '\r') {
  801ad0:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801ad4:	3c 0a                	cmp    $0xa,%al
  801ad6:	74 0c                	je     801ae4 <readline+0x123>
  801ad8:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801adc:	3c 0d                	cmp    $0xd,%al
  801ade:	0f 85 0d ff ff ff    	jne    8019f1 <readline+0x30>
            putc(c);
  801ae4:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
  801ae8:	0f be c0             	movsbl %al,%eax
  801aeb:	89 44 24 08          	mov    %eax,0x8(%esp)
  801aef:	c7 44 24 04 78 25 80 	movl   $0x802578,0x4(%esp)
  801af6:	00 
  801af7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801afe:	e8 cb e9 ff ff       	call   8004ce <fprintf>
            buffer[i] = '\0';
  801b03:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b06:	05 40 40 80 00       	add    $0x804040,%eax
  801b0b:	c6 00 00             	movb   $0x0,(%eax)
            break;
  801b0e:	eb 05                	jmp    801b15 <readline+0x154>
        }
    }
  801b10:	e9 dc fe ff ff       	jmp    8019f1 <readline+0x30>
    return buffer;
  801b15:	b8 40 40 80 00       	mov    $0x804040,%eax
}
  801b1a:	c9                   	leave  
  801b1b:	c3                   	ret    
...
usage(void) {
  ...
  801b22:	c7 44 24 04 7b 25 80 	movl   $0x80257b,0x4(%esp)
  801b29:	00 
  801b2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801b31:	e8 98 e9 ff ff       	call   8004ce <fprintf>
}
  801b36:	c9                   	leave  
  801b37:	c3                   	ret    
...
reopen(int fd2, const char *filename, uint32_t open_flags) {
  ...
  801b44:	e8 c9 e5 ff ff       	call   800112 <close>
  ...
  801b56:	e8 9d e5 ff ff       	call   8000f8 <open>
  801b5b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801b5e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801b62:	78 39                	js     801b9d <reopen+0x65>
  801b64:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b67:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b6a:	74 31                	je     801b9d <reopen+0x65>
        close(fd2);
  801b6c:	8b 45 08             	mov    0x8(%ebp),%eax
  801b6f:	89 04 24             	mov    %eax,(%esp)
  801b72:	e8 9b e5 ff ff       	call   800112 <close>
  ...
  801b8a:	e8 26 e6 ff ff       	call   8001b5 <dup2>
  801b8f:	89 45 f4             	mov    %eax,-0xc(%ebp)
        close(fd1);
  801b92:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b95:	89 04 24             	mov    %eax,(%esp)
  801b98:	e8 75 e5 ff ff       	call   800112 <close>
    }
    return ret < 0 ? ret : 0;
  801b9d:	b8 00 00 00 00       	mov    $0x0,%eax
  801ba2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801ba6:	0f 4e 45 f4          	cmovle -0xc(%ebp),%eax
}
  801baa:	c9                   	leave  
  801bab:	c3                   	ret    
...
runcmd(char *cmd) {
  ...
  801be8:	81 ec b8 00 00 00    	sub    $0xb8,%esp
...
again:
  ...
  801bf5:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801bfb:	89 44 24 04          	mov    %eax,0x4(%esp)
  801bff:	8d 45 08             	lea    0x8(%ebp),%eax
  801c02:	89 04 24             	mov    %eax,(%esp)
  801c05:	e8 a2 fc ff ff       	call   8018ac <gettoken>
  801c0a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801c0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c10:	83 f8 3e             	cmp    $0x3e,%eax
  801c13:	0f 84 db 00 00 00    	je     801cf4 <runcmd+0x10f>
  801c19:	83 f8 3e             	cmp    $0x3e,%eax
  801c1c:	7f 1b                	jg     801c39 <runcmd+0x54>
  801c1e:	83 f8 3b             	cmp    $0x3b,%eax
  801c21:	0f 84 f9 01 00 00    	je     801e20 <runcmd+0x23b>
  801c27:	83 f8 3c             	cmp    $0x3c,%eax
  801c2a:	74 5d                	je     801c89 <runcmd+0xa4>
  801c2c:	85 c0                	test   %eax,%eax
  801c2e:	0f 84 4e 02 00 00    	je     801e82 <runcmd+0x29d>
  801c34:	e9 1b 02 00 00       	jmp    801e54 <runcmd+0x26f>
  801c39:	83 f8 77             	cmp    $0x77,%eax
  801c3c:	74 0e                	je     801c4c <runcmd+0x67>
  801c3e:	83 f8 7c             	cmp    $0x7c,%eax
  801c41:	0f 84 18 01 00 00    	je     801d5f <runcmd+0x17a>
  801c47:	e9 08 02 00 00       	jmp    801e54 <runcmd+0x26f>
        case 'w':
            if (argc == EXEC_MAX_ARG_NUM) {
  801c4c:	83 7d f4 20          	cmpl   $0x20,-0xc(%ebp)
  801c50:	75 1e                	jne    801c70 <runcmd+0x8b>
                printf("sh error: too many arguments\n");
  801c52:	c7 44 24 04 95 25 80 	movl   $0x802595,0x4(%esp)
  801c59:	00 
  801c5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801c61:	e8 68 e8 ff ff       	call   8004ce <fprintf>
                return -1;
  801c66:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801c6b:	e9 e3 02 00 00       	jmp    801f53 <runcmd+0x36e>
            }
            argv[argc ++] = t;
  801c70:	8b 95 64 ff ff ff    	mov    -0x9c(%ebp),%edx
  801c76:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c79:	89 94 85 68 ff ff ff 	mov    %edx,-0x98(%ebp,%eax,4)
  801c80:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
            break;
  801c84:	e9 f4 01 00 00       	jmp    801e7d <runcmd+0x298>
        case '<':
            if (gettoken(&cmd, &t) != 'w') {
  801c89:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801c8f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801c93:	8d 45 08             	lea    0x8(%ebp),%eax
  801c96:	89 04 24             	mov    %eax,(%esp)
  801c99:	e8 0e fc ff ff       	call   8018ac <gettoken>
  801c9e:	83 f8 77             	cmp    $0x77,%eax
  801ca1:	74 1e                	je     801cc1 <runcmd+0xdc>
                printf("sh error: syntax error: < not followed by word\n");
  801ca3:	c7 44 24 04 b4 25 80 	movl   $0x8025b4,0x4(%esp)
  801caa:	00 
  801cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801cb2:	e8 17 e8 ff ff       	call   8004ce <fprintf>
                return -1;
  801cb7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801cbc:	e9 92 02 00 00       	jmp    801f53 <runcmd+0x36e>
            }
            if ((ret = reopen(0, t, O_RDONLY)) != 0) {
  801cc1:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801cc7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801cce:	00 
  801ccf:	89 44 24 04          	mov    %eax,0x4(%esp)
  801cd3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801cda:	e8 59 fe ff ff       	call   801b38 <reopen>
  801cdf:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801ce2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801ce6:	0f 84 8d 01 00 00    	je     801e79 <runcmd+0x294>
                return ret;
  801cec:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801cef:	e9 5f 02 00 00       	jmp    801f53 <runcmd+0x36e>
            }
            break;
        case '>':
            if (gettoken(&cmd, &t) != 'w') {
  801cf4:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
  801cfa:	89 44 24 04          	mov    %eax,0x4(%esp)
  801cfe:	8d 45 08             	lea    0x8(%ebp),%eax
  801d01:	89 04 24             	mov    %eax,(%esp)
  801d04:	e8 a3 fb ff ff       	call   8018ac <gettoken>
  801d09:	83 f8 77             	cmp    $0x77,%eax
  801d0c:	74 1e                	je     801d2c <runcmd+0x147>
                printf("sh error: syntax error: > not followed by word\n");
  801d0e:	c7 44 24 04 e4 25 80 	movl   $0x8025e4,0x4(%esp)
  801d15:	00 
  801d16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d1d:	e8 ac e7 ff ff       	call   8004ce <fprintf>
                return -1;
  801d22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801d27:	e9 27 02 00 00       	jmp    801f53 <runcmd+0x36e>
            }
            if ((ret = reopen(1, t, O_RDWR | O_TRUNC | O_CREAT)) != 0) {
  801d2c:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
  801d32:	c7 44 24 08 16 00 00 	movl   $0x16,0x8(%esp)
  801d39:	00 
  801d3a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801d3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801d45:	e8 ee fd ff ff       	call   801b38 <reopen>
  801d4a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d4d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d51:	0f 84 25 01 00 00    	je     801e7c <runcmd+0x297>
                return ret;
  801d57:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d5a:	e9 f4 01 00 00       	jmp    801f53 <runcmd+0x36e>
            break;
        case '|':
          //  if ((ret = pipe(p)) != 0) {
          //      return ret;
          //  }
            if ((ret = fork()) == 0) {
  801d5f:	e8 a6 eb ff ff       	call   80090a <fork>
  801d64:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d67:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d6b:	75 54                	jne    801dc1 <runcmd+0x1dc>
                close(0);
  801d6d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801d74:	e8 99 e3 ff ff       	call   800112 <close>
                if ((ret = dup2(p[0], 0)) < 0) {
  801d79:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801d7f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801d86:	00 
  801d87:	89 04 24             	mov    %eax,(%esp)
  801d8a:	e8 26 e4 ff ff       	call   8001b5 <dup2>
  801d8f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801d92:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801d96:	79 08                	jns    801da0 <runcmd+0x1bb>
                    return ret;
  801d98:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801d9b:	e9 b3 01 00 00       	jmp    801f53 <runcmd+0x36e>
                }
                close(p[0]), close(p[1]);
  801da0:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801da6:	89 04 24             	mov    %eax,(%esp)
  801da9:	e8 64 e3 ff ff       	call   800112 <close>
  801dae:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801db4:	89 04 24             	mov    %eax,(%esp)
  801db7:	e8 56 e3 ff ff       	call   800112 <close>
                goto again;
  801dbc:	e9 2d fe ff ff       	jmp    801bee <runcmd+0x9>
            }
            else {
                if (ret < 0) {
  801dc1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801dc5:	79 08                	jns    801dcf <runcmd+0x1ea>
                    return ret;
  801dc7:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801dca:	e9 84 01 00 00       	jmp    801f53 <runcmd+0x36e>
                }
                close(1);
  801dcf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801dd6:	e8 37 e3 ff ff       	call   800112 <close>
                if ((ret = dup2(p[1], 1)) < 0) {
  801ddb:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801de1:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  801de8:	00 
  801de9:	89 04 24             	mov    %eax,(%esp)
  801dec:	e8 c4 e3 ff ff       	call   8001b5 <dup2>
  801df1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801df4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801df8:	79 08                	jns    801e02 <runcmd+0x21d>
                    return ret;
  801dfa:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801dfd:	e9 51 01 00 00       	jmp    801f53 <runcmd+0x36e>
                }
                close(p[0]), close(p[1]);
  801e02:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
  801e08:	89 04 24             	mov    %eax,(%esp)
  801e0b:	e8 02 e3 ff ff       	call   800112 <close>
  801e10:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
  801e16:	89 04 24             	mov    %eax,(%esp)
  801e19:	e8 f4 e2 ff ff       	call   800112 <close>
                goto runit;
  801e1e:	eb 66                	jmp    801e86 <runcmd+0x2a1>
            }
            break;
        case 0:
            goto runit;
        case ';':
            if ((ret = fork()) == 0) {
  801e20:	e8 e5 ea ff ff       	call   80090a <fork>
  801e25:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801e28:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801e2c:	74 57                	je     801e85 <runcmd+0x2a0>
                goto runit;
            }
            else {
                if (ret < 0) {
  801e2e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801e32:	79 08                	jns    801e3c <runcmd+0x257>
                    return ret;
  801e34:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e37:	e9 17 01 00 00       	jmp    801f53 <runcmd+0x36e>
                }
                waitpid(ret, NULL);
  801e3c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801e43:	00 
  801e44:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801e47:	89 04 24             	mov    %eax,(%esp)
  801e4a:	e8 e4 ea ff ff       	call   800933 <waitpid>
                goto again;
  801e4f:	e9 9a fd ff ff       	jmp    801bee <runcmd+0x9>
            }
            break;
        default:
            printf("sh error: bad return %d from gettoken\n", token);
  801e54:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801e57:	89 44 24 08          	mov    %eax,0x8(%esp)
  801e5b:	c7 44 24 04 14 26 80 	movl   $0x802614,0x4(%esp)
  801e62:	00 
  801e63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801e6a:	e8 5f e6 ff ff       	call   8004ce <fprintf>
            return -1;
  801e6f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801e74:	e9 da 00 00 00       	jmp    801f53 <runcmd+0x36e>
                return -1;
            }
            if ((ret = reopen(0, t, O_RDONLY)) != 0) {
                return ret;
            ...
            break;
  801e79:	90                   	nop
  801e7a:	eb 01                	jmp    801e7d <runcmd+0x298>
                return -1;
            }
            if ((ret = reopen(1, t, O_RDWR | O_TRUNC | O_CREAT)) != 0) {
                return ret;
  ...
  801e7d:	e9 73 fd ff ff       	jmp    801bf5 <runcmd+0x10>
                close(p[0]), close(p[1]);
                goto runit;
            }
            break;
        case 0:
            goto runit;
  801e82:	90                   	nop
  801e83:	eb 01                	jmp    801e86 <runcmd+0x2a1>
        case ';':
            if ((ret = fork()) == 0) {
                goto runit;
  801e85:	90                   	nop
...
runit:
    if (argc == 0) {
  801e86:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801e8a:	75 0a                	jne    801e96 <runcmd+0x2b1>
        return 0;
  801e8c:	b8 00 00 00 00       	mov    $0x0,%eax
  801e91:	e9 bd 00 00 00       	jmp    801f53 <runcmd+0x36e>
    }
    else if (strcmp(argv[0], "cd") == 0) {
  801e96:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801e9c:	c7 44 24 04 3b 26 80 	movl   $0x80263b,0x4(%esp)
  801ea3:	00 
  801ea4:	89 04 24             	mov    %eax,(%esp)
  801ea7:	e8 e8 f5 ff ff       	call   801494 <strcmp>
  801eac:	85 c0                	test   %eax,%eax
  801eae:	75 2d                	jne    801edd <runcmd+0x2f8>
        if (argc != 2) {
  801eb0:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
  801eb4:	74 0a                	je     801ec0 <runcmd+0x2db>
            return -1;
  801eb6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801ebb:	e9 93 00 00 00       	jmp    801f53 <runcmd+0x36e>
        }
        strcpy(shcwd, argv[1]);
  801ec0:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
  801ec6:	89 44 24 04          	mov    %eax,0x4(%esp)
  801eca:	c7 04 24 60 51 80 00 	movl   $0x805160,(%esp)
  801ed1:	e8 41 f5 ff ff       	call   801417 <strcpy>
        return 0;
  801ed6:	b8 00 00 00 00       	mov    $0x0,%eax
  801edb:	eb 76                	jmp    801f53 <runcmd+0x36e>
    }
    if ((ret = testfile(argv[0])) != 0) {
  801edd:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801ee3:	89 04 24             	mov    %eax,(%esp)
  801ee6:	e8 c1 fc ff ff       	call   801bac <testfile>
  801eeb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801eee:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801ef2:	74 3b                	je     801f2f <runcmd+0x34a>
        if (ret != -E_NOENT) {
  801ef4:	83 7d ec f0          	cmpl   $0xfffffff0,-0x14(%ebp)
  801ef8:	74 05                	je     801eff <runcmd+0x31a>
            return ret;
  801efa:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801efd:	eb 54                	jmp    801f53 <runcmd+0x36e>
        }
        snprintf(argv0, sizeof(argv0), "/%s", argv[0]);
  801eff:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
  801f05:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801f09:	c7 44 24 08 3e 26 80 	movl   $0x80263e,0x8(%esp)
  801f10:	00 
  801f11:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
  801f18:	00 
  801f19:	c7 04 24 40 30 80 00 	movl   $0x803040,(%esp)
  801f20:	e8 c9 f2 ff ff       	call   8011ee <snprintf>
        argv[0] = argv0;
  801f25:	c7 85 68 ff ff ff 40 	movl   $0x803040,-0x98(%ebp)
  801f2c:	30 80 00 
    }
    argv[argc] = NULL;
  801f2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801f32:	c7 84 85 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%eax,4)
  801f39:	00 00 00 00 
    return __exec(NULL, argv);
  801f3d:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  801f43:	89 44 24 04          	mov    %eax,0x4(%esp)
  801f47:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801f4e:	e8 67 ea ff ff       	call   8009ba <__exec>
}
  801f53:	c9                   	leave  
  801f54:	c3                   	ret    
...
main(int argc, char **argv) {
  ...
  801f58:	83 e4 f0             	and    $0xfffffff0,%esp
  801f5b:	83 ec 20             	sub    $0x20,%esp
    printf("user sh is running!!!");
  801f5e:	c7 44 24 04 42 26 80 	movl   $0x802642,0x4(%esp)
  801f65:	00 
  801f66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801f6d:	e8 5c e5 ff ff       	call   8004ce <fprintf>
    int ret, interactive = 1;
  801f72:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801f79:	00 
    if (argc == 2) {
  801f7a:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801f7e:	75 42                	jne    801fc2 <main+0x6d>
        if ((ret = reopen(0, argv[1], O_RDONLY)) != 0) {
  801f80:	8b 45 0c             	mov    0xc(%ebp),%eax
  801f83:	83 c0 04             	add    $0x4,%eax
  801f86:	8b 00                	mov    (%eax),%eax
  801f88:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  801f8f:	00 
  801f90:	89 44 24 04          	mov    %eax,0x4(%esp)
  801f94:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801f9b:	e8 98 fb ff ff       	call   801b38 <reopen>
  801fa0:	89 44 24 10          	mov    %eax,0x10(%esp)
  801fa4:	8b 44 24 10          	mov    0x10(%esp),%eax
  801fa8:	85 c0                	test   %eax,%eax
  801faa:	74 09                	je     801fb5 <main+0x60>
            return ret;
  801fac:	8b 44 24 10          	mov    0x10(%esp),%eax
  801fb0:	e9 15 01 00 00       	jmp    8020ca <main+0x175>
        }
        interactive = 0;
  801fb5:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801fbc:	00 
    }
  ...
  801fbd:	e9 d8 00 00 00       	jmp    80209a <main+0x145>
        if ((ret = reopen(0, argv[1], O_RDONLY)) != 0) {
            return ret;
        }
        interactive = 0;
  ...
  801fc2:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
  801fc6:	0f 8e ce 00 00 00    	jle    80209a <main+0x145>
        usage();
  801fcc:	e8 4b fb ff ff       	call   801b1c <usage>
        return -1;
  801fd1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801fd6:	e9 ef 00 00 00       	jmp    8020ca <main+0x175>
    //shcwd = malloc(BUFSIZE);
    assert(shcwd != NULL);
    ...
    while ((buffer = readline((interactive) ? "$ " : NULL)) != NULL) {
        shcwd[0] = '\0';
  801fdb:	c6 05 60 51 80 00 00 	movb   $0x0,0x805160
        int pid;
        if ((pid = fork()) == 0) {
  801fe2:	e8 23 e9 ff ff       	call   80090a <fork>
  801fe7:	89 44 24 14          	mov    %eax,0x14(%esp)
  801feb:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  801ff0:	75 1c                	jne    80200e <main+0xb9>
            ret = runcmd(buffer);
  801ff2:	8b 44 24 18          	mov    0x18(%esp),%eax
  801ff6:	89 04 24             	mov    %eax,(%esp)
  801ff9:	e8 e7 fb ff ff       	call   801be5 <runcmd>
  801ffe:	89 44 24 10          	mov    %eax,0x10(%esp)
            exit(ret);
  802002:	8b 44 24 10          	mov    0x10(%esp),%eax
  802006:	89 04 24             	mov    %eax,(%esp)
  802009:	e8 dd e8 ff ff       	call   8008eb <exit>
        }
        assert(pid >= 0);
  80200e:	83 7c 24 14 00       	cmpl   $0x0,0x14(%esp)
  802013:	79 24                	jns    802039 <main+0xe4>
  802015:	c7 44 24 0c 58 26 80 	movl   $0x802658,0xc(%esp)
  80201c:	00 
  80201d:	c7 44 24 08 61 26 80 	movl   $0x802661,0x8(%esp)
  802024:	00 
  802025:	c7 44 24 04 f2 00 00 	movl   $0xf2,0x4(%esp)
  80202c:	00 
  80202d:	c7 04 24 76 26 80 00 	movl   $0x802676,(%esp)
  802034:	e8 b3 e2 ff ff       	call   8002ec <__panic>
        if (waitpid(pid, &ret) == 0) {
  802039:	8d 44 24 10          	lea    0x10(%esp),%eax
  80203d:	89 44 24 04          	mov    %eax,0x4(%esp)
  802041:	8b 44 24 14          	mov    0x14(%esp),%eax
  802045:	89 04 24             	mov    %eax,(%esp)
  802048:	e8 e6 e8 ff ff       	call   800933 <waitpid>
  80204d:	85 c0                	test   %eax,%eax
  80204f:	75 4a                	jne    80209b <main+0x146>
            if (ret == 0 && shcwd[0] != '\0') {
  802051:	8b 44 24 10          	mov    0x10(%esp),%eax
  802055:	85 c0                	test   %eax,%eax
  802057:	75 13                	jne    80206c <main+0x117>
  802059:	0f b6 05 60 51 80 00 	movzbl 0x805160,%eax
  802060:	84 c0                	test   %al,%al
  802062:	74 08                	je     80206c <main+0x117>
                ret = 0;
  802064:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
  80206b:	00 
            }
            if (ret != 0) {
  80206c:	8b 44 24 10          	mov    0x10(%esp),%eax
  802070:	85 c0                	test   %eax,%eax
  802072:	74 27                	je     80209b <main+0x146>
                printf("error: %d - %e\n", ret, ret);
  802074:	8b 54 24 10          	mov    0x10(%esp),%edx
  802078:	8b 44 24 10          	mov    0x10(%esp),%eax
  80207c:	89 54 24 0c          	mov    %edx,0xc(%esp)
  802080:	89 44 24 08          	mov    %eax,0x8(%esp)
  802084:	c7 44 24 04 80 26 80 	movl   $0x802680,0x4(%esp)
  80208b:	00 
  80208c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  802093:	e8 36 e4 ff ff       	call   8004ce <fprintf>
  802098:	eb 01                	jmp    80209b <main+0x146>
    }
    //shcwd = malloc(BUFSIZE);
    assert(shcwd != NULL);
    ...
    while ((buffer = readline((interactive) ? "$ " : NULL)) != NULL) {
  80209a:	90                   	nop
  80209b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8020a0:	74 07                	je     8020a9 <main+0x154>
  8020a2:	b8 90 26 80 00       	mov    $0x802690,%eax
  8020a7:	eb 05                	jmp    8020ae <main+0x159>
  8020a9:	b8 00 00 00 00       	mov    $0x0,%eax
  8020ae:	89 04 24             	mov    %eax,(%esp)
  8020b1:	e8 0b f9 ff ff       	call   8019c1 <readline>
  8020b6:	89 44 24 18          	mov    %eax,0x18(%esp)
  8020ba:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8020bf:	0f 85 16 ff ff ff    	jne    801fdb <main+0x86>
            if (ret != 0) {
                printf("error: %d - %e\n", ret, ret);
            }
        }
