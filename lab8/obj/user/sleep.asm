...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 a0 19 80 00 	movl   $0x8019a0,(%esp)
  ...
  800284:	c7 04 24 ab 19 80 00 	movl   $0x8019ab,(%esp)
  ...
  80029a:	c7 04 24 bd 19 80 00 	movl   $0x8019bd,(%esp)
  ...
  8002b0:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
  ...
  8002c6:	c7 04 24 e3 19 80 00 	movl   $0x8019e3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 f6 19 80 00 	movl   $0x8019f6,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 10 1a 80 00 	movl   $0x801a10,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 12 1a 80 00 	movl   $0x801a12,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 10 1a 80 00 	movl   $0x801a10,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 2e 1a 80 00 	movl   $0x801a2e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 41 1a 80 	movl   $0x801a41,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 48 1a 80 	movl   $0x801a48,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 62 1a 80 00 	movl   $0x801a62,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 74 1a 80 	movl   $0x801a74,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 7c 1a 80 	movl   $0x801a7c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 62 1a 80 00 	movl   $0x801a62,(%esp)
  ...
  800af9:	e8 02 0e 00 00       	call   801900 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 a4 1c 80 00       	add    $0x801ca4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 c8 1c 80 00 	mov    0x801cc8(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c be 1c 80 	movl   $0x801cbe,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be c1 1c 80 00       	mov    $0x801cc1,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8018af:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8018b2:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8018b9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8018c0:	eb 2c                	jmp    8018ee <sleepy+0x42>
        sleep(time);
  8018c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018c5:	89 04 24             	mov    %eax,(%esp)
  8018c8:	e8 cd f0 ff ff       	call   80099a <sleep>
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  8018cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018d0:	8d 50 01             	lea    0x1(%eax),%edx
  8018d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018d6:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018da:	89 54 24 04          	mov    %edx,0x4(%esp)
  8018de:	c7 04 24 20 1e 80 00 	movl   $0x801e20,(%esp)
  8018e5:	e8 fa ea ff ff       	call   8003e4 <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  8018ea:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8018ee:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  8018f2:	7e ce                	jle    8018c2 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  8018f4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8018fb:	e8 eb ef ff ff       	call   8008eb <exit>
...
main(void) {
  ...
  801903:	83 e4 f0             	and    $0xfffffff0,%esp
  801906:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  801909:	e8 9f f0 ff ff       	call   8009ad <gettime_msec>
  80190e:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801912:	e8 f3 ef ff ff       	call   80090a <fork>
  801917:	89 44 24 18          	mov    %eax,0x18(%esp)
  80191b:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801920:	75 0c                	jne    80192e <main+0x2e>
        sleepy(pid1);
  801922:	8b 44 24 18          	mov    0x18(%esp),%eax
  801926:	89 04 24             	mov    %eax,(%esp)
  801929:	e8 7e ff ff ff       	call   8018ac <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  80192e:	8d 44 24 14          	lea    0x14(%esp),%eax
  801932:	89 44 24 04          	mov    %eax,0x4(%esp)
  801936:	8b 44 24 18          	mov    0x18(%esp),%eax
  80193a:	89 04 24             	mov    %eax,(%esp)
  80193d:	e8 f1 ef ff ff       	call   800933 <waitpid>
  801942:	85 c0                	test   %eax,%eax
  801944:	75 08                	jne    80194e <main+0x4e>
  801946:	8b 44 24 14          	mov    0x14(%esp),%eax
  80194a:	85 c0                	test   %eax,%eax
  80194c:	74 24                	je     801972 <main+0x72>
  80194e:	c7 44 24 0c 38 1e 80 	movl   $0x801e38,0xc(%esp)
  801955:	00 
  801956:	c7 44 24 08 69 1e 80 	movl   $0x801e69,0x8(%esp)
  80195d:	00 
  80195e:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801965:	00 
  801966:	c7 04 24 7e 1e 80 00 	movl   $0x801e7e,(%esp)
  80196d:	e8 7a e9 ff ff       	call   8002ec <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  801972:	e8 36 f0 ff ff       	call   8009ad <gettime_msec>
  801977:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  80197b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80197f:	c7 04 24 8b 1e 80 00 	movl   $0x801e8b,(%esp)
  801986:	e8 59 ea ff ff       	call   8003e4 <cprintf>
    cprintf("sleep pass.\n");
  80198b:	c7 04 24 9c 1e 80 00 	movl   $0x801e9c,(%esp)
  801992:	e8 4d ea ff ff       	call   8003e4 <cprintf>
    return 0;
