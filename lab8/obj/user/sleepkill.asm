...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 b6 19 80 00 	movl   $0x8019b6,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 d2 19 80 00 	movl   $0x8019d2,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 ee 19 80 00 	movl   $0x8019ee,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 01 1a 80 	movl   $0x801a01,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 08 1a 80 	movl   $0x801a08,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 22 1a 80 00 	movl   $0x801a22,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 34 1a 80 	movl   $0x801a34,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 3c 1a 80 	movl   $0x801a3c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 22 1a 80 00 	movl   $0x801a22,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 64 1c 80 00       	add    $0x801c64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 88 1c 80 00 	mov    0x801c88(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 7e 1c 80 	movl   $0x801c7e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 81 1c 80 00       	mov    $0x801c81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018ba:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8018be:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8018c3:	75 18                	jne    8018dd <main+0x31>
        sleep(~0);
  8018c5:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8018cc:	e8 c9 f0 ff ff       	call   80099a <sleep>
        exit(0xdead);
  8018d1:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  8018d8:	e8 0e f0 ff ff       	call   8008eb <exit>
    }
    assert(pid > 0);
  8018dd:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8018e2:	7f 24                	jg     801908 <main+0x5c>
  8018e4:	c7 44 24 0c e0 1d 80 	movl   $0x801de0,0xc(%esp)
  8018eb:	00 
  8018ec:	c7 44 24 08 e8 1d 80 	movl   $0x801de8,0x8(%esp)
  8018f3:	00 
  8018f4:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  8018fb:	00 
  8018fc:	c7 04 24 fd 1d 80 00 	movl   $0x801dfd,(%esp)
  801903:	e8 e4 e9 ff ff       	call   8002ec <__panic>

    sleep(100);
  801908:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  80190f:	e8 86 f0 ff ff       	call   80099a <sleep>
    assert(kill(pid) == 0);
  801914:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801918:	89 04 24             	mov    %eax,(%esp)
  80191b:	e8 3a f0 ff ff       	call   80095a <kill>
  801920:	85 c0                	test   %eax,%eax
  801922:	74 24                	je     801948 <main+0x9c>
  801924:	c7 44 24 0c 0e 1e 80 	movl   $0x801e0e,0xc(%esp)
  80192b:	00 
  80192c:	c7 44 24 08 e8 1d 80 	movl   $0x801de8,0x8(%esp)
  801933:	00 
  801934:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80193b:	00 
  80193c:	c7 04 24 fd 1d 80 00 	movl   $0x801dfd,(%esp)
  801943:	e8 a4 e9 ff ff       	call   8002ec <__panic>
    cprintf("sleepkill pass.\n");
  801948:	c7 04 24 1d 1e 80 00 	movl   $0x801e1d,(%esp)
  80194f:	e8 90 ea ff ff       	call   8003e4 <cprintf>
    return 0;
