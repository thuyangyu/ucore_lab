...
main(void) {
  ...
  8018b2:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8018b5:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8018b7:	c7 44 24 08 60 1d 80 	movl   $0x801d60,0x8(%esp)
  8018be:	00 
  8018bf:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8018c6:	00 
  8018c7:	c7 04 24 6b 1d 80 00 	movl   $0x801d6b,(%esp)
  8018ce:	e8 19 ea ff ff       	call   8002ec <__panic>
