...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
  ...
  800284:	c7 04 24 cb 19 80 00 	movl   $0x8019cb,(%esp)
  ...
  80029a:	c7 04 24 dd 19 80 00 	movl   $0x8019dd,(%esp)
  ...
  8002b0:	c7 04 24 f0 19 80 00 	movl   $0x8019f0,(%esp)
  ...
  8002c6:	c7 04 24 03 1a 80 00 	movl   $0x801a03,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 16 1a 80 00 	movl   $0x801a16,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 30 1a 80 00 	movl   $0x801a30,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 32 1a 80 00 	movl   $0x801a32,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 30 1a 80 00 	movl   $0x801a30,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 4e 1a 80 00 	movl   $0x801a4e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 61 1a 80 	movl   $0x801a61,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 68 1a 80 	movl   $0x801a68,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 82 1a 80 00 	movl   $0x801a82,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 94 1a 80 	movl   $0x801a94,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 9c 1a 80 	movl   $0x801a9c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 82 1a 80 00 	movl   $0x801a82,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 c4 1c 80 00       	add    $0x801cc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 e8 1c 80 00 	mov    0x801ce8(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c de 1c 80 	movl   $0x801cde,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be e1 1c 80 00       	mov    $0x801ce1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8018b5:	c7 04 24 40 1e 80 00 	movl   $0x801e40,(%esp)
  ...
  8018cf:	75 0e                	jne    8018df <main+0x33>
        cprintf("I am the child. spinning ...\n");
  8018d1:	c7 04 24 67 1e 80 00 	movl   $0x801e67,(%esp)
  8018d8:	e8 07 eb ff ff       	call   8003e4 <cprintf>
        while (1);
  8018dd:	eb fe                	jmp    8018dd <main+0x31>
    }
    cprintf("I am the parent. Running the child...\n");
  8018df:	c7 04 24 88 1e 80 00 	movl   $0x801e88,(%esp)
  8018e6:	e8 f9 ea ff ff       	call   8003e4 <cprintf>

    yield();
  8018eb:	e8 5d f0 ff ff       	call   80094d <yield>
    yield();
  8018f0:	e8 58 f0 ff ff       	call   80094d <yield>
    yield();
  8018f5:	e8 53 f0 ff ff       	call   80094d <yield>

    cprintf("I am the parent.  Killing the child...\n");
  8018fa:	c7 04 24 b0 1e 80 00 	movl   $0x801eb0,(%esp)
  801901:	e8 de ea ff ff       	call   8003e4 <cprintf>

    assert((ret = kill(pid)) == 0);
  801906:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80190a:	89 04 24             	mov    %eax,(%esp)
  80190d:	e8 48 f0 ff ff       	call   80095a <kill>
  801912:	89 44 24 18          	mov    %eax,0x18(%esp)
  801916:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80191b:	74 24                	je     801941 <main+0x95>
  80191d:	c7 44 24 0c d8 1e 80 	movl   $0x801ed8,0xc(%esp)
  801924:	00 
  801925:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  80192c:	00 
  80192d:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  801934:	00 
  801935:	c7 04 24 04 1f 80 00 	movl   $0x801f04,(%esp)
  80193c:	e8 ab e9 ff ff       	call   8002ec <__panic>
    cprintf("kill returns %d\n", ret);
  801941:	8b 44 24 18          	mov    0x18(%esp),%eax
  801945:	89 44 24 04          	mov    %eax,0x4(%esp)
  801949:	c7 04 24 10 1f 80 00 	movl   $0x801f10,(%esp)
  801950:	e8 8f ea ff ff       	call   8003e4 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  801955:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80195c:	00 
  80195d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801961:	89 04 24             	mov    %eax,(%esp)
  801964:	e8 ca ef ff ff       	call   800933 <waitpid>
  801969:	89 44 24 18          	mov    %eax,0x18(%esp)
  80196d:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801972:	74 24                	je     801998 <main+0xec>
  801974:	c7 44 24 0c 24 1f 80 	movl   $0x801f24,0xc(%esp)
  80197b:	00 
  80197c:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  801983:	00 
  801984:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80198b:	00 
  80198c:	c7 04 24 04 1f 80 00 	movl   $0x801f04,(%esp)
  801993:	e8 54 e9 ff ff       	call   8002ec <__panic>
    cprintf("wait returns %d\n", ret);
  801998:	8b 44 24 18          	mov    0x18(%esp),%eax
  80199c:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019a0:	c7 04 24 44 1f 80 00 	movl   $0x801f44,(%esp)
  8019a7:	e8 38 ea ff ff       	call   8003e4 <cprintf>

    cprintf("spin may pass.\n");
  8019ac:	c7 04 24 55 1f 80 00 	movl   $0x801f55,(%esp)
  8019b3:	e8 2c ea ff ff       	call   8003e4 <cprintf>
    return 0;
