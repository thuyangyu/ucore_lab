...
main(void) {
  ...
  8018b5:	c7 04 24 60 1e 80 00 	movl   $0x801e60,(%esp)
  8018bc:	e8 23 eb ff ff       	call   8003e4 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8018c1:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8018c8:	00 
  8018c9:	eb 38                	jmp    801903 <main+0x57>
        if (bigarray[i] != 0) {
  8018cb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018cf:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  8018d6:	85 c0                	test   %eax,%eax
  8018d8:	74 24                	je     8018fe <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  8018da:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018de:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8018e2:	c7 44 24 08 80 1e 80 	movl   $0x801e80,0x8(%esp)
  8018e9:	00 
  8018ea:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  8018f1:	00 
  8018f2:	c7 04 24 9d 1e 80 00 	movl   $0x801e9d,(%esp)
  8018f9:	e8 ee e9 ff ff       	call   8002ec <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8018fe:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801903:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80190a:	00 
  80190b:	7e be                	jle    8018cb <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80190d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801914:	00 
  801915:	eb 14                	jmp    80192b <main+0x7f>
        bigarray[i] = i;
  801917:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80191b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80191f:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801926:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80192b:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801932:	00 
  801933:	7e e2                	jle    801917 <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801935:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80193c:	00 
  80193d:	eb 3c                	jmp    80197b <main+0xcf>
        if (bigarray[i] != i) {
  80193f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801943:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  80194a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80194e:	39 c2                	cmp    %eax,%edx
  801950:	74 24                	je     801976 <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801952:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801956:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80195a:	c7 44 24 08 ac 1e 80 	movl   $0x801eac,0x8(%esp)
  801961:	00 
  801962:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  801969:	00 
  80196a:	c7 04 24 9d 1e 80 00 	movl   $0x801e9d,(%esp)
  801971:	e8 76 e9 ff ff       	call   8002ec <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801976:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80197b:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801982:	00 
  801983:	7e ba                	jle    80193f <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  801985:	c7 04 24 d4 1e 80 00 	movl   $0x801ed4,(%esp)
  80198c:	e8 53 ea ff ff       	call   8003e4 <cprintf>
    cprintf("testbss may pass.\n");
  801991:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
  801998:	e8 47 ea ff ff       	call   8003e4 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  80199d:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8019a4:	00 00 00 
    asm volatile ("int $0x14");
  8019a7:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8019a9:	c7 44 24 08 1a 1f 80 	movl   $0x801f1a,0x8(%esp)
  8019b0:	00 
  8019b1:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8019b8:	00 
  8019b9:	c7 04 24 9d 1e 80 00 	movl   $0x801e9d,(%esp)
  8019c0:	e8 27 e9 ff ff       	call   8002ec <__panic>
