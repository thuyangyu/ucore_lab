...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 40 1a 80 00 	movl   $0x801a40,(%esp)
  ...
  800284:	c7 04 24 4b 1a 80 00 	movl   $0x801a4b,(%esp)
  ...
  80029a:	c7 04 24 5d 1a 80 00 	movl   $0x801a5d,(%esp)
  ...
  8002b0:	c7 04 24 70 1a 80 00 	movl   $0x801a70,(%esp)
  ...
  8002c6:	c7 04 24 83 1a 80 00 	movl   $0x801a83,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800308:	c7 04 24 96 1a 80 00 	movl   $0x801a96,(%esp)
  ...
  800321:	e8 82 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800326:	c7 04 24 b0 1a 80 00 	movl   $0x801ab0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80035a:	c7 04 24 b2 1a 80 00 	movl   $0x801ab2,(%esp)
  ...
  800373:	e8 30 00 00 00       	call   8003a8 <vcprintf>
    cprintf("\n");
  800378:	c7 04 24 b0 1a 80 00 	movl   $0x801ab0,(%esp)
...
exit(int error_code) {
  ...
  8008fc:	c7 04 24 ce 1a 80 00 	movl   $0x801ace,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a63:	00 
  800a64:	c7 44 24 04 e1 1a 80 	movl   $0x801ae1,0x4(%esp)
  800a6b:	00 
  ...
  800a88:	c7 44 24 08 e8 1a 80 	movl   $0x801ae8,0x8(%esp)
  800a8f:	00 
  800a90:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a97:	00 
  800a98:	c7 04 24 02 1b 80 00 	movl   $0x801b02,(%esp)
  800a9f:	e8 9a f8 ff ff       	call   80033e <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800aa4:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800aab:	00 
  800aac:	c7 44 24 04 14 1b 80 	movl   $0x801b14,0x4(%esp)
  800ab3:	00 
  ...
  800ad0:	c7 44 24 08 1c 1b 80 	movl   $0x801b1c,0x8(%esp)
  800ad7:	00 
  800ad8:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800adf:	00 
  800ae0:	c7 04 24 02 1b 80 00 	movl   $0x801b02,(%esp)
  ...
  800af9:	e8 56 0e 00 00       	call   801954 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c5d:	05 44 1d 80 00       	add    $0x801d44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800dd8:	8b 04 85 68 1d 80 00 	mov    0x801d68(,%eax,4),%eax
  ...
  800eea:	c7 44 24 0c 5e 1d 80 	movl   $0x801d5e,0xc(%esp)
  800ef1:	00 
  ...
  800f1d:	75 05                	jne    800f24 <vprintfmt+0x1ca>
                p = "(null)";
  800f1f:	be 61 1d 80 00       	mov    $0x801d61,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8018af:	83 ec 08             	sub    $0x8,%esp
    yield();
  8018b2:	e8 96 f0 ff ff       	call   80094d <yield>
    yield();
  8018b7:	e8 91 f0 ff ff       	call   80094d <yield>
    yield();
  8018bc:	e8 8c f0 ff ff       	call   80094d <yield>
    yield();
  8018c1:	e8 87 f0 ff ff       	call   80094d <yield>
    yield();
  8018c6:	e8 82 f0 ff ff       	call   80094d <yield>
    yield();
  8018cb:	e8 7d f0 ff ff       	call   80094d <yield>
}
  8018d0:	c9                   	leave  
  8018d1:	c3                   	ret    
...
loop(void) {
  ...
  8018d5:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  8018d8:	c7 04 24 c0 1e 80 00 	movl   $0x801ec0,(%esp)
  8018df:	e8 00 eb ff ff       	call   8003e4 <cprintf>
    while (1);
  8018e4:	eb fe                	jmp    8018e4 <loop+0x12>
...
work(void) {
  ...
  8018e9:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  8018ec:	c7 04 24 ca 1e 80 00 	movl   $0x801eca,(%esp)
  8018f3:	e8 ec ea ff ff       	call   8003e4 <cprintf>
    do_yield();
  8018f8:	e8 af ff ff ff       	call   8018ac <do_yield>
    if (kill(parent) == 0) {
  8018fd:	a1 48 21 80 00       	mov    0x802148,%eax
  801902:	89 04 24             	mov    %eax,(%esp)
  801905:	e8 50 f0 ff ff       	call   80095a <kill>
  80190a:	85 c0                	test   %eax,%eax
  80190c:	75 3a                	jne    801948 <work+0x62>
        cprintf("kill parent ok.\n");
  80190e:	c7 04 24 d4 1e 80 00 	movl   $0x801ed4,(%esp)
  801915:	e8 ca ea ff ff       	call   8003e4 <cprintf>
        do_yield();
  80191a:	e8 8d ff ff ff       	call   8018ac <do_yield>
        if (kill(pid1) == 0) {
  80191f:	a1 50 21 80 00       	mov    0x802150,%eax
  801924:	89 04 24             	mov    %eax,(%esp)
  801927:	e8 2e f0 ff ff       	call   80095a <kill>
  80192c:	85 c0                	test   %eax,%eax
  80192e:	75 18                	jne    801948 <work+0x62>
            cprintf("kill child1 ok.\n");
  801930:	c7 04 24 e5 1e 80 00 	movl   $0x801ee5,(%esp)
  801937:	e8 a8 ea ff ff       	call   8003e4 <cprintf>
            exit(0);
  80193c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801943:	e8 a3 ef ff ff       	call   8008eb <exit>
        }
    }
    exit(-1);
  801948:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  80194f:	e8 97 ef ff ff       	call   8008eb <exit>
...
main(void) {
  ...
  801957:	83 e4 f0             	and    $0xfffffff0,%esp
  80195a:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80195d:	e8 0b f0 ff ff       	call   80096d <getpid>
  801962:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  801967:	e8 9e ef ff ff       	call   80090a <fork>
  80196c:	a3 50 21 80 00       	mov    %eax,0x802150
  801971:	a1 50 21 80 00       	mov    0x802150,%eax
  801976:	85 c0                	test   %eax,%eax
  801978:	75 05                	jne    80197f <main+0x2b>
        loop();
  80197a:	e8 53 ff ff ff       	call   8018d2 <loop>
    }

    assert(pid1 > 0);
  80197f:	a1 50 21 80 00       	mov    0x802150,%eax
  801984:	85 c0                	test   %eax,%eax
  801986:	7f 24                	jg     8019ac <main+0x58>
  801988:	c7 44 24 0c f6 1e 80 	movl   $0x801ef6,0xc(%esp)
  80198f:	00 
  801990:	c7 44 24 08 ff 1e 80 	movl   $0x801eff,0x8(%esp)
  801997:	00 
  801998:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80199f:	00 
  8019a0:	c7 04 24 14 1f 80 00 	movl   $0x801f14,(%esp)
  8019a7:	e8 40 e9 ff ff       	call   8002ec <__panic>

    if ((pid2 = fork()) == 0) {
  8019ac:	e8 59 ef ff ff       	call   80090a <fork>
  8019b1:	a3 4c 21 80 00       	mov    %eax,0x80214c
  8019b6:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8019bb:	85 c0                	test   %eax,%eax
  8019bd:	75 05                	jne    8019c4 <main+0x70>
        work();
  8019bf:	e8 22 ff ff ff       	call   8018e6 <work>
    }
    if (pid2 > 0) {
  8019c4:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8019c9:	85 c0                	test   %eax,%eax
  8019cb:	7e 46                	jle    801a13 <main+0xbf>
        cprintf("wait child 1.\n");
  8019cd:	c7 04 24 24 1f 80 00 	movl   $0x801f24,(%esp)
  8019d4:	e8 0b ea ff ff       	call   8003e4 <cprintf>
        waitpid(pid1, NULL);
  8019d9:	a1 50 21 80 00       	mov    0x802150,%eax
  8019de:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8019e5:	00 
  8019e6:	89 04 24             	mov    %eax,(%esp)
  8019e9:	e8 45 ef ff ff       	call   800933 <waitpid>
        panic("waitpid %d returns\n", pid1);
  8019ee:	a1 50 21 80 00       	mov    0x802150,%eax
  8019f3:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019f7:	c7 44 24 08 33 1f 80 	movl   $0x801f33,0x8(%esp)
  8019fe:	00 
  8019ff:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801a06:	00 
  801a07:	c7 04 24 14 1f 80 00 	movl   $0x801f14,(%esp)
  801a0e:	e8 d9 e8 ff ff       	call   8002ec <__panic>
    }
    else {
        kill(pid1);
  801a13:	a1 50 21 80 00       	mov    0x802150,%eax
  801a18:	89 04 24             	mov    %eax,(%esp)
  801a1b:	e8 3a ef ff ff       	call   80095a <kill>
    }
    panic("FAIL: T.T\n");
  801a20:	c7 44 24 08 47 1f 80 	movl   $0x801f47,0x8(%esp)
  801a27:	00 
  801a28:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801a2f:	00 
  801a30:	c7 04 24 14 1f 80 00 	movl   $0x801f14,(%esp)
  801a37:	e8 b0 e8 ff ff       	call   8002ec <__panic>
